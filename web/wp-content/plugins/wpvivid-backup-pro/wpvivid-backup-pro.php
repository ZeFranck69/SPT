 ...
 * Text Domain:       wpvivid-backup-pro
...
define('WPVIVID_BACKUP_PRO_VERSION','2.2.49');
...
function wpvivid_pro_plugin_activate($network_wide)
{
    if (is_multisite() && !$network_wide)
    {
        ...
        wp_die(
            esc_html__('WPvivid Plugins Pro must be network activated on a multisite installation.', 'wpvivid-backup-pro'),
            esc_html__('Network activation required', 'wpvivid-backup-pro'),
