...
class WPvivid_New_Backup_List extends WP_List_Table
{
    ...
    public function get_columns()
    {
        ...
        $columns['wpvivid_content2'] =__( 'Content', 'wpvivid-backup-pro'  );
        $columns['wpvivid_storage'] =__( 'Storage', 'wpvivid-backup-pro'  );
        $columns['wpvivid_size2'] =__( 'Size', 'wpvivid-backup-pro'  );
        $columns['wpvivid_action2'] = __( 'Actions', 'wpvivid-backup-pro' );
        $columns['wpvivid_comment2'] = __( 'Comment', 'wpvivid-backup-pro'  );
        return $columns;
    }
    ...
    public function _column_wpvivid_date2( $backup )
    {
        ...
        $html='<td class="tablelistcolumn">
                    <div class="backuptime"  title="">
						...
						<span class="dashicons dashicons-welcome-write-blog wpvivid-dashicons-grey" style="cursor:pointer;" title="'.esc_attr__('Backup Log', 'wpvivid-backup-pro').'" onclick="wpvivid_backup_open_log(\''.$log_name.'\');"></span>
						<span style="margin:0 5px 0 0; opacity: 0.5;">|</span> <span><strong>'.esc_html__('Type:', 'wpvivid-backup-pro').' </strong></span>
    ...
    public function _column_wpvivid_storage( $backup )
    {
        ...
        {
            echo "<span><span class='dashicons dashicons-desktop'></span><span>".esc_html__('Localhost', 'wpvivid-backup-pro')."</span></span>";
        }
        else
        {
...
class WPvivid_Incremental_Files_List extends WP_List_Table
{
    ...
    public function get_columns()
    {
        $columns = array();
        $columns['cb'] = __('cb', 'wpvivid-backup-pro');
        $columns['wpvivid_i_date'] = __('Date', 'wpvivid-backup-pro');
        $columns['wpvivid_i_type'] = __('Type', 'wpvivid-backup-pro');
        $columns['wpvivid_file_name'] = __('File Name', 'wpvivid-backup-pro');
        $columns['wpvivid_i_file_size'] = __('Size', 'wpvivid-backup-pro');
        $columns['wpvivid_download_action'] = __('Actions', 'wpvivid-backup-pro');
        return $columns;
    }
    ...
    public function _column_wpvivid_download_action($file)
    {
        echo '<td class="tablelistcolumn">
					<div style="cursor:pointer;">		
						<span class="dashicons dashicons-download wpvivid-dashicons-grey wpvivid-download" title="'.esc_attr__('Download', 'wpvivid-backup-pro').'"></span>					
					</div>
				</td>';
    }
    ...
    protected function display_tablenav( $which ) {
        ...
        if ( $total_pages >1)
        {
            ...
            <div class="tablenav <?php echo esc_attr( $which ); ?>" style="<?php echo esc_attr($css_type); ?>">
                ...
                <input type="submit" class="button action wpvivid-select-bulk wpvivid_bulk_download2" value="<?php esc_attr_e('Apply', 'wpvivid-backup-pro'); ?>">
                <?php
                $this->pagination( $which );
                ?>
                <br class="clear" />
...
class WPvivid_Types_Files_List
{
    ...
    public function display_rows_or_placeholder()
    {
        ...
        else
        {
            ...
            esc_html_e('No items found.', 'wpvivid-backup-pro');
            echo '</td></tr>';
        }
    }
    ...
    public function main_type_tr($type,&$files)
    {
        ...
        <tr data-type="<?php echo $type?>" data-filename="<?php echo $file_name?>" data-total-size="<?php echo $total_size ?>" data-file-size="<?php echo $file_data['size'] ?>">
            ...
            <td class="tablelistcolumn">
                <div style="cursor:pointer;">
                    <span class="dashicons dashicons-download wpvivid-dashicons-grey wpvivid-download" title="<?php esc_attr_e('Download', 'wpvivid-backup-pro'); ?>"></span>
                </div>
            </td>
        </tr>
        <?php
