        ...
        <div class="tablenav <?php echo esc_attr( $which ); ?>" style="<?php echo esc_attr($css_type); ?>">
            <div class="alignleft actions bulkactions">
                <label>
                    ...
                    <span><strong><?php esc_html_e('Export all pages', 'wpvivid-backup-pro'); ?></strong></span>
                </label>
                <input class="button-primary" id="wpvivid-post-research-submit" type="submit" name="post" value="<?php esc_attr_e('Reset Filters', 'wpvivid-backup-pro'); ?>">
            </div>
            <?php
    ...
    public static function get_backup_tasks_progress($task_id)
    {
        ...
        if(array_key_exists ($task_id,$tasks))
        {
            ...
            if(isset($task['data'][$ret['type']]['sub_job'][$ret['doing']]['progress']))
                $ret['descript']=__($task['data'][$ret['type']]['sub_job'][$ret['doing']]['progress'], 'wpvivid-backup-pro');
            else
                $ret['descript']='';
