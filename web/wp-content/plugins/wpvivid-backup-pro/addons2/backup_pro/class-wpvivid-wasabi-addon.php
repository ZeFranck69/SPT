    ...
    public function wpvivid_add_storage_page_wasabi()
    {
        ...
        <div id="storage_account_wasabi"  class="storage-account-page">
            <div style="padding: 0 10px 10px 0;">
                <strong><?php esc_html_e('Enter Your Wasabi Account', 'wpvivid-backup-pro'); ?></strong>
            </div>
            <table class="wp-list-table widefat plugins" style="width:100%;">
                ...
                <form>
                    ...
                    <tr>
                        ...
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
                                <i><?php esc_html_e('Enter your Wasabi access key', 'wpvivid-backup-pro'); ?></i>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
                                <i><?php esc_html_e('Enter your Wasabi secret key', 'wpvivid-backup-pro'); ?></i>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
                                <i><span><?php echo sprintf(__('Enter an existing Bucket in which you want to create a parent folder for holding %s folders.', 'wpvivid-backup-pro'), apply_filters('wpvivid_white_label_display', 'WPvivid backup')); ?></i>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td class="plugin-title column-primary">
                            <div class="wpvivid-storage-form">
                                <input type="text" class="regular-text" autocomplete="off" option="wasabi" name="root_path" value="<?php echo esc_attr(apply_filters('wpvivid_white_label_remote_root_path', 'wpvividbackuppro')); ?>" />
                            </div>
                        </td>
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
                    ...
                    <tr>
                        <td class="plugin-title column-primary">
                            <div class="wpvivid-storage-form">
                                <input type="text" class="regular-text" autocomplete="off" option="wasabi" name="path" placeholder="Custom Path" value="<?php echo esc_attr($wpvivid_backup_pro->func->swtich_domain_to_folder_name(home_url())); ?>" />
                            </div>
                        </td>
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
                    ...
                    <tr>
                        <td class="plugin-title column-primary">
                            <div class="wpvivid-storage-form">
                                <select id="wpvivid_wasabi_endpoint_select" style="margin-bottom:5px;">
                                    <option value="us_east1"><?php esc_html_e('US East 1', 'wpvivid-backup-pro'); ?></option>
                                    <option value="us_east2"><?php esc_html_e('US East 2', 'wpvivid-backup-pro'); ?></option>
                                    <option value="us_west1"><?php esc_html_e('US West 1', 'wpvivid-backup-pro'); ?></option>
                                    <option value="us_central1"><?php esc_html_e('EU Central 1', 'wpvivid-backup-pro'); ?></option>
                                    <option value="custom"><?php esc_html_e('Custom', 'wpvivid-backup-pro'); ?></option>
                                </select>
                        ...
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
                                <i><?php esc_html_e('Enter the Wasabi Endpoint for the storage', 'wpvivid-backup-pro'); ?></i>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="plugin-title column-primary">
                            <div class="wpvivid-storage-select">
                                <label>
                                    <input type="checkbox" option="wasabi" name="default" checked /> <?php esc_html_e('Set as the default remote storage.', 'wpvivid-backup-pro'); ?>
                                </label>
                            </div>
                        </td>
                        <td class="column-description desc">
                    ...
                    <tr>
                        <td class="plugin-title column-primary">
                            <div class="wpvivid-storage-select">
                                <label>
                                    <input type="checkbox" option="wasabi" name="uncheckdelete" /><?php esc_html_e('Do not check DeleteObject.', 'wpvivid-backup-pro'); ?>
                                </label>
                            </div>
                        </td>
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
                                ...
                                <span class="dashicons dashicons-editor-help wpvivid-dashicons-editor-help wpvivid-tooltip">
                                    <div class="wpvivid-bottom">
                                        <p><?php esc_html_e('s3:DeleteObject is a permission for deleting objects from Wasabi. Without it, you are not able to delete backups on S3 from WPvivid.', 'wpvivid-backup-pro'); ?></p>
                ...
                <tr>
                    ...
                    <td class="column-description desc">
                        <div class="wpvivid-storage-form-desc">
                            <i><?php esc_html_e('Click the button to connect to Wasabi storage and add it to the storage list below.', 'wpvivid-backup-pro'); ?></i>
                        </div>
                    </td>
                </tr>
                </tbody>
            ...
            <table class="wp-list-table widefat plugins" style="width:100%;">
                ...
                <form>
                    ...
                    <tr>
                        <td class="plugin-title column-primary">
                            <div class="wpvivid-storage-form">
                                <input type="text" class="regular-text" autocomplete="off" option="edit-wasabi" name="root_path" value="<?php echo esc_attr(apply_filters('wpvivid_white_label_remote_root_path', 'wpvividbackuppro')); ?>" />
                            </div>
                        </td>
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
