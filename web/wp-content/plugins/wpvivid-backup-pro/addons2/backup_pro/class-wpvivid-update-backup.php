...
class WPvivid_update_backup
{
        ...
        <script>
            ...
            function wpvivid_start_auto_backup()
            {
                ...
                var ajax_data = {
                    ...
                    'themes':themes_list,
                    'backup_to_remote':'<?php echo esc_html($backup_to_remote); ?>'
                };
    ...
    public function core_auto_backup_check()
    {
        ...
        <?php
         <div class="updated" style="<?php echo esc_attr($auto_backup_display); ?>">
            <h3><?php esc_html_e('Auto-backup before updating', 'wpvivid-backup-pro'); ?></h3>

            <div style="margin-bottom: 10px;">
                <label>
                    <input type="checkbox" id="wpvivid_backup_before_update_enable" <?php echo esc_attr($auto_backup_enable) ?> />
                    <?php echo sprintf(__('%s Pro will automatically back up your plugins, themes or core files before you update them. It will only back up the files you want to update.', 'wpvivid-backup-pro'), apply_filters('wpvivid_white_label_display', 'WPvivid Backup')); ?>
                </label>
            </div>

            <div style="margin-bottom: 10px;">
                <label for="wpvivid_backup_before_update">
                    <input type="radio" id="wpvivid_backup_before_update" name="wpvivid_bfu" value="local" style="<?php echo esc_attr($auto_backup_style); ?>" <?php echo esc_attr($auto_backup_local); ?> />
                    Save the backup to localhost: <?php echo esc_html(WP_CONTENT_DIR . DIRECTORY_SEPARATOR . $backupdir); ?>
                </label>
            </div>
            <?php
            ...
            ?>
            <div style="margin-bottom: 10px; <?php echo esc_attr($style); ?>">
                <label for="wpvivid_backup_to_remote">
                    <input type="radio" id="wpvivid_backup_to_remote" name="wpvivid_bfu" value="remote" style="<?php echo esc_attr($auto_backup_style); ?>" <?php echo esc_attr($auto_backup_remote); ?> />
                    Send the backup to remote storage: rollback folder under the custom directory <?php echo esc_html($descript); ?>
                </label>
            </div>
        </div>
         <script>
            ...
            jQuery(document).ready(function ($) {
                var wpvivid_auto_backup_before_update = '<?php
                    ...
                    echo esc_html($auto_backup_enable);
                    ?>';
            ...
            <td>
                <p>
                    <label class="wpvivid-checkbox">
                        <span><?php echo sprintf(__('%s Pro will automatically back up your plugins, themes or core files before you update them. It will only back up the files you want to update.', 'wpvivid-backup-pro'), apply_filters('wpvivid_white_label_display', 'WPvivid Backup')); ?></span>
                        <input type="checkbox" option="setting" name="auto_backup_enable" <?php echo esc_attr($auto_backup_enable) ?>>
                        <span class="wpvivid-checkbox-checkmark"></span>
                    </label>
                </p>
                <p></p>
                <div id="wpvivid_auto_backup_block" style="padding-left:2em; <?php echo esc_attr($auto_backup_style); ?>">
                    <fieldset>
                        <label class="wpvivid-radio" style="float:left; padding-right:1em;">
                            <input type="radio" option="setting" name="auto_backup" value="local" <?php echo esc_attr($auto_backup_local); ?> />Save the backup to localhost: <code><?php echo WPvivid_Custom_Interface_addon::wpvivid_get_local_backup_abspath(); ?></code>
                        ...
                        <label class="wpvivid-radio" style="float:left; padding-right:1em;">Send the backup to cloud storage: <code>rollback</code> folder under the custom directory
                            <input type="radio" option="setting"  name="auto_backup" value="remote" <?php echo esc_attr($auto_backup_remote); ?> />
                            <span class="wpvivid-radio-checkmark"></span>
                        </label>
                    </fieldset>
                </div>
