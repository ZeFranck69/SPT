...
class WPvivid_Uploads_Cleaner_addon
{
    ...
    public function get_toolbar_menus($toolbar_menus)
    {
        ...
        if($display)
        {
            ...
            $menu['title'] = __('Unused Image Cleaner', 'wpvivid-backup-pro');
    ...
    public function get_dashboard_menu($submenus,$parent_slug)
    {
        ...
        if($display)
        {
            ...
            $submenu['page_title'] = apply_filters('wpvivid_white_label_display', __('Unused Image Cleaner', 'wpvivid-backup-pro'));
            $submenu['menu_title'] = __('Unused Image Cleaner', 'wpvivid-backup-pro');
                    ...
                    <td>
                        ...
                        <div>
                            <label class="wpvivid-checkbox">
                                <span><?php esc_html_e('Enable Quick Scan', 'wpvivid-backup-pro'); ?></span>
                                <span class="dashicons dashicons-editor-help wpvivid-dashicons-editor-help wpvivid-tooltip">
                                    <div class="wpvivid-bottom">
                                        <!-- The content you need -->
                                        <p><?php esc_html_e('Checking this option will speed up your scans but may produce lower accuracy.', 'wpvivid-backup-pro'); ?></p>
                                        <i></i> <!-- do not delete this line -->
                                    </div>
                                </span>
                                <input type="checkbox" id="wpvivid_uc_quick_scan" option="setting" name="wpvivid_uc_quick_scan" <?php echo esc_attr($quick_scan); ?> />
                        ...
                        <div>
                            <label class="wpvivid-checkbox">
                                <span><?php esc_html_e('Delete Unused Image URL in Database', 'wpvivid-backup-pro'); ?></span>
                                <span class="dashicons dashicons-editor-help wpvivid-dashicons-editor-help wpvivid-tooltip">
                                    <div class="wpvivid-bottom">
                                        <!-- The content you need -->
                                        <p><?php esc_html_e('With this option checked, when the image is deleted, the corresponding image url in the database that is not used anywhere on your website will also be deleted.', 'wpvivid-backup-pro'); ?></p>
                                        <i></i> <!-- do not delete this line -->
                                    </div>
                                </span>
                                <input type="checkbox" id="wpvivid_uc_delete_media_when_delete_file" option="setting" name="wpvivid_uc_delete_media_when_delete_file" <?php echo esc_attr($delete_media_when_delete_file); ?> />
                                <span class="wpvivid-checkbox-checkmark"></span>
                            </label>
                        </div>
                        ...
                        <div>
                            <label class="wpvivid-checkbox">
                                <span><?php esc_html_e('Ignore webp files', 'wpvivid-backup-pro'); ?></span>
                                <span class="dashicons dashicons-editor-help wpvivid-dashicons-editor-help wpvivid-tooltip">
                                    <div class="wpvivid-bottom">
                                        <!-- The content you need -->
                                        <p><?php esc_html_e('Do not scan webp files.', 'wpvivid-backup-pro'); ?></p>
                                        <i></i> <!-- do not delete this line -->
                                    </div>
                                </span>
                                <input type="checkbox" id="wpvivid_uc_ignore_webp" option="setting" name="wpvivid_uc_ignore_webp" <?php echo esc_attr($ignore_webp); ?> />
                                <span class="wpvivid-checkbox-checkmark"></span>
                            </label>
                        </div>
                        ...
                        <p></p>
                        <div>
                            <input type="text" placeholder="20" id="wpvivid_uc_scan_limit" option="setting" name="wpvivid_uc_scan_limit" value="<?php echo esc_attr($scan_limit); ?>" onkeyup="value=value.replace(/\D/g,'')" />
                            <span><?php esc_html_e('Posts Quantity Processed Per Request', 'wpvivid-backup-pro'); ?></span>
                            <span class="dashicons dashicons-editor-help wpvivid-dashicons-editor-help wpvivid-tooltip wpvivid-tooltip-padding-top">
                                <div class="wpvivid-bottom">
                                    <!-- The content you need -->
                                    <p><?php esc_html_e('Set how many posts to process per request. The value should be set depending on your server performance and the recommended value is 20.', 'wpvivid-backup-pro'); ?></p>
                                    <i></i> <!-- do not delete this line -->
                                </div>
                            </span>
                        </div>
                        ...
                        <p></p>
                        <div><input type="text" placeholder="100" id="wpvivid_uc_files_limit" option="setting" name="wpvivid_uc_files_limit" value="<?php echo esc_attr($files_limit); ?>" onkeyup="value=value.replace(/\D/g,'')" />
                            <span><?php esc_html_e('Media Files Quantity Processed Per Request', 'wpvivid-backup-pro'); ?></span>
                            <span class="dashicons dashicons-editor-help wpvivid-dashicons-editor-help wpvivid-tooltip wpvivid-tooltip-padding-top">
                                <div class="wpvivid-bottom">
                                    <!-- The content you need -->
                                    <p><?php esc_html_e('Set how many media files to process per request. The value should be set depending on your server performance and the recommended value is 100.', 'wpvivid-backup-pro'); ?></p>
                                    <i></i> <!-- do not delete this line -->
                                </div>
                            </span>
                        </div>
                    ...
                    if(version_compare(WPVIVID_PLUGIN_VERSION,'0.9.89','>='))
                    {
                        ...
                        <tr>
                            <td class="row-title" style="min-width:200px;">
                                <span><?php esc_html_e('Exclude images by folder path', 'wpvivid-backup-pro'); ?></span>
                            </td>
                            <td>
    ...
    public function wpvivid_check_jet_engine()
    {
        ...
        if(!empty($plugins))
        {
            if(isset($plugins[$jet_engine_slug]))
            {
                ...
                {
                    echo '<div class="notice notice-warning inline" style="margin: 10px 0 0 0;"><p><strong>' . esc_html__('Warning:', 'wpvivid-backup-pro') . '</strong> ' . esc_html__('We detected that you use Jet Engine plugin on this site, it may have compatibility issues with our plugin, which can result in an inaccuracy of the scan result, so we recommend not using this feature yet.', 'wpvivid-backup-pro') . '</p></div>';
                }
            }
        }
    }
                        ...
                        <div class="meta-box-sortables ui-sortable">
                            <div class="wpvivid-backup">
                                <div class="wpvivid-welcome-bar wpvivid-clear-float">
                                    <div class="wpvivid-welcome-bar-left">
                                        ...
                                        <div>
                                            ...
                                            <span class="wpvivid-page-title"><?php esc_html_e('Unused Image Cleaner', 'wpvivid-backup-pro'); ?></span>
                                        </div>
                                        <p></p>
                                        <span class="about-description"><?php esc_html_e('Scan your media folder (uploads) to find unused images and isolate specific or all unused images.', 'wpvivid-backup-pro'); ?></span>
                                    </div>
                                ...
                                <div class="wpvivid-canvas wpvivid-clear-float">
                                    ...
                                    $tabs['scan']['title']=__('Scan', 'wpvivid-backup-pro');
                                    $tabs['scan']['slug']='scan';
                                    ...
                                    $args['is_parent_tab']=0;
                                    $tabs['isolate']['title']=__('Media Isolated', 'wpvivid-backup-pro');
    ...
    public function output_scan()
    {
        ...
        $folders=$scanner->get_all_folder();
        $admin_url = apply_filters('wpvivid_get_admin_url', '');
        $progress_bar='<p><span><span class="wpvivid-backup-percent-progress">0%</span> '.esc_html__('Completed', 'wpvivid-backup-pro').'</span><br><span class="wpvivid-span-progress"><span class="wpvivid-span-processed-progress wpvivid-span-processed-percent-progress" style="width:0%"></span></span></p><p><span class="dashicons dashicons-portfolio wpvivid-dashicons-orange"></span><span>'.esc_html__('Total Posts:', 'wpvivid-backup-pro').'</span><span>N/A</span><span class="dashicons dashicons-admin-page wpvivid-dashicons-green"></span><span>'.esc_html__('Scanned:', 'wpvivid-backup-pro').'</span><span>N/A</span></p><p><span class="dashicons dashicons-welcome-write-blog wpvivid-dashicons-grey"></span><span>'.esc_html__('Action:', 'wpvivid-backup-pro').'</span><span>'.esc_html__('Ready to scan', 'wpvivid-backup-pro').'</span></p><div><input class="button-primary" id="wpvivid_uc_cancel" type="submit" value="'.esc_attr__('Cancel', 'wpvivid-backup-pro').'"></div>';
        ...
        <div class="wpvivid-one-coloum wpvivid-workflow wpvivid-clear-float">
            <div id="wpvivid_uc_scan">
                ...
                <span><?php esc_html_e('Clicking the \'Scan\' button to find unused images in your media folder. Currently it only scans JPG and PNG images.', 'wpvivid-backup-pro'); ?></span>
                <div class="wpvivid-two-col">
                    <p><span class="dashicons dashicons-category wpvivid-dashicons-blue"></span><span><strong><?php esc_html_e('Scanned Images Total Size', 'wpvivid-backup-pro'); ?>: </strong></span><?php echo esc_html($total_size); ?></p>
                    <p><span class="dashicons dashicons-code-standards wpvivid-dashicons-green"></span><span><strong><?php esc_html_e('Unused Image(s) Found', 'wpvivid-backup-pro'); ?>: </strong></span><?php echo wp_kses_post($last_scan); ?></p>
                </div>
                <div class="wpvivid-two-col" style="text-align:center;">
                    <p><input class="button-primary" style="width: 200px; font-size: 20px;" id="wpvivid_start_scan" type="submit" value="<?php esc_attr_e('Scan', 'wpvivid-backup-pro'); ?>"></p>
                    <p><code><?php esc_html_e('Note: Please don\'t refresh the page while scanning.', 'wpvivid-backup-pro'); ?></code></p>
                </div>
            </div>
                    ...
                    try
                    {
                        ...
                        if (jsonarray.result === 'success')
                        {
                            if(jsonarray.empty)
                            {
                                ...
                                alert(wpvivid_ajax_object_addon.i18n.no_items_found);
    ...
    public function output_isolate()
    {
        ...
        <div class="wpvivid-one-coloum wpvivid-workflow wpvivid-clear-float">
            <span class="dashicons dashicons-lightbulb wpvivid-dashicons-orange"></span>
            <span><?php esc_html_e('Note: Once deleted, images will be lost permanently. The action cannot be undone, unless you have', 'wpvivid-backup-pro'); ?> <a href="<?php echo apply_filters('wpvivid_white_label_page_redirect', 'admin.php?page=wpvivid-backup-and-restore', 'wpvivid-backup-and-restore'); ?>"><?php esc_html_e('a backup', 'wpvivid-backup-pro'); ?></a> <?php esc_html_e('in place', 'wpvivid-backup-pro'); ?>.
        </div>
        <div style="clear: both;"></div>
