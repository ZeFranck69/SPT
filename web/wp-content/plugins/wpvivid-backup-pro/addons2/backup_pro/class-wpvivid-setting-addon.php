...
class WPvivid_Setting_addon
{
    ...
    public function setting_tab($tabs)
    {
        if( apply_filters('wpvivid_current_user_can',true,'wpvivid-can-backup'))
        {
            ...
            $tabs['general_setting']['title']=__('Backup', 'wpvivid-backup-pro');
            ...
            $tabs['advance_setting']['title']=__('Backup (Advanced)', 'wpvivid-backup-pro');
    ...
    public function trim_import_info($json)
    {
        ...
        if(isset($json['data']['wpvivid_local_setting']))
        {
            $local_setting = get_option('wpvivid_local_setting', array());

            if(array_key_exists('path', $local_setting))
            {
                $json['data']['wpvivid_local_setting']['path'] = $local_setting['path'];
            }
            else
            {
            ...
            if(array_key_exists('outside_path', $local_setting))
            {
                $json['data']['wpvivid_local_setting']['outside_path'] = $local_setting['outside_path'];
            }
            else
            {
                unset($json['data']['wpvivid_local_setting']['outside_path']);
            }
        }

        if(isset($json['data']['wpvivid_common_setting']))
        {
            ...
            $preserve_keys = array(
                'local_backup_folder',
                'log_save_location',
                'log_save_location_outside'
            );

            foreach($preserve_keys as $key)
            {
                if(array_key_exists($key, $common_setting))
                {
                    $json['data']['wpvivid_common_setting'][$key] = $common_setting[$key];
                }
                else
                {
                    unset($json['data']['wpvivid_common_setting'][$key]);
                }
            }
        }
    ...
    public function wpvivid_set_general_setting($setting_data, $setting, $options)
    {
        ...
        $setting_data['wpvivid_dashboard_addons_display']['staging'] = isset($setting['show_dashboard_staging']) && intval($setting['show_dashboard_staging']) === 1 ? 1 : 0;
        $setting_data['wpvivid_dashboard_addons_display']['database_snapshots'] = isset($setting['show_dashboard_database_snapshots']) && intval($setting['show_dashboard_database_snapshots']) === 1 ? 1 : 0;
        $setting_data['wpvivid_dashboard_addons_display']['unused_image_cleaner'] = isset($setting['show_dashboard_unused_image_cleaner']) && intval($setting['show_dashboard_unused_image_cleaner']) === 1 ? 1 : 0;
        $setting_data['wpvivid_dashboard_addons_display']['url_replacement'] = isset($setting['show_dashboard_url_replacement']) && intval($setting['show_dashboard_url_replacement']) === 1 ? 1 : 0;
        $setting_data['wpvivid_dashboard_addons_display']['rollback'] = isset($setting['show_dashboard_rollback']) && intval($setting['show_dashboard_rollback']) === 1 ? 1 : 0;
        $setting_data['wpvivid_dashboard_addons_display']['roles_capabilities'] = isset($setting['show_dashboard_roles_capabilities']) && intval($setting['show_dashboard_roles_capabilities']) === 1 ? 1 : 0;
        $setting_data['wpvivid_dashboard_addons_display']['export_import_post_page'] = isset($setting['show_dashboard_export_import_post_page']) && intval($setting['show_dashboard_export_import_post_page']) === 1 ? 1 : 0;
        $setting_data['wpvivid_dashboard_addons_display']['white_label'] = isset($setting['show_dashboard_white_label']) && intval($setting['show_dashboard_white_label']) === 1 ? 1 : 0;
        $setting_data['wpvivid_dashboard_addons_display']['image_optimization_pro'] = isset($setting['show_dashboard_image_optimization_pro']) && intval($setting['show_dashboard_image_optimization_pro']) === 1 ? 1 : 0;
    ...
    public function export_setting_addon($json)
    {
        ...
        // Do not export the site-specific backup folder settings.
        if(isset($json['data']['wpvivid_common_setting']))
        {
            unset($json['data']['wpvivid_common_setting']['local_backup_folder']);
            unset($json['data']['wpvivid_common_setting']['log_save_location']);
            unset($json['data']['wpvivid_common_setting']['log_save_location_outside']);
        }
    ...
    public function check_setting_option($data)
    {
        ...
        {
            $ret['error']=__('The value of \'split a backup every this size\' can\'t be empty.', 'wpvivid-backup-pro');
            return $ret;
        }
        ...
        {
            $ret['error']=__('\'The number of database tables compressed to each zip\' cannot be empty.', 'wpvivid-backup-pro');
            return $ret;
        }
        ...
        {
            $ret['error']=__('The value of \'exclude files lager than this size\' can\'t be empty.', 'wpvivid-backup-pro');
        }
        ...
        {
            $ret['error']=__('The value of \'maximum PHP script execution time for a backup task\' can\'t be empty.', 'wpvivid-backup-pro');
        }
        ...
        {
            $ret['error']=__('The value of \'maximum PHP script execution time for a restore task\' can\'t be empty.', 'wpvivid-backup-pro');
        }
        ...
        {
            $ret['error']=__('The value of \'maximum PHP memory for a backup task\' can\'t be empty.', 'wpvivid-backup-pro');
        }
        ...
        {
            $ret['error']=__('The value of \'maximum PHP memory for a restore task\' can\'t be empty.', 'wpvivid-backup-pro');
        }
        ...
        {
            $ret['error']=__('The value of \'chunk size\' can\'t be empty.', 'wpvivid-backup-pro');
        }
        ...
        if( apply_filters('wpvivid_current_user_can',true,'wpvivid-can-use-image-cleaner'))
        {
            ...
            {
                $ret['error']=__('The value of \'Posts Quantity Processed Per Request\' can\'t be empty.', 'wpvivid-backup-pro');
            }
            ...
            {
                $ret['error']=__('The value of \'Media Files Quantity Processed Per Request\' can\'t be empty.', 'wpvivid-backup-pro');
            }
        ...
        if(!isset($data['path']))
        {
            $ret['error']=__('The local storage path is required.', 'wpvivid-backup-pro');
        }
        ...
        if(isset($data['domain_include'])){
            if($data['domain_include'] == '1'){
                if(!isset($data['backup_prefix']) || empty($data['backup_prefix'])){
                    $ret['error']=__('A prefix for backup files is required. Please enter a valid prefix or uncheck the option.', 'wpvivid-backup-pro');
                    return $ret;
                }
            }
        }
        ...
        if(isset($data['use_mail_title'])){
            if($data['use_mail_title'] == '1'){
                if(!isset($data['mail_title']) || empty($data['mail_title'])){
                    $ret['error']=__('Please specify a custom title to emails or disable the customization for email title.', 'wpvivid-backup-pro');
                    return $ret;
                }
            }
        }
        ...
        if(isset($data['db_connect_method']) && $data['db_connect_method'] === 'pdo') {
            if (class_exists('PDO')) {
                ...
                if (!array_search('pdo_mysql', $extensions)) {
                    $ret['error'] = __('The pdo_mysql extension is not detected. Please install the extension first or choose wpdb option for Database connection method.', 'wpvivid-backup-pro');
                    return $ret;
                }
            } else {
                $ret['error'] = __('The pdo_mysql extension is not detected. Please install the extension first or choose wpdb option for Database connection method.', 'wpvivid-backup-pro');
    ...
    public function add_send_mail()
    {
        ...
        try
        {
            if (isset($_POST['send_to']) && !empty($_POST['send_to']) && is_string($_POST['send_to']))
            {
                ...
                {
                    $ret['result'] = 'failed';
                    $ret['error'] = __('Invalid email address', 'wpvivid-backup-pro');
                    ...
                    {
                        $ret['result'] = 'failed';
                        $ret['error'] = __('Unable to send email. Please check the configuration of email server.', 'wpvivid-backup-pro');
                    } else {
                        $ret['result'] = 'success';
                        $ret['html']  =  '';
                        $ret['html'] .= '<tr>';
    ...
    public function clean_local_storage_ex()
    {
        ...
        try
        {
            ...
            if($options['log']=='0' && $options['backup_cache']=='0' && $options['junk_files']=='0' && $options['old_files']=='0')
            {
                ...
                $ret['msg']=__('Choose at least one type of junk files for deleting.', 'wpvivid-backup-pro');
                echo json_encode($ret);
                die();
            }
            $delete_files = array();
            ...
            $ret['result']='success';
            $ret['msg']=__('The selected junk files have been deleted.', 'wpvivid-backup-pro');
            $ret['data']=$this->_junk_files_info_ex();
    ...
    public function output_manual_backup_count_setting_page()
    {
        ...
        <div>
            <div>
                <p><?php esc_html_e('Manual Backup', 'wpvivid-backup-pro'); ?></p>
                <p><input type="text" class="wpvivid-backup-count-retention" placeholder="30" option="setting" name="manual_max_backup_count" id="manual_max_backup_count" value="<?php echo esc_attr($manual_max_backup_count); ?>"> <?php esc_html_e('(localhost) File backups retained.', 'wpvivid-backup-pro'); ?></p>
                <p><input type="text" class="wpvivid-backup-count-retention" placeholder="30" option="setting" name="manual_max_backup_db_count" id="manual_max_backup_db_count" value="<?php echo esc_attr($manual_max_backup_db_count); ?>"> <?php esc_html_e('(localhost) Database backups retained.', 'wpvivid-backup-pro'); ?></p>
                <p><input type="text" class="wpvivid-backup-count-retention" placeholder="30" option="setting" name="manual_max_remote_backup_count" id="manual_max_remote_backup_count" value="<?php echo esc_attr($max_remote_backup_count); ?>"> <?php esc_html_e('(remote storage) File backups retained.', 'wpvivid-backup-pro'); ?></p>
                <p><input type="text" class="wpvivid-backup-count-retention" placeholder="30" option="setting" name="manual_max_remote_backup_db_count" id="manual_max_remote_backup_db_count" value="<?php echo esc_attr($max_remote_backup_db_count); ?>"> <?php esc_html_e('(remote storage) Database backups retained.', 'wpvivid-backup-pro'); ?></p>
            </div>
        </div>
        <?php
    }
    ...
    public function output_schedule_backup_count_setting_page()
    {
        ...
        <div>
            <div>
                <p><?php esc_html_e('Schedule(General)', 'wpvivid-backup-pro'); ?></p>
                <p><input type="text" class="wpvivid-backup-count-retention" placeholder="30" option="setting" name="schedule_max_backup_count" id="schedule_max_backup_count" value="<?php echo esc_attr($schedule_max_backup_count); ?>"> <?php esc_html_e('(localhost) File backups retained.', 'wpvivid-backup-pro'); ?></p>
                <p><input type="text" class="wpvivid-backup-count-retention" placeholder="30" option="setting" name="schedule_max_backup_db_count" id="schedule_max_backup_db_count" value="<?php echo esc_attr($schedule_max_backup_db_count); ?>"> <?php esc_html_e('(localhost) Database backups retained.', 'wpvivid-backup-pro'); ?></p>
                <p><input type="text" class="wpvivid-backup-count-retention" placeholder="30" option="setting" name="schedule_max_remote_backup_count" id="schedule_max_remote_backup_count" value="<?php echo esc_attr($max_remote_backup_count); ?>"> <?php esc_html_e('(remote storage) File backups retained.', 'wpvivid-backup-pro'); ?></p>
                <p><input type="text" class="wpvivid-backup-count-retention" placeholder="30" option="setting" name="schedule_max_remote_backup_db_count" id="schedule_max_remote_backup_db_count" value="<?php echo esc_attr($max_remote_backup_db_count); ?>"> <?php esc_html_e('(remote storage) Database backups retained.', 'wpvivid-backup-pro'); ?></p>
            </div>
        </div>
        <?php
    }
    ...
    public function output_incremental_schedule_backup_count_setting_page()
    {
        ...
        <div>
            <div>
                <p><?php esc_html_e('Schedule(Incremental)', 'wpvivid-backup-pro'); ?></p>
                <p><input type="text" class="wpvivid-backup-count-retention" placeholder="3" option="setting" name="incremental_max_db_count" id="incremental_max_db_count" value="<?php echo esc_attr($incremental_max_db_count); ?>"> <?php esc_html_e('(localhost)Incremental Database Backups retained.', 'wpvivid-backup-pro'); ?></p>
                <p><input type="text" class="wpvivid-backup-count-retention" placeholder="3" option="setting" name="incremental_max_backup_count" id="incremental_max_backup_count" value="<?php echo esc_attr($incremental_max_backup_count); ?>"> <?php esc_html_e('(localhost) Cycles of incremental backups retained.', 'wpvivid-backup-pro'); ?></p>
                <p><input type="text" class="wpvivid-backup-count-retention" placeholder="3" option="setting" name="incremental_max_remote_backup_count" id="incremental_max_remote_backup_count" value="<?php echo esc_attr($incremental_max_remote_backup_count); ?>"> <?php esc_html_e('(remote storage) Cycles of incremental backups retained.', 'wpvivid-backup-pro'); ?></p>
            </div>
        </div>
        <?php
    }
    ...
    public function check_file_is_a_wpvivid_backup($file_name,&$backup_id)
    {
        if (WPvivid_backup_pro_function::is_wpvivid_backup($file_name))
        {
            if ($id =WPvivid_backup_pro_function::get_wpvivid_backup_id($file_name))
            {
                ...
                foreach ($list as $remote_backup_id => $backup_value)
                {
                    if($remote_backup_id === $id)
                    {
                        return false;
                    }
                }
    ...
    public function output_general_setting()
    {
        ...
        $dashboard_addons_display = get_option('wpvivid_dashboard_addons_display', array());
        $dashboard_addons_display = wp_parse_args($dashboard_addons_display, array(
            'staging'                 => 1,
            'database_snapshots'      => 1,
            'unused_image_cleaner'    => 1,
            'url_replacement'         => 1,
            'rollback'                => 1,
            'roles_capabilities'      => 1,
            'export_import_post_page' => 1,
            'white_label'             => 1,
            'image_optimization_pro'  => 1,
        ));
        $show_dashboard_staging = intval($dashboard_addons_display['staging']) === 1 ? 'checked' : '';
        $show_dashboard_database_snapshots = intval($dashboard_addons_display['database_snapshots']) === 1 ? 'checked' : '';
        $show_dashboard_unused_image_cleaner = intval($dashboard_addons_display['unused_image_cleaner']) === 1 ? 'checked' : '';
        $show_dashboard_url_replacement = intval($dashboard_addons_display['url_replacement']) === 1 ? 'checked' : '';
        $show_dashboard_rollback = intval($dashboard_addons_display['rollback']) === 1 ? 'checked' : '';
        $show_dashboard_roles_capabilities = intval($dashboard_addons_display['roles_capabilities']) === 1 ? 'checked' : '';
        $show_dashboard_export_import_post_page = intval($dashboard_addons_display['export_import_post_page']) === 1 ? 'checked' : '';
        $show_dashboard_white_label = intval($dashboard_addons_display['white_label']) === 1 ? 'checked' : '';
        $show_dashboard_image_optimization_pro = intval($dashboard_addons_display['image_optimization_pro']) === 1 ? 'checked' : '';

        ?>
        <div>
            <table class="wp-list-table widefat plugins" style="border-left:none;border-top:none;border-right:none;">
                <tr>
                    <td class="row-title" style="min-width:200px;"><label for="tablecell"><?php esc_html_e('General', 'wpvivid-backup-pro'); ?></label></td>
                    <td>
                        <p>
                            <label class="wpvivid-checkbox">
                                <span><?php esc_html_e('Remove the oldest backups stored in remote storage before creating a backup if the current backups reached the limit of backup retention for remote storage. It is recommended to uncheck this option if there is a unstable connection between your site and remote storage', 'wpvivid-backup-pro'); ?></span>
                                <input type="checkbox" option="setting" name="clean_old_remote_before_backup" id="wpvivid_clean_old_remote" <?php echo esc_attr($clean_old_remote_before_backup); ?>>
                                <span class="wpvivid-checkbox-checkmark"></span>
                            </label>
                        </p>
                        <p>
                            <label class="wpvivid-checkbox">
                                <span><?php esc_html_e('Calculate the size of files, folder and database before backing up', 'wpvivid-backup-pro'); ?></span>
                        ...
                        <p>
                            <label class="wpvivid-checkbox">
                                <span><?php printf(esc_html__('Show %s backup plugin on top admin bar', 'wpvivid-backup-pro'), esc_html(apply_filters('wpvivid_white_label_display', 'WPvivid'))); ?></span>
                        ...
                        <p>
                            <label class="wpvivid-checkbox">
                                <span><?php esc_html_e('Merge all backup parts into single zip when a backup completes. This helps save disk spaces but can cause timeouts on restricted servers. We recommended unchecking it on servers with limited resources.', 'wpvivid-backup-pro'); ?></span>
                        ...
                        <p>
                            <label class="wpvivid-checkbox">
                                <span><?php esc_html_e('Keep storing the backups in localhost after uploading to remote storage', 'wpvivid-backup-pro'); ?></span>
                        ...
                        <p>
                            <label class="wpvivid-checkbox">
                                <span><?php esc_html_e('The out-of-date backups will be removed if the current value of backup retention is lower than the previous one, which is irreversible', 'wpvivid-backup-pro'); ?></span>
                                <input type="checkbox" option="setting" name="remove_out_of_date" <?php echo esc_attr($wpvivid_remove_out_of_date); ?>>
                                <span class="wpvivid-checkbox-checkmark"></span>
                            </label>
                        </p>
                        <p>
                            <label class="wpvivid-checkbox">
                                <span>
                                    ...
                                    printf(
                                        esc_html__(
                                            'Delete the /%1$s folder when deleting %2$s Backup Pro. Caution: This folder may contain %2$s Pro and Free backups, once deleted, any backups in it will be permanently lost!',
                                            'wpvivid-backup-pro'
                                        ),
                                        esc_html($general_setting['options']['wpvivid_local_setting']['path']),
                                        esc_html(apply_filters('wpvivid_white_label_display', 'WPvivid'))
                                    );
                                    ?>
                                </span>
                        ...
                        <p>
                            <label class="wpvivid-checkbox">
                                <span><?php esc_html_e('Do not show the plugin update notice on my website pages.', 'wpvivid-backup-pro'); ?></span>
                                <input type="checkbox" option="setting" name="hide_admin_update_notice" <?php echo esc_attr($hide_admin_update_notice); ?>>
                                <span class="wpvivid-checkbox-checkmark"></span>
                            </label>
                        </p>
                        <p>
                            <label class="wpvivid-checkbox">
                                <span><?php esc_html_e('Back up symlink folders. Including symlink folders may cause backup/migration failure. Uncheck this option unless you know how symlink folders work.', 'wpvivid-backup-pro'); ?></span>
                ...
                <tr>
                    <td class="row-title" style="min-width:200px;"><label for="tablecell"><?php esc_html_e('Backup Retention', 'wpvivid-backup-pro'); ?></label></td>
                    <td>
                        <?php
                        ...
                        $args['is_parent_tab']=0;
                        $tabs['manual_backup']['title']=__('Manual Backup', 'wpvivid-backup-pro');
                        ...
                        $args['div_style']='';
                        $tabs['general_schedule']['title']=__('Schedule(General)', 'wpvivid-backup-pro');
                        ...
                        $tabs['incremental_schedule']['title']=__('Schedule(Incremental)', 'wpvivid-backup-pro');
                ...
                <tr>
                    <td class="row-title" style="min-width:200px;"><label for="tablecell"><?php esc_html_e('Default location for backups', 'wpvivid-backup-pro'); ?>:</label></td>
                    <td>
                        <p><?php esc_html_e('Set the default location for backups', 'wpvivid-backup-pro'); ?>:</p>
                        <p></p>
                        <fieldset>
                            <label class="wpvivid-radio" style="float:left; padding-right:1em;">
                                <input type="radio" option="setting" name="default_backup_local" value="1" <?php echo esc_attr($default_backup_local); ?> /><?php esc_html_e('Localhost(web server)', 'wpvivid-backup-pro'); ?>
                                <span class="wpvivid-radio-checkmark"></span>
                            </label>
                            <label class="wpvivid-radio" style="float:left; padding-right:1em;"><?php esc_html_e('Cloud Storage', 'wpvivid-backup-pro'); ?>
                                <input type="radio" option="setting" name="default_backup_local" value="0" <?php echo esc_attr($default_backup_remote); ?> />
                                <span class="wpvivid-radio-checkmark"></span>
                            </label>
                        </fieldset>
                    </td>
                ...
                <tr>
                    <td class="row-title" style="min-width:200px;"><label for="tablecell"><?php esc_html_e('Backup folder', 'wpvivid-backup-pro'); ?></label></td>
                    <td>
                        <p>Set backup folder</p>
                        <p></p>
                        <fieldset>
                            <label class="wpvivid-radio" style="float:left; padding-right:1em;">
                                <input type="radio" option="setting" name="local_backup_folder" value="content_folder" <?php echo esc_attr($backup_content_folder); ?> /><?php esc_html_e('Backup to wp-content folder', 'wpvivid-backup-pro'); ?>
                                <span class="wpvivid-radio-checkmark"></span>
                            </label>
                            <label class="wpvivid-radio" style="float:left; padding-right:1em;"><?php esc_html_e('Backup to outside the website directory', 'wpvivid-backup-pro'); ?>
                                <input type="radio" option="setting" name="local_backup_folder" value="outside_folder" <?php echo esc_attr($backup_outside_folder); ?> />
                                <span class="wpvivid-radio-checkmark"></span>
                            </label>
                        </fieldset>
                        <div id="wpvivid_part_backup_content_folder" style="<?php echo esc_attr($hide_part_content_folder); ?>">
                            <input type="text" placeholder="wpvividbackups" option="setting" name="path" id="wpvivid_option_backup_dir" value="<?php echo esc_attr($general_setting['options']['wpvivid_local_setting']['path']); ?>" style="width: 290px;" onkeyup="value=value.replace(/[^\a-\z\A-\Z0-9]/g,'')" onpaste="value=value.replace(/[^\a-\z\A-\Z0-9]/g,'')" /> <?php esc_html_e('Name your folder, this folder must be writable for creating backup files.', 'wpvivid-backup-pro'); ?>
                        </div>
                        <div id="wpvivid_part_backup_outside_folder" style="<?php echo esc_attr($hide_part_outside_folder); ?>">
                            <p>
                                <code><?php esc_html_e('Store backups outside the website directory. Enter the full path to your desired directory, for example, if your website directory is /var/www/html/wordpress, then the path can be /var/www/html/wpvividbackups.', 'wpvivid-backup-pro'); ?></code>
                            </p>
                            <input type="text" placeholder="/var/www/html/wpvividbackups" option="setting" name="outside_path" id="wpvivid_option_outside_backup_dir" value="<?php echo esc_attr($wpvivid_option_outside_backup_dir); ?>" style="width: 290px;" />
                            <input class="button-secondary" id="wpvivid_check_outside_backup_folder" type="submit" value="<?php esc_attr_e('Test Path', 'wpvivid-backup-pro'); ?>">
                            <span class="dashicons dashicons-editor-help wpvivid-dashicons-editor-help wpvivid-tooltip wpvivid-tooltip-padding-top">
                                <div class="wpvivid-bottom">
                                    ...
                                    <p><?php esc_html_e('Notes:', 'wpvivid-backup-pro'); ?></p>
                                    <p><?php esc_html_e('1. The parent folder of the specified path should have read, write permissions and user group permissions. This allows the plugin to create the backup folder. For example, if you enter /var/www/html/wpvividbackups, make sure /var/www/html has the necessary permissions.', 'wpvivid-backup-pro'); ?></p>
                                    <p><?php esc_html_e('2. Use unique backup folders for each website to prevent accidental deletion of backups from other sites.', 'wpvivid-backup-pro'); ?></p>
                                    <p><?php esc_html_e('3. After entering the path, click the "Test Path" button to verify its availability.', 'wpvivid-backup-pro'); ?></p>
                        ...
                        <p></p>
                        <div>
                            <input type="text" id="wpvivid_backup_prefix" placeholder="Enter prefix (e.g. test)" value="<?php echo esc_attr($prefix); ?>" option="setting" name="backup_prefix" style="width: 290px;" onkeyup="value=value.replace(/[^a-zA-Z0-9._]/g,'')" onpaste="value=value.replace(/[^\a-\z\A-\Z0-9]/g,'')" /> <?php esc_html_e('Add a prefix to all backup files', 'wpvivid-backup-pro'); ?>
                            <span class="dashicons dashicons-editor-help wpvivid-dashicons-editor-help wpvivid-tooltip wpvivid-tooltip-padding-top">
                                <div class="wpvivid-bottom">
                                    <!-- The content you need -->
                                    <p><?php esc_html_e('Only letters (except for wpvivid) and numbers are allowed. This will help you identify backups if you store backups of many websites in one directory.', 'wpvivid-backup-pro'); ?></p>
                                    <i></i> <!-- do not delete this line -->
                                </div>
                            </span>
                        </div>
                ...
                <tr>
                    <td class="row-title" style="min-width:200px;"><label for="tablecell"><?php esc_html_e('Database encryption', 'wpvivid-backup-pro'); ?></label></td>
                    <td>
                        <p>
                            <label class="wpvivid-checkbox">
                                <span><?php esc_html_e('Enable database encryption', 'wpvivid-backup-pro'); ?></span>
                                <input type="checkbox" id="wpvivid_encrypt_db" option="setting" name="encrypt_db" <?php echo esc_attr($encrypt_db_check); ?> />
                                <span class="wpvivid-checkbox-checkmark"></span>
                            </label>
                        </p>
                        <p>
                            <input type="password" class="all-options" id="wpvivid_encrypt_db_pw" option="setting" name="encrypt_db_password" value="<?php echo esc_attr($password); ?>" <?php echo esc_attr($encrypt_db_disable); ?> /> <?php esc_html_e('Enter a password here to encrypt your database backups.', 'wpvivid-backup-pro'); ?>
                        </p>
                        <p>
                ...
                <tr>
                    <td class="row-title" style="min-width:200px;"><label for="tablecell"><?php esc_html_e('Email report', 'wpvivid-backup-pro'); ?></label></td>
                    <td>
                        <div style="padding:0 1em 1em 0;">
                            ...
                            <span class="dashicons dashicons-editor-help wpvivid-dashicons-editor-help wpvivid-tooltip">
                                <div class="wpvivid-bottom">
                                    <!-- The content you need -->
                                    <p><?php esc_html_e('WordPress uses the PHP Mail function to send its emails by default, which is not supported by many hosts and can cause issues if it is not set properly.', 'wpvivid-backup-pro'); ?></p>
                                    <i></i> <!-- do not delete this line -->
                                </div>
                            </span>
                        </div>
                        <p>
                            ...
                            <input class="button-secondary" id="wpvivid_send_email_test" type="submit" value="<?php esc_attr_e('Test and Add', 'wpvivid-backup-pro'); ?>" title="<?php esc_attr_e('Send an email for testing mail function', 'wpvivid-backup-pro'); ?>">
                        </p>
                        <div id="wpvivid_send_email_res" style="display: none;"></div>
                        <div>
                            <table class="widefat">
                                <tr>
                                    <th class="row-title"><?php esc_html_e('Email Address', 'wpvivid-backup-pro'); ?></th>
                                    <th><?php esc_html_e('Action', 'wpvivid-backup-pro'); ?></th>
                                </tr>
                                ...
                                if(isset($general_setting['options']['wpvivid_email_setting_addon']['send_to'])){
                                    foreach ($general_setting['options']['wpvivid_email_setting_addon']['send_to'] as $mail => $value){
                                        ...
                                        ?>
                                        <tr>
                                            <td class="row-title" option="email_list"><label for="tablecell"><?php echo esc_html($value['email_address']); ?></label></td>
                        ...
                        <div style="padding:1em 1em 0 0;">
                            ...
                            <fieldset>
                                <label class="wpvivid-radio" style="float:left; padding-right:1em;">
                                    <input type="radio" option="setting" name="always" value="1" <?php echo esc_attr($wpvivid_setting_email_always); ?> /><?php esc_html_e('Always send an email notification when a backup is complete', 'wpvivid-backup-pro'); ?>
                                    <span class="wpvivid-radio-checkmark"></span>
                                </label>
                                <label class="wpvivid-radio" style="float:left; padding-right:1em;">
                                    <input type="radio" option="setting" name="always" value="0" <?php echo esc_attr($wpvivid_setting_email_failed); ?> /><?php esc_html_e('Only send an email notification when a backup fails', 'wpvivid-backup-pro'); ?>
                                    <span class="wpvivid-radio-checkmark"></span>
                                </label>
                            </fieldset>
                            ...
                            <p>
                                <label class="wpvivid-checkbox">
                                    <span><?php esc_html_e('Attach the log when sending a report', 'wpvivid-backup-pro'); ?></span>
                                    <input type="checkbox" option="setting" name="email_attach_log" <?php echo esc_attr($wpvivid_email_attach_log); ?> />
                                    <span class="wpvivid-checkbox-checkmark"></span>
                                </label>
                            </p>
                            ...
                            <div>
                                <label class="wpvivid-checkbox">
                                    <span><?php esc_html_e('Comment the email subject', 'wpvivid-backup-pro'); ?></span>
                                    <span class="dashicons dashicons-editor-help wpvivid-dashicons-editor-help wpvivid-tooltip">
                                        <div class="wpvivid-bottom">
                                            <!-- The content you need -->
                                            <p><?php esc_html_e('Add a custom subject to WPvivid backup email reports for easy identification. The default subject is the domain name of the current website.', 'wpvivid-backup-pro'); ?></p>
                                            <i></i> <!-- do not delete this line -->
                                        </div>
                                    </span>
                                    <input type="checkbox" option="setting" name="use_mail_title" <?php echo esc_attr($wpvivid_use_mail_title); ?> /><span class="wpvivid-checkbox-checkmark"></span>
                                </label>
                            </div>
                            <p><input type="text" id="wpvivid_mail_title" option="setting" name="mail_title" value="<?php echo esc_attr($mail_title); ?>" placeholder="www.domain.com" <?php echo esc_attr($wpvivid_mail_title_style); ?> /></p>
                            <p>
                                <span>e.g. [</span><span><?php echo esc_html($mail_title); ?></span><span><?php echo sprintf(__(': Backup Succeeded]12-04-2019 07:04:57 - By %s.', 'wpvivid-backup-pro'), apply_filters('wpvivid_white_label_display', 'WPvivid Backup Plugin')); ?></span>
                            </p>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    <td class="row-title" style="min-width:200px;"><label for="tablecell"><?php esc_html_e('Export/Import settings', 'wpvivid-backup-pro'); ?></label></td>
                    <td>
                        <table class="widefat" style="border:none;box-shadow:none;">
                            <tr>
                                <td>
                                    <p><input id="wpvivid_setting_export" type="button" name="" value="<?php esc_attr_e('Export', 'wpvivid-backup-pro'); ?>"><?php echo sprintf(__('Click \'Export\' button to save %s settings on your local computer.', 'wpvivid-backup-pro'), apply_filters('wpvivid_white_label_display', WPVIVID_PRO_PLUGIN_SLUG)); ?></p>
                                </td>
                                <td>
                                    <p><input type="file" name="fileTrans" id="wpvivid_select_import_file"></p>
                                    <p><input id="wpvivid_setting_import" type="button" name="" value="<?php esc_attr_e('Import', 'wpvivid-backup-pro'); ?>"><?php echo sprintf(__('Importing the json file can help you set %s\'s configuration on another wordpress site quickly.', 'wpvivid-backup-pro'), apply_filters('wpvivid_white_label_display', WPVIVID_PRO_PLUGIN_SLUG)); ?></p>
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td class="row-title" style="min-width:200px;"><label for="tablecell"><?php esc_html_e('Show addons & tools on dashboard', 'wpvivid-backup-pro'); ?></label></td>
                    <td>
                        <p>
                            <label class="wpvivid-checkbox">
                                <span><?php esc_html_e('Staging', 'wpvivid-backup-pro'); ?></span>
                                <input type="checkbox" option="setting" name="show_dashboard_staging" <?php echo esc_attr($show_dashboard_staging); ?>>
                                <span class="wpvivid-checkbox-checkmark"></span>
                            </label>
                        </p>
                        ...
                        <p>
                            <label class="wpvivid-checkbox">
                                <span><?php esc_html_e('Database Snapshots', 'wpvivid-backup-pro'); ?></span>
                                <input type="checkbox" option="setting" name="show_dashboard_database_snapshots" <?php echo esc_attr($show_dashboard_database_snapshots); ?>>
                                <span class="wpvivid-checkbox-checkmark"></span>
                            </label>
                        </p>
                        ...
                        <p>
                            <label class="wpvivid-checkbox">
                                <span><?php esc_html_e('Unused Image Cleaner', 'wpvivid-backup-pro'); ?></span>
                                <input type="checkbox" option="setting" name="show_dashboard_unused_image_cleaner" <?php echo esc_attr($show_dashboard_unused_image_cleaner); ?>>
                                <span class="wpvivid-checkbox-checkmark"></span>
                            </label>
                        </p>
                        ...
                        <p>
                            <label class="wpvivid-checkbox">
                                <span><?php esc_html_e('URL Replacement', 'wpvivid-backup-pro'); ?></span>
                                <input type="checkbox" option="setting" name="show_dashboard_url_replacement" <?php echo esc_attr($show_dashboard_url_replacement); ?>>
                                <span class="wpvivid-checkbox-checkmark"></span>
                            </label>
                        </p>
                        ...
                        <p>
                            <label class="wpvivid-checkbox">
                                <span><?php esc_html_e('Rollback', 'wpvivid-backup-pro'); ?></span>
                                <input type="checkbox" option="setting" name="show_dashboard_rollback" <?php echo esc_attr($show_dashboard_rollback); ?>>
                                <span class="wpvivid-checkbox-checkmark"></span>
                            </label>
                        </p>
                        ...
                        <p>
                            <label class="wpvivid-checkbox">
                                <span><?php esc_html_e('Roles & Capabilities', 'wpvivid-backup-pro'); ?></span>
                                <input type="checkbox" option="setting" name="show_dashboard_roles_capabilities" <?php echo esc_attr($show_dashboard_roles_capabilities); ?>>
                                <span class="wpvivid-checkbox-checkmark"></span>
                            </label>
                        </p>
                        ...
                        <p>
                            <label class="wpvivid-checkbox">
                                <span><?php esc_html_e('Export/Import Post or Page', 'wpvivid-backup-pro'); ?></span>
                                <input type="checkbox" option="setting" name="show_dashboard_export_import_post_page" <?php echo esc_attr($show_dashboard_export_import_post_page); ?>>
                                <span class="wpvivid-checkbox-checkmark"></span>
                            </label>
                        </p>
                        ...
                        <p>
                            <label class="wpvivid-checkbox">
                                <span><?php esc_html_e('White Label', 'wpvivid-backup-pro'); ?></span>
                                <input type="checkbox" option="setting" name="show_dashboard_white_label" <?php echo esc_attr($show_dashboard_white_label); ?>>
                                <span class="wpvivid-checkbox-checkmark"></span>
                            </label>
                        </p>
                        ...
                        if(!empty($dashboard_info['plugins']) && isset($dashboard_info['plugins']))
                        {
                        ...
                        if(isset($plugins['imgoptim_pro']))
                        {
                            ...
                            <p>
                                <label class="wpvivid-checkbox">
                                    <span><?php esc_html_e('Image Optimization Pro', 'wpvivid-backup-pro'); ?></span>
                                    <input type="checkbox" option="setting" name="show_dashboard_image_optimization_pro" <?php echo esc_attr($show_dashboard_image_optimization_pro); ?>>
                                    <span class="wpvivid-checkbox-checkmark"></span>
                                </label>
                            </p>
                            <?php
                ...
                <tr>
                    <td class="row-title" style="min-width:200px;"><label for="tablecell"><?php esc_html_e('Auto calculate site size', 'wpvivid-backup-pro'); ?></label></td>
                    <td>
                        <p>
                            <label class="wpvivid-checkbox">
                                <span><?php esc_html_e( 'Enable automatic site size calculation', 'wpvivid-backup-pro' ); ?></span>
                        ...
                        <select option="setting" name="auto_calc_site_size_interval">
                            <option value="wpvivid_daily" <?php selected($auto_calc_site_size_interval, 'wpvivid_daily'); ?>><?php esc_html_e('Daily', 'wpvivid-backup-pro'); ?></option>
                            <option value="wpvivid_2days" <?php selected($auto_calc_site_size_interval, 'wpvivid_2days'); ?>><?php esc_html_e('Every 2 days', 'wpvivid-backup-pro'); ?></option>
                            <option value="wpvivid_3days" <?php selected($auto_calc_site_size_interval, 'wpvivid_3days'); ?>><?php esc_html_e('Every 3 days', 'wpvivid-backup-pro'); ?></option>
                            <option value="wpvivid_4days" <?php selected($auto_calc_site_size_interval, 'wpvivid_4days'); ?>><?php esc_html_e('Every 4 days', 'wpvivid-backup-pro'); ?></option>
                            <option value="wpvivid_5days" <?php selected($auto_calc_site_size_interval, 'wpvivid_5days'); ?>><?php esc_html_e('Every 5 days', 'wpvivid-backup-pro'); ?></option>
                            <option value="wpvivid_6days" <?php selected($auto_calc_site_size_interval, 'wpvivid_6days'); ?>><?php esc_html_e('Every 6 days', 'wpvivid-backup-pro'); ?></option>
                            <option value="wpvivid_weekly" <?php selected($auto_calc_site_size_interval, 'wpvivid_weekly'); ?>><?php esc_html_e('Weekly', 'wpvivid-backup-pro'); ?></option>
                        </select>
                        <span class="dashicons dashicons-editor-help wpvivid-dashicons-editor-help wpvivid-tooltip wpvivid-tooltip-padding-top">
                            <div class="wpvivid-bottom">
                                <!-- The content you need -->
                                <p><?php esc_html_e('When enabled, WPvivid automatically calculates your website size at the selected interval to keep the size information on your dashboard up to date. This calculation runs in the background and will not start immediately, the execution depends on WordPress cron and site traffic.', 'wpvivid-backup-pro'); ?></p>
                                <i></i> <!-- do not delete this line -->
                            </div>
                        </span>
                    </td>
                ...
                <tr>
                    <td class="row-title" style="min-width:200px;"><label for="tablecell"><?php echo sprintf(__('Web-server disk space in use by %s', 'wpvivid-backup-pro'), apply_filters('wpvivid_white_label_display', 'WPvivid')); ?></label></td>
                    <td>
                        <p>
                            <span><?php esc_html_e('Total Size:', 'wpvivid-backup-pro'); ?></span>
                            <span class="wpvivid-size-calc" id="wpvivid_junk_sum_size"><?php echo esc_html($junk_file['sum_size']); ?></span>
                            <span style="margin-left: 5px;"><?php esc_html_e( 'Backup Size:', 'wpvivid-backup-pro' ); ?></span>
                            <span class="wpvivid-size-calc" id="wpvivid_backup_size"><?php echo esc_html($junk_file['backup_size']); ?></span>
                            <input class="button-secondary" id="wpvivid_calculate_size" style="margin-left:10px;" type="submit" name="Calculate-Sizes" value="<?php esc_attr_e( 'Calculate Sizes', 'wpvivid-backup-pro' ); ?>" />
                        </p>

                        <p>
                            <label class="wpvivid-checkbox">
                                <span><?php esc_html_e( 'Logs Size:', 'wpvivid-backup-pro' ); ?></span>
                                <span class="wpvivid-size-calc" id="wpvivid_log_size"><?php echo esc_html($junk_file['log_dir_size']); ?></span>
                                <input type="checkbox" id="wpvivid_junk_log" option="setting" name="clean_local_storage_log" value="junk-log" <?php echo esc_attr($clean_local_storage_log); ?> />
                                <span class="wpvivid-checkbox-checkmark"></span>
                            </label>
                        </p>
                        ...
                        <p>
                            <label class="wpvivid-checkbox">
                                <span><?php esc_html_e( 'Backup Cache Size:', 'wpvivid-backup-pro' ); ?></span>
                                <span class="wpvivid-size-calc" id="wpvivid_backup_cache_size"><?php echo esc_html($junk_file['backup_cache_size']); ?></span>
                                <input type="checkbox" id="wpvivid_junk_backup_cache" option="setting" name="clean_local_storage_backup_cache" value="junk-backup-cache" <?php echo esc_attr($clean_local_storage_backup_cache); ?>/>
                                <span class="wpvivid-checkbox-checkmark"></span>
                            </label>
                        </p>
                        <p>
                            <label class="wpvivid-checkbox">
                                <span><?php esc_html_e( 'Junk Size:', 'wpvivid-backup-pro' ); ?></span>
                                <span class="wpvivid-size-calc" id="wpvivid_junk_size"><?php echo esc_html($junk_file['junk_size']); ?></span>
                                <input type="checkbox" id="wpvivid_junk_file" option="setting" name="clean_local_storage_junk_files" value="junk-files" <?php echo esc_attr($clean_local_storage_junk_files); ?>/>
                                <span class="wpvivid-checkbox-checkmark"></span>
                            </label>
                        </p>

                        <p>
                            <input class="button-primary" id="wpvivid_clean_junk_file" type="submit" name="Empty-all-files" value="<?php esc_attr_e( 'Empty Now', 'wpvivid-backup-pro' ); ?>" />
                            <?php esc_html_e('or Empty per', 'wpvivid-backup-pro'); ?>
                            <select id="wpvivid_clean_local_storage" option="setting" name="clean_local_storage_recurrence">
                                <option value="wpvivid_hourly"><?php esc_html_e('Every hour', 'wpvivid-backup-pro'); ?></option>
                                <option value="wpvivid_2hours"><?php esc_html_e('Every 2 hours', 'wpvivid-backup-pro'); ?></option>
                                <option value="wpvivid_4hours"><?php esc_html_e('Every 4 hours', 'wpvivid-backup-pro'); ?></option>
                                <option value="wpvivid_8hours"><?php esc_html_e('Every 8 hours', 'wpvivid-backup-pro'); ?></option>
                                <option value="wpvivid_12hours"><?php esc_html_e('Every 12 hours', 'wpvivid-backup-pro'); ?></option>
                                <option value="wpvivid_daily"><?php esc_html_e('Daily', 'wpvivid-backup-pro'); ?></option>
                                <option value="wpvivid_2days"><?php esc_html_e('Every 2 days', 'wpvivid-backup-pro'); ?></option>
                                <option value="wpvivid_weekly"><?php esc_html_e('Weekly', 'wpvivid-backup-pro'); ?></option>
                                <option value="wpvivid_fortnightly"><?php esc_html_e('Fortnightly', 'wpvivid-backup-pro'); ?></option>
                                <option value="wpvivid_monthly"><?php esc_html_e('Every 30 days', 'wpvivid-backup-pro'); ?></option>
                            </select>
                        </p>
                    </td>
                </tr>
                ...
                <tr>
                    <td class="row-title" style="min-width:200px;"><label for="tablecell"><?php esc_html_e('Remove out-of-date backups', 'wpvivid-backup-pro'); ?></label></td>
                    <td>
                        <p>
                            <span><?php esc_html_e('Web Server Directory:', 'wpvivid-backup-pro'); ?></span>
                            <span id="wpvivid_out_of_date_local_path"><?php echo esc_html($out_of_date['web_server']); ?></span>
                        </p>

                        <p>
                            <span style="margin-right: 2px;"><?php esc_html_e('Remote Storage Directory:', 'wpvivid-backup-pro'); ?></span>
                        ...
                        <p>
                            <input class="button-primary" id="wpvivid_delete_out_of_backup" style="margin-right:10px;" type="submit" name="delete-out-of-backup" value="<?php esc_attr_e( 'Remove', 'wpvivid-backup-pro' ); ?>" />
                        </p>

                        <p><?php esc_html_e('The action is irreversible! It will remove all backups which are out-of-date (including local web server and remote storage) if they exist.', 'wpvivid-backup-pro'); ?></p>
                    </td>
                </tr>
            </table>
        </div>
        <div style="padding:1em 1em 0 0;"><input class="button-primary wpvivid_setting_general_save" type="submit" value="<?php esc_attr_e('Save Changes', 'wpvivid-backup-pro'); ?>"></div>
        <script>
                ...
                wpvivid_post_request_addon(ajax_data, function(data){
                    try {
                        ...
                        if (jsonarray.result === "success") {
                            ...
                            alert(wpvivid_ajax_object_addon.i18n.success_path_is_valid_and_accessible);
                        }
                        else {
            ...
            function wpvivid_delete_out_of_date_backups(){
                ...
                wpvivid_post_request_addon(ajax_data, function(data){
                    ...
                    try {
                        var jsonarray = jQuery.parseJSON(data);
                        if (jsonarray.result === "success") {
                            alert(wpvivid_ajax_object_addon.i18n.out_of_date_backups_removed);
                        }
                    }
                    catch(err){
                        alert(err);
            ...
            {
                jQuery('#wpvivid_clean_local_storage').val('<?php echo esc_attr($clean_local_storage_recurrence); ?>');
                wpvivid_calculate_diskspaceused();
            });
        </script>
        <?php
        ...
        <table class="widefat" style="border-left:none;border-top:none;border-right:none;">
            <tr>
                <td class="row-title" style="min-width:200px;">
                    <label for="tablecell"><?php esc_html_e('Learning Mode', 'wpvivid-backup-pro'); ?></label>
                </td>
                <td>
                    <p>
                        <label class="wpvivid-checkbox">
                            <span><?php esc_html_e('Enable Learning Mode', 'wpvivid-backup-pro'); ?></span>
                            <input type="checkbox" option="setting" name="use_adaptive_settings" <?php echo esc_attr($use_adaptive_settings); ?> />
                            <span class="wpvivid-checkbox-checkmark"></span>
                        </label>
                    </p>
                    <p><code><?php esc_html_e('Designed for servers with limited resources. Enabling it can improve backup success rates, but may result in longer backup time.', 'wpvivid-backup-pro'); ?></code></p>
                </td>
            </tr>

            <tr>
                <td class="row-title" style="min-width:200px;">
                    <label for="tablecell"><?php esc_html_e('Auto Delete Backup Log', 'wpvivid-backup-pro'); ?></label>
                </td>
                <td>
                    <p>
                        <label class="wpvivid-checkbox">
                            <span><?php esc_html_e('Automatically delete corresponding logs when deleting backups', 'wpvivid-backup-pro'); ?></span>
                            <input type="checkbox" option="setting" name="auto_delete_backup_log" <?php echo esc_attr($auto_delete_backup_log); ?> />
                            <span class="wpvivid-checkbox-checkmark"></span>
                        </label>
                    </p>
                </td>
            ...
            <tr>
                <td class="row-title" style="min-width:200px;">
                    <label for="tablecell"><?php esc_html_e('Large Database Mode', 'wpvivid-backup-pro'); ?></label>
                </td>
                <td>
                    <p>
                        <label class="wpvivid-checkbox">
                            <span><?php esc_html_e('This mode optimizes backup process for high-volume data. You can try to enable it if backups fail or time out due to a very large database', 'wpvivid-backup-pro'); ?></span>
                            <input type="checkbox" option="setting" name="backup_database_use_primary_key" <?php echo esc_attr($backup_database_use_primary_key); ?> />
                            <span class="wpvivid-checkbox-checkmark"></span>
                        </label>
                    </p>
                </td>
            ...
            <tr>
                <td class="row-title" style="min-width:200px;">
                    <label for="tablecell"><?php esc_html_e('Large Uploads Mode', 'wpvivid-backup-pro'); ?></label>
                </td>
                <td>
                    <p>
                        <label class="wpvivid-checkbox">
                            <span><?php esc_html_e('This mode improves backup performance for extensive media libraries. You can try to enable it if backups are slow or fail because of a large number of files in the uploads folder. This mode only supports ZipArchive, it will not work with PclZip', 'wpvivid-backup-pro'); ?></span>
                            <input type="checkbox" option="setting" name="backup_upload_use_cm_store" <?php echo esc_attr($backup_upload_use_cm_store); ?> />
                            <span class="wpvivid-checkbox-checkmark"></span>
                        </label>
                    </p>
                </td>
            ...
            <tr>
                <td class="row-title" style="min-width:200px;"><label for="tablecell"><?php esc_html_e('Large Uploads Mode', 'wpvivid-backup-pro'); ?>Database access method</label></td>
                <td>
                    <div>
                        <fieldset>
                            <label class="wpvivid-radio" style="float:left; padding-right:1em;">
                                <input type="radio" option="setting" name="db_connect_method" value="wpdb" <?php echo esc_attr($db_method_wpdb); ?> /><strong><?php esc_html_e('WPDB', 'wpvivid-backup-pro'); ?></strong>
                                <span class="wpvivid-radio-checkmark"></span>
                                <span class="dashicons dashicons-editor-help wpvivid-dashicons-editor-help wpvivid-tooltip">
                                    <div class="wpvivid-bottom">
                                        <!-- The content you need -->
                                        <p><?php esc_html_e('WPDB option has a better compatibility, but the speed of backup and restore is slower.', 'wpvivid-backup-pro'); ?></p>
                                        <i></i> <!-- do not delete this line -->
                                    </div>
                                </span>
                            </label>
                            <label class="wpvivid-radio" style="float:left; padding-right:1em;"><strong><?php esc_html_e('PDO', 'wpvivid-backup-pro'); ?></strong>
                                <input type="radio" option="setting" name="db_connect_method" value="pdo" <?php echo esc_attr($db_method_pdo); ?> />
                                <span class="wpvivid-radio-checkmark"></span>
                                <span class="dashicons dashicons-editor-help wpvivid-dashicons-editor-help wpvivid-tooltip">
                                    <div class="wpvivid-bottom">
                                        <!-- The content you need -->
                                        <p><?php esc_html_e('It is recommended to choose PDO option if pdo_mysql extension is installed on your server, which lets you backup and restore your site faster.', 'wpvivid-backup-pro'); ?></p>
                                        <i></i> <!-- do not delete this line -->
                                    </div>
                                </span>
                            </label>
            ...
            <tr>
                <td class="row-title" style="min-width:200px;"><label for="tablecell"><?php esc_html_e('Backup compression method', 'wpvivid-backup-pro'); ?></label></td>
                <td>
                    <div>
                        <fieldset>
                            <label class="wpvivid-radio" style="float:left; padding-right:1em;">
                                <input type="radio" option="setting" name="zip_method" value="ziparchive" <?php echo esc_attr($zip_method_archive); ?> /><strong><?php esc_html_e('ZipArchive', 'wpvivid-backup-pro'); ?></strong>
                                <span class="wpvivid-radio-checkmark"></span>
                                <span class="dashicons dashicons-editor-help wpvivid-dashicons-editor-help wpvivid-tooltip">
                                    <div class="wpvivid-bottom">
                                        <!-- The content you need -->
                                        <p><?php esc_html_e('ZipArchive has a better flexibility which provides a higher backup success rate and speed. It is also the default zip method WPvivid pro uses. Using this method requires the ZIP extension to be installed within your PHP.', 'wpvivid-backup-pro'); ?></p>
                                        <i></i> <!-- do not delete this line -->
                                    </div>
                                </span>
                            </label>
                            <label class="wpvivid-radio" style="float:left; padding-right:1em;"><strong><?php esc_html_e('PclZip', 'wpvivid-backup-pro'); ?></strong>
                                <input type="radio" option="setting" name="zip_method" value="pclzip" <?php echo esc_attr($zip_method_pclzip); ?> />
                                <span class="wpvivid-radio-checkmark"></span>
                                <span class="dashicons dashicons-editor-help wpvivid-dashicons-editor-help wpvivid-tooltip">
                                    <div class="wpvivid-bottom">
                                        <!-- The content you need -->
                                        <p><?php esc_html_e('PclZip is a much slower but more stable zip method that is included in every WordPress install. WPvivid will automatically switch to PclZip if the ZIP extension is not installed within your PHP.', 'wpvivid-backup-pro'); ?></p>
                                        <i></i> <!-- do not delete this line -->
                                    </div>
                                </span>
                            </label>
            ...
            <tr>
                <td class="row-title" style="min-width:200px;"><label for="tablecell"><?php esc_html_e('Backup performance mode', 'wpvivid-backup-pro'); ?></label></td>
                <td>
                    <div>
                        <fieldset>
                            <label class="wpvivid-radio" style="float:left; padding-right:1em;">
                                <input type="radio" option="setting" name="backup_params" value="low" <?php echo esc_attr($backup_params_low); ?> /><strong><?php esc_html_e('Low (Balanced)', 'wpvivid-backup-pro'); ?></strong>
                                <span class="wpvivid-radio-checkmark"></span>
                                <span class="dashicons dashicons-editor-help wpvivid-dashicons-editor-help wpvivid-tooltip">
                                    <div class="wpvivid-bottom">
                                        <!-- The content you need -->
                                        <p><?php esc_html_e('Low (Balanced): Use this default setting for minimal server resource usage, but expect longer backup times. Best for shared hosting or limited resources. Backups are split into 200MB chunks.', 'wpvivid-backup-pro'); ?></p>
                                        <i></i> <!-- do not delete this line -->
                                    </div>
                                </span>
                            </label>
                            <label class="wpvivid-radio" style="float:left; padding-right:1em;">
                                <input type="radio" option="setting" name="backup_params" value="mid" <?php echo esc_attr($backup_params_mid); ?> /><strong><?php esc_html_e('Mid (Standard)', 'wpvivid-backup-pro'); ?></strong>
                                <span class="wpvivid-radio-checkmark"></span>
                                <span class="dashicons dashicons-editor-help wpvivid-dashicons-editor-help wpvivid-tooltip">
                                    <div class="wpvivid-bottom">
                                        <!-- The content you need -->
                                        <p><?php esc_html_e('Mid (Standard): This mode offers a good balance between backup speed and resource usage. It\'s suitable for most web hosting environments.', 'wpvivid-backup-pro'); ?></p>
                                        <i></i> <!-- do not delete this line -->
                                    </div>
                                </span>
                            </label>
                            <label class="wpvivid-radio" style="float:left; padding-right:1em;">
                                <input type="radio" option="setting" name="backup_params" value="high" <?php echo esc_attr($backup_params_high); ?> /><strong><?php esc_html_e('High (Accelerated)', 'wpvivid-backup-pro'); ?></strong>
                                <span class="wpvivid-radio-checkmark"></span>
                                <span class="dashicons dashicons-editor-help wpvivid-dashicons-editor-help wpvivid-tooltip">
                                    <div class="wpvivid-bottom">
                                        <!-- The content you need -->
                                        <p><?php esc_html_e('High (Accelerated): This mode uses more server resources to reduce backup time, but is only recommended for dedicated servers. If backups time out or get stuck, consider Mid or Low mode. Backups are split into 4GB chunks.', 'wpvivid-backup-pro'); ?></p>
                                        <i></i> <!-- do not delete this line -->
                                    </div>
                                </span>
                            </label>
                            <label class="wpvivid-radio" style="float:left; padding-right:1em;">
                                <input type="radio" option="setting" name="backup_params" value="custom" <?php echo esc_attr($backup_params_custom); ?> /><strong><?php esc_html_e('Custom (Advanced)', 'wpvivid-backup-pro'); ?></strong>
                                <span class="wpvivid-radio-checkmark"></span>
                                <span class="dashicons dashicons-editor-help wpvivid-dashicons-editor-help wpvivid-tooltip">
                                    <div class="wpvivid-bottom">
                                        <!-- The content you need -->
                                        <p><?php esc_html_e('Custom (Advanced): This mode allows fine-tuning of backup parameters. Incorrect configuration can lead to backup failures. It is recommended to use only with specific guidance from our support team.', 'wpvivid-backup-pro'); ?></p>
                                        <i></i> <!-- do not delete this line -->
                                    </div>
                                </span>
                            </label>
                    ...
                    <p></p>
                    <div id="wpvivid_custom_backup_params" style="<?php echo esc_attr($backup_custom_setting_display); ?>">
                        <div>
                            <span><input type="text" placeholder="<?php echo esc_attr($compress_file_count); ?>" option="setting" name="compress_file_count" id="compress_file_count" class="all-options" value="<?php echo esc_attr($compress_file_count); ?>" onkeyup="value=value.replace(/\D/g,'')"></span><span><?php esc_html_e('The number of files compressed to the backup zip each time', 'wpvivid-backup-pro'); ?></span>
                            <span class="dashicons dashicons-editor-help wpvivid-dashicons-editor-help wpvivid-tooltip wpvivid-tooltip-padding-top">
                            <div class="wpvivid-bottom">
                                <!-- The content you need -->
                                <p><?php esc_html_e('When taking a backup, the plugin will compress this number of files to the backup zip each time. The default value is 500. The lower the value, the longer time the backup will take, but the higher the backup success rate. If you encounter a backup timeout issue, try to decrease this value.', 'wpvivid-backup-pro'); ?></p>
                                <i></i> <!-- do not delete this line -->
                            </div>
                        </span>
                        </div>
                        <p></p>
                        <div>
                            <span><input type="text" placeholder="200" option="setting" name="max_file_size" id="wpvivid_max_zip" class="all-options" value="<?php esc_attr_e(str_replace('M', '', $max_file_size), 'wpvivid-backup-pro'); ?>" onkeyup="value=value.replace(/\D/g,'')">MB</span><span>, <?php esc_html_e('split a backup every this size', 'wpvivid-backup-pro'); ?></span>
                            <span class="dashicons dashicons-editor-help wpvivid-dashicons-editor-help wpvivid-tooltip wpvivid-tooltip-padding-top">
                            <div class="wpvivid-bottom">
                                <!-- The content you need -->
                                <p><?php esc_html_e('Some web hosting providers limit large zip files (e.g. 200MB), and therefore splitting your backup into many parts is an ideal way to avoid hitting the limitation if you are running a big website. Please try to adjust the value if you are encountering backup errors. When you set a value of 0MB, backups will be split every 4GB.', 'wpvivid-backup-pro'); ?></p>
                                <i></i> <!-- do not delete this line -->
                            </div>
                        </span>
                        </div>
                        <p></p>
                        <div>
                            <span><input type="text" placeholder="1000" option="setting" name="max_backup_table" id="wpvivid_max_backup_table" class="all-options" value="<?php echo esc_attr($max_backup_table); ?>" onkeyup="value=value.replace(/\D/g,'')"><?php esc_html_e('The number of database tables compressed to each zip', 'wpvivid-backup-pro'); ?></span>
                            <span class="dashicons dashicons-editor-help wpvivid-dashicons-editor-help wpvivid-tooltip wpvivid-tooltip-padding-top">
                            <div class="wpvivid-bottom">
                                <!-- The content you need -->
                                <p><?php esc_html_e('When taking a database backup, the plugin will compress this number of tables to each backup zip. The default value is 1000 which works for most websites.', 'wpvivid-backup-pro'); ?></p>
                                <i></i> <!-- do not delete this line -->
                            </div>
                        </span>
                        </div>
                        <p></p>
                        <div>
                            <span><input type="text" placeholder="400" option="setting" name="max_sql_file_size" class="all-options" value="<?php esc_attr_e(str_replace('M', '', $max_sql_file_size), 'wpvivid-backup-pro'); ?>" onkeyup="value=value.replace(/\D/g,'')">MB</span><span>, <?php esc_html_e('split a sql file every this size', 'wpvivid-backup-pro'); ?></span>
                            <span class="dashicons dashicons-editor-help wpvivid-dashicons-editor-help wpvivid-tooltip wpvivid-tooltip-padding-top">
                            <div class="wpvivid-bottom">
                                <!-- The content you need -->
                                <p><?php esc_html_e('Some web hosting providers limit large files, therefore, splitting your sql files into many parts is an ideal way to avoid hitting the limitation. Please try to adjust the value if you get a backup timeout error. The default value is 400, and it is not recommended to set the value lower than 100.', 'wpvivid-backup-pro'); ?></p>
                                <i></i> <!-- do not delete this line -->
                            </div>
                        </span>
                        </div>
                        <p></p>
                        <div>
                            <span><input type="text" placeholder="0" option="setting" name="exclude_file_size" id="wpvivid_ignore_large" class="all-options" value="<?php echo esc_attr($exclude_file_size); ?>" onkeyup="value=value.replace(/\D/g,'')">MB</span><span>, <?php esc_html_e('exclude files larger than this size', 'wpvivid-backup-pro'); ?></span>
                            <span class="dashicons dashicons-editor-help wpvivid-dashicons-editor-help wpvivid-tooltip wpvivid-tooltip-padding-top">
                            <div class="wpvivid-bottom">
                                <!-- The content you need -->
                                <p><?php esc_html_e('Using the option will ignore the file larger than the certain size in MB when backing up, \'0\' (zero) means unlimited.', 'wpvivid-backup-pro'); ?></p>
                                <i></i> <!-- do not delete this line -->
                            </div>
                        </span>
                        </div>
                        <p></p>
                        <div>
                            <span><input type="text" placeholder="900" option="setting" name="max_execution_time" id="wpvivid_option_timeout" class="all-options" value="<?php echo esc_attr($max_execution_time); ?>" onkeyup="value=value.replace(/\D/g,'')">Seconds</span><span>, <?php esc_html_e('maximum PHP script execution time for a backup task', 'wpvivid-backup-pro'); ?></span>
                            <span class="dashicons dashicons-editor-help wpvivid-dashicons-editor-help wpvivid-tooltip wpvivid-tooltip-padding-top">
                            <div class="wpvivid-bottom">
                                <!-- The content you need -->
                                <p><?php esc_html_e('The time-out is not your server PHP time-out. With the execution time exhausted, our plugin will shut the process of backup down. If the progress of backup encounters a time-out, that means you have a medium or large sized website, please try to scale the value bigger.', 'wpvivid-backup-pro'); ?></p>
                                <i></i> <!-- do not delete this line -->
                            </div>
                        </span>
                        </div>
                        <p></p>
                        <div>
                            <span><input type="text" placeholder="256" option="setting" name="memory_limit" class="all-options" value="<?php esc_attr_e(str_replace('M', '', $memory_limit), 'wpvivid-backup-pro'); ?>" onkeyup="value=value.replace(/\D/g,'')">MB</span><span>, <?php esc_html_e('maximum PHP memory for a backup task', 'wpvivid-backup-pro'); ?></span>
                            <span class="dashicons dashicons-editor-help wpvivid-dashicons-editor-help wpvivid-tooltip wpvivid-tooltip-padding-top">
                            <div class="wpvivid-bottom">
                                <!-- The content you need -->
                                <p><?php esc_html_e('Adjust this value to apply for a temporary PHP memory limit for WPvivid backup plugin to run a backup. We set this value to 256M by default. Increase the value if you encounter a memory exhausted error. Note: some web hosting providers may not support this.', 'wpvivid-backup-pro'); ?></p>
                                <i></i> <!-- do not delete this line -->
                            </div>
                        </span>
                        </div>
                        <p></p>
                        <div>
                            <span><input type="text" placeholder="2048" option="setting" name="migrate_size" class="all-options" value="<?php echo esc_attr($migrate_size); ?>" onkeyup="value=value.replace(/\D/g,'')">KB</span><span>, <?php esc_html_e('chunk size', 'wpvivid-backup-pro'); ?></span>
                            <span class="dashicons dashicons-editor-help wpvivid-dashicons-editor-help wpvivid-tooltip wpvivid-tooltip-padding-top">
                            <div class="wpvivid-bottom">
                                <!-- The content you need -->
                                <p><?php esc_html_e('e.g. if you choose a chunk size of 2MB, a 8MB file will use 4 chunks. Decreasing this value will break the ISP\'s transmission limit, for example:512KB', 'wpvivid-backup-pro'); ?></p>
                                <i></i> <!-- do not delete this line -->
                            </div>
                        </span>
                        </div>
        ...
        <script>
            ...
            jQuery('.wpvivid_setting_general_save').click(function(){
                ...
                if(old_local_backup_folder === 'content_folder' && new_local_backup_folder === 'outside_folder')
                {
                    ...
                    {
                        alert(wpvivid_ajax_object_addon.i18n.verify_directory_accessibility_test_path);
                        return;
                    }
                }
                ...
                if(new_local_backup_folder === 'outside_folder')
                {
                    ...
                    if(old_outside_path !== new_outside_path)
                    {
                        if(!has_check_outside_folder)
                        {
                            alert(wpvivid_ajax_object_addon.i18n.ensure_directory_accessibility_test_path);
                            return;
                        }
                    }
                }
                ...
                if (encrypt_db_checked) {
                    ...
                    if (pw === '') {
                        alert(wpvivid_ajax_object_addon.i18n.please_enter_a_password_for_database_encryption);
            ...
            function wpvivid_set_general_settings()
            {
                ...
                {
                    alert(wpvivid_ajax_object_addon.i18n.files_per_zip_invalid_range);
                    return;
                }
                ...
                {
                    alert(wpvivid_ajax_object_addon.i18n.db_tables_per_zip_invalid_range);
                    return;
                }
            ...
            jQuery('#wpvivid_backup_prefix').on("keyup", function(){
                ...
                if (backup_prefix.match(reg)) {
                    ...
                    alert(wpvivid_ajax_object_addon.i18n.wpvivid_reserved_backup_comment);
                }
            });
            ...
            jQuery('.wpvivid-backup-count-retention').on("keyup", function(){
                ...
                if(!regExp.test(input_value)){
                    alert(wpvivid_ajax_object_addon.i18n.only_enter_numbers_from_1_999);
                    jQuery(this).val('');
                }
            });
            ...
            function wpvivid_add_email()
            {
                ...
                if(mail !== '') {
                    ...
                    if(!repeat) {
                        ...
                        alert(wpvivid_ajax_object_addon.i18n.email_alreay_in_list);
                    }
                }
                else{
                    alert(wpvivid_ajax_object_addon.i18n.mail_is_required);
                }
            }
            ...
            function wpvivid_import_settings(){
                ...
                if(files.length == 0){
                    alert(wpvivid_ajax_object_addon.i18n.choose_settings_file_to_import);
                    return;
                }
                else{
                    ...
                    reader.onload = function(evt){
                        ...
                        wpvivid_post_request_addon(ajax_data, function(data){
                            try {
                                var jsonarray = jQuery.parseJSON(data);
                                if (jsonarray.result === 'success') {
                                    alert(wpvivid_ajax_object_addon.i18n.the_plugin_settings_were_imported_successfully);
                                    ...
                                    alert(wpvivid_ajax_object_addon.i18n.error_with_message + jsonarray.error);
                                }
                            }
                            catch(err){
                                alert(err);
    ...
    public function output_staging_setting()
    {
        ...
        <div class="wpvivid-one-coloum wpvivid-workflow wpvivid-clear-float" style="padding-top: 0;">
            <div class="wpvivid-element-space-bottom"><strong><?php esc_html_e('DB Copy Count', 'wpvivid-backup-pro'); ?></strong></div>
            ...
            <div class="wpvivid-element-space-bottom">
                <?php esc_html_e( 'Number of DB rows, that are copied within one ajax query. The higher value makes the database copy process faster. Please try a high value to find out the highest possible value. If you encounter timeout errors, try lower values until no more errors occur.', 'wpvivid-backup-pro'); ?>
            </div>

            <div class="wpvivid-element-space-bottom"><strong><?php esc_html_e('DB Replace Count', 'wpvivid-backup-pro'); ?></strong></div>
            <div class="wpvivid-element-space-bottom">
            ...
            <div class="wpvivid-element-space-bottom">
                <?php esc_html_e( 'Number of DB rows, that are processed within one ajax query. The higher value makes the DB replacement process faster. If timeout erros occur, decrease the value because this process consumes a lot of memory.', 'wpvivid-backup-pro'); ?>
            </div>

            <div class="wpvivid-element-space-bottom"><strong><?php esc_html_e('File Copy Count', 'wpvivid-backup-pro'); ?></strong></div>
            <div class="wpvivid-element-space-bottom">
            ...
            <div class="wpvivid-element-space-bottom">
                <?php esc_html_e( 'Number of files to copy that will be copied within one ajax request. The higher value makes the file file copy process faster. Please try a high value to find out the highest possible value. If you encounter timeout errors, try lower values until no more errors occur.', 'wpvivid-backup-pro'); ?>
            </div>

            <div class="wpvivid-element-space-bottom"><strong><?php esc_html_e('Max File Size', 'wpvivid-backup-pro'); ?></strong></div>
            <div class="wpvivid-element-space-bottom">
            ...
            <div class="wpvivid-element-space-bottom">
                <?php esc_html_e( 'Maximum size of the files copied to a staging site. All files larger than this value will be ignored. If you set the value of 0 MB, all files will be copied to a staging site.', 'wpvivid-backup-pro'); ?>
            </div>

            <div class="wpvivid-element-space-bottom"><strong><?php esc_html_e('Staging Memory Limit', 'wpvivid-backup-pro'); ?></strong></div>
            <div class="wpvivid-element-space-bottom">
            ...
            <div class="wpvivid-element-space-bottom">
                <?php echo sprintf(__('Adjust this value to apply for a temporary PHP memory limit for %s while creating a staging site. We set this value to 256M by default. Increase the value if you encounter a memory exhausted error. Note: some web hosting providers may not support this.', 'wpvivid-backup-pro'), apply_filters( 'wpvivid_white_label_display', 'WPvivid backup plugin' )); ?>
            </div>

            <div class="wpvivid-element-space-bottom"><strong><?php esc_html_e('PHP Script Execution Timeout', 'wpvivid-backup-pro'); ?></strong></div>
            <div class="wpvivid-element-space-bottom">
            ...
            <div class="wpvivid-element-space-bottom">
                <?php esc_html_e( 'The time-out is not your server PHP time-out. With the execution time exhausted, our plugin will shut down the progress of creating a staging site. If the progress  encounters a time-out, that means you have a medium or large sized website. Please try to scale the value bigger.', 'wpvivid-backup-pro'); ?>
            </div>

            <div class="wpvivid-element-space-bottom"><strong><?php esc_html_e('Delay Between Requests', 'wpvivid-backup-pro'); ?></strong></div>
            <div class="wpvivid-element-space-bottom">
            ...
            <div class="wpvivid-element-space-bottom">
                <?php esc_html_e( 'A lower value will help speed up the process of creating a staging site. However, if your server has a limit on the number of requests, a higher value is recommended.', 'wpvivid-backup-pro'); ?>
            </div>

            <div class="wpvivid-element-space-bottom">
                <strong><?php esc_html_e('Retrying', 'wpvivid-backup-pro'); ?> </strong>
                <select option="setting" name="staging_resume_count">
                    ...
                    for($resume_count=3; $resume_count<10; $resume_count++){
                        if($resume_count === $staging_resume_count){
                            ?>
                            <option selected="selected" value="<?php echo esc_attr($resume_count); ?>"><?php echo esc_html($resume_count); ?></option>
                            <?php
                        }
                        else{
                            ?>
                            <option value="<?php echo esc_attr($resume_count); ?>"><?php echo esc_html($resume_count); ?></option>
                            <?php
                        }
                    }
                    ?>
                </select><strong><?php esc_html_e(' times when encountering a time-out error', 'wpvivid-backup-pro'); ?></strong>
            </div>

            <div class="wpvivid-element-space-bottom">
                <label>
                    <input type="checkbox" option="setting" name="not_need_login" <?php echo esc_attr($staging_not_need_login_check); ?> />
                    <span><strong><?php esc_html_e('Anyone can visit the staging site', 'wpvivid-backup-pro'); ?></strong></span>
                </label>
            </div>
            ...
            <div class="wpvivid-element-space-bottom">
                <label>
                    ...
                    <span><strong><?php esc_html_e('Keep permalink when transferring website', 'wpvivid-backup-pro'); ?></strong></span>
                </label>
            </div>
            ...
            <div><input class="button-primary wpvividstg_save_setting" type="submit" value="<?php esc_attr_e( 'Save Changes', 'wpvivid-backup-pro' ); ?>" /></div>
        </div>
