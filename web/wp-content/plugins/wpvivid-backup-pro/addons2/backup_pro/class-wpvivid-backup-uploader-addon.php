...
class Wpvivid_BackupUploader_addon
{
    ...
    static function rescan_local_folder()
    {
        ...
        <div class="wpvivid-element-space-bottom">
            <div style="float: left; margin-bottom: 10px; margin-right: 10px;">
                <input type="submit" class="button-primary" id="wpvivid_rescan_local_folder_btn" value="<?php esc_attr_e('Scan uploaded backup or received backup', 'wpvivid-backup-pro'); ?>" onclick="wpvivid_rescan_local_folder();" style="float: left;" />
            </div>
            <small>
    ...
    static function upload_meta_box()
    {
        ...
        <div id="wpvivid_plupload-upload-ui" class="hide-if-no-js" style="margin-bottom: 10px;">
            <div id="drag-drop-area">
                <div class="drag-drop-inside">
                    <p class="drag-drop-info"><?php esc_html_e('Drop files here', 'wpvivid-backup-pro'); ?></p>
                    <p><?php _ex('or', 'Uploader: Drop files here - or - Select Files'); ?></p>
                    <p class="drag-drop-buttons"><input id="wpvivid_select_file_button" type="button" value="<?php esc_attr_e('Select Files', 'wpvivid-backup-pro'); ?>" class="button" /></p>
                </div>
            </div>
        </div>
        ...
        <div style="margin-bottom: 10px;">
            <input type="submit" class="button-primary" id="wpvivid_upload_submit_btn" value="<?php esc_attr_e('Upload', 'wpvivid-backup-pro'); ?>" onclick="wpvivid_submit_upload();" />
            <input type="submit" class="button-primary" id="wpvivid_stop_upload_btn" value="<?php esc_attr_e('Cancel', 'wpvivid-backup-pro'); ?>" onclick="wpvivid_cancel_upload();" />
        </div>
        <div class="wpvivid-one-coloum wpvivid-workflow wpvivid-clear-float">
            ...
            <span><strong><?php esc_html_e('Please make sure to upload all the backup parts in a set (if any), at a time.', 'wpvivid-backup-pro'); ?></strong></span>
        </div>
        <div style="clear: both;"></div>
        <?php
                    ...
                    if(!brepeat)
                    {
                        ...
                        wpvivid_post_request_addon(ajax_data, function (data)
                        {
                            ...
                            if (jsonarray.result === "success")
                            {
                                ...
                                {
                                    alert(wpvivid_ajax_object_addon.i18n.backup_already_exists_target_folder);
                                    exist_files = '';
                                }
                    ...
                    wpvivid_post_request_addon(ajax_data, function (data)
                    {
                        try
                        {
                            ...
                            if(jsonarray.result === 'success')
                            {
                                ...
                                {
                                    alert(wpvivid_ajax_object_addon.i18n.the_upload_has_completed);
                                }
                                jQuery( document ).trigger( 'wpvivid_update_local_backup');
    ...
    static function upload_meta_box_ex()
    {
        ...
        <div id="wpvivid_plupload-upload-ui-ex" class="hide-if-no-js" style="margin-bottom: 10px;">
            <div id="drag-drop-area">
                <div class="drag-drop-inside">
                    <p class="drag-drop-info"><?php esc_html_e('Drag & Drop files to import', 'wpvivid-backup-pro'); ?></p>
                    <p><?php _ex('or', 'Uploader: Drop files here - or - Select Files'); ?></p>
                    <p class="drag-drop-buttons"><input id="wpvivid_select_file_button_ex" type="button" value="<?php esc_attr_e('Select Files', 'wpvivid-backup-pro'); ?>" class="button" /></p>
                </div>
            </div>
        </div>
        ...
        <div class="wpvivid-v2-uploaded-box" id="wpvivid_upload_file_list_part" style="display: none;">
            <div class="wpvivid-v2-uploaded-header wpvivid-upload-complete-notice" style="display: none;">
                <h2 class="wpvivid-v2-uploaded-title">
                    ...
                    <?php esc_html_e('The backup uploaded', 'wpvivid-backup-pro'); ?>
                </h2>
                <p class="wpvivid-v2-uploaded-tip">
                    <span class="dashicons dashicons-lightbulb wpvivid-v2-dashicons-orange"></span>
                    <?php esc_html_e('You can restore the backup to the site now, or restore it later on', 'wpvivid-backup-pro'); ?>
                    <a href="<?php echo apply_filters('wpvivid_white_label_page_redirect', 'admin.php?page=wpvivid-backup-and-restore', 'wpvivid-backup-and-restore'); ?>"><?php esc_html_e('Backup Manager Page', 'wpvivid-backup-pro'); ?></a>.
                </p>
            </div>
            ...
            <div class="wpvivid-v2-uploaded-footer">
                <button class="wpvivid-v2-btn-primary" id="wpvivid_restore_upload_backup_now" onclick="wpvivid_restore_upload_backup_now();" style="display: none;"><?php esc_html_e('Restore Now', 'wpvivid-backup-pro'); ?></button>
            </div>
        </div>

        <div style="clear: both;"></div>
        <div style="margin-top: 10px;">
            <input type="submit" class="button-primary" id="wpvivid_upload_submit_btn_ex" value="<?php esc_attr_e('Upload', 'wpvivid-backup-pro'); ?>" onclick="wpvivid_submit_upload_ex();" />
            <input type="submit" class="button-primary" id="wpvivid_stop_upload_btn_ex" value="<?php esc_attr_e('Cancel', 'wpvivid-backup-pro'); ?>" onclick="wpvivid_stop_upload_ex();" />
        </div>
        <div style="clear: both;"></div>
        <?php
