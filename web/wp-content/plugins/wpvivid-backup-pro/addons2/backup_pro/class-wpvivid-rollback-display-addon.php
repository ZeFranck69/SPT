...
class WPvivid_Rollback_Plugins_List extends WP_List_Table
{
    ...
    public function get_columns()
    {
        ...
        $columns['wpvivid_status'] = __( 'Status', 'wpvivid-backup-pro' );
        $columns['wpvivid_plugins'] = __( 'Plugins', 'wpvivid-backup-pro' );
        $columns['wpvivid_date2'] = __( 'Date', 'wpvivid-backup-pro' );
        $columns['wpvivid_version'] =__( 'Current/Latest', 'wpvivid-backup-pro'  );
        $columns['wpvivid_version_backup'] = __( 'Versioning Backups', 'wpvivid-backup-pro' );
        $columns['wpvivid_rollback'] = __( 'Rollback', 'wpvivid-backup-pro' );
        $columns['wpvivid_location'] = __( 'Location', 'wpvivid-backup-pro' );
        return $columns;
    }
...
class WPvivid_Themes_List extends WP_List_Table
{
    ...
    public function get_columns()
    {
        ...
        $columns['cb'] = __( 'cb', 'wpvivid-backup-pro' );
        $columns['wpvivid_status'] = __( 'Status', 'wpvivid-backup-pro' );
        $columns['wpvivid_themes'] = __( 'Themes', 'wpvivid-backup-pro' );
        $columns['wpvivid_date'] = __( 'Date', 'wpvivid-backup-pro' );
        $columns['wpvivid_version'] =__( 'Current/Latest', 'wpvivid-backup-pro'  );
        $columns['wpvivid_version_backup'] = __( 'Versioning Backups', 'wpvivid-backup-pro' );
        $columns['wpvivid_rollback'] = __( 'Rollback', 'wpvivid-backup-pro' );
        $columns['wpvivid_location'] = __( 'Location', 'wpvivid-backup-pro' );
...
class WPvivid_Core_List extends WP_List_Table
{
    ...
    public function get_columns()
    {
        $columns = array();
        $columns['cb'] = __( 'cb', 'wpvivid-backup-pro' );
        $columns['wpvivid_version'] = __( 'Version', 'wpvivid-backup-pro' );
        $columns['wpvivid_modified'] = __( 'Modified', 'wpvivid-backup-pro' );
        $columns['wpvivid_size'] =__( 'Size', 'wpvivid-backup-pro'  );
        $columns['wpvivid_action'] = __( 'Action', 'wpvivid-backup-pro' );
        return $columns;
    }
...
class WPvivid_Rollback_Display_Addon
{
                    ...
                    wpvivid_post_request_addon(ajax_data, function(data)
                    {
                        ...
                        else
                        {
                            ...
                            if(auto_backup_retry_times>3)
                            {
                                ...
                                {
                                    alert(wpvivid_ajax_object_addon.i18n.backup_failed);
                                }
    ...
    public function show_auto_backup_page($backup)
    {
        ...
        <div class="wrap wpvivid-canvas">
            ...
            <h1><?php printf( esc_html__('%s Plugins - Rollback', 'wpvivid-backup-pro'), esc_html(apply_filters('wpvivid_white_label_display', 'WPvivid')) ); ?></h1>
            <div id="poststuff">
    ...
    public function get_dashboard_menu($submenus,$parent_slug)
    {
        ...
        if($display)
        {
            ...
            $submenu['page_title'] = apply_filters('wpvivid_white_label_display', __('Rollback', 'wpvivid-backup-pro'));
            $submenu['menu_title'] = __('Rollback', 'wpvivid-backup-pro');
    ...
    public function get_toolbar_menus($toolbar_menus)
    {
        ...
        if($display)
        {
            ...
            $menu['title'] = __('Rollback', 'wpvivid-backup-pro');
                        ...
                        <div class="meta-box-sortables ui-sortable">
                            <div class="wpvivid-backup">
                                <div class="wpvivid-welcome-bar wpvivid-clear-float">
                                    <div class="wpvivid-welcome-bar-left">
                                        <p>
                                            ...
                                            <span class="wpvivid-page-title"><?php esc_html_e('Rollback', 'wpvivid-backup-pro'); ?></span>
                                        </p>
                                        <span class="about-description"><?php esc_html_e('Perform a return to a prior state of plugins, themes and Wordpress core.', 'wpvivid-backup-pro'); ?></span>
                                    </div>
                                ...
                                <div class="wpvivid-canvas wpvivid-clear-float">
                                    ...
                                    $tabs['plugins']['title']=__('Plugins', 'wpvivid-backup-pro');
                                    ...
                                    $tabs['themes']['title']=__('Themes', 'wpvivid-backup-pro');
                                    ...
                                    $tabs['core']['title']=__('Wordpress Core', 'wpvivid-backup-pro');
                                    $tabs['core']['slug']='core';
                                    ...
                                    $tabs['settings']['title']=__('Settings', 'wpvivid-backup-pro');
                                    ...
                                    $args['can_delete']=1;
                                    $args['hide']=1;
                                    $tabs['version_backup']['title']=__('Versioning Backups', 'wpvivid-backup-pro');
                    ...
                    <div class="postbox wpvivid-footer wpvivid-footer-two-cols">
                        <div class="wpvivid-footer-two-cols-left">
                            <strong>
                                ...
                                <span><?php esc_html_e('Documentation', 'wpvivid-backup-pro'); ?></span>
                            </strong>
                            <div class="wpvivid-footer-two-cols-left-list">
                                <ul>
                                    ...
                                    <li><span class="dashicons dashicons-update wpvivid-dashicons-grey" ></span>
                                        <a href="<?php echo $href; ?>"><b><?php esc_html_e('Rollback', 'wpvivid-backup-pro'); ?></b></a>
                                    </li>
                                    <?php
                                    if(apply_filters('wpvivid_check_install_addon', false, 'imgoptim_pro'))
                                    {
                                        ...
                                        <li><span class="dashicons dashicons-format-gallery  wpvivid-dashicons-grey"></span>
                                            <a href="https://docs.wpvivid.com/wpvivid-image-optimization-pro-overview.html"><b><?php esc_html_e('Image Bulk Optimization', 'wpvivid-backup-pro'); ?></b></a>
                                        </li>
                                        <li><span class="dashicons dashicons-update  wpvivid-dashicons-grey"></span>
                                            <a href="https://docs.wpvivid.com/wpvivid-image-optimization-free-lazyload-images.html"><b><?php esc_html_e('Lazy Loading', 'wpvivid-backup-pro'); ?></b></a>
                                        </li>
                                        <li><span class="dashicons dashicons-admin-site  wpvivid-dashicons-grey"></span>
                                            <a href="https://docs.wpvivid.com/wpvivid-image-optimization-pro-integrate-cdn.html"><b><?php esc_html_e('CDN Integration', 'wpvivid-backup-pro'); ?></b></a>
                                        </li>
                                        <li>
                                            <span class="dashicons dashicons-format-image  wpvivid-dashicons-grey"></span>
                                            <a href="https://docs.wpvivid.com/wpvivid-image-optimization-pro-convert-to-webp.html"><b><?php esc_html_e('Convert Images to WebP', 'wpvivid-backup-pro'); ?></b></a>
                                        </li>
                                        <?php
                                    }
                                    ?>
                                    ...
                                    if(apply_filters('wpvivid_check_install_addon', false, 'staging_pro'))
                                    {
                                        ...
                                        <li><span class="dashicons dashicons-welcome-view-site  wpvivid-dashicons-blue"></span>
                                            <a href="https://docs.wpvivid.com/wpvivid-backup-pro-create-staging-site.html"><b><?php esc_html_e('WPvivid Staging', 'wpvivid-backup-pro'); ?></b></a>
                                        </li>
                                        <?php
                                    }
                                    ?>
                        ...
                        <div class="wpvivid-footer-two-cols-right">
                            <strong>
                                ...
                                <span><?php esc_html_e('Troubleshooting', 'wpvivid-backup-pro'); ?></span>
                            </strong>
                                ...
                                <div class="wpvivid-footer-two-cols-right-list">
                                    ...
                                    <ul class="">
                                        <li style="border-bottom: 0;"><span class="dashicons dashicons-admin-comments wpvivid-dashicons-green" ></span>
                                            <a href="https://wpvivid.com/submit-ticket"><b><?php esc_html_e('Submit a Ticket', 'wpvivid-backup-pro'); ?></b></a>
                                            <?php esc_html_e('The ticket system is for WPvivid Pro users only. If you need any help with our plugin, submit a ticket and we will respond shortly.', 'wpvivid-backup-pro'); ?>
                                        </li>
                                    </ul>
                                </div>
                                <?php
    ...
    public function output_plugins()
    {
        ...
        <div id="wpvivid_backup_plugin_progress" class="wpvivid-one-coloum wpvivid-workflow wpvivid-clear-float" style="display: none">
            ...
            <p>
                <span class="dashicons dashicons-backup wpvivid-dashicons-blue"></span>
                <span>
                    <span id="wpvivid_rollback_progress_text" class="wpvivid-rollback-progress-text"><?php esc_html_e('Rolling back the plugin...', 'wpvivid-backup-pro'); ?></span>
                </span>
            </p>
        </div>
        ...
        <script>
            ...
            jQuery('#wpvivid_plugins_list').on("click",'.wpvivid-plugin-rollback',function()
            {
                ...
                if(version!=='-')
                {
                    var descript = '<?php esc_html_e('Are you sure to rollback the plugin?', 'wpvivid-backup-pro'); ?>';
                ...
                wpvivid_post_request_addon(ajax_data, function(data)
                {
                    try
                    {
                        ...
                        if (jsonarray.result === 'success')
                        {
                            ...
                            {
                                jQuery('#wpvivid_backup_plugin_progress').hide();
                                alert(wpvivid_ajax_object_addon.i18n.rollback_plugin_completed_successfully);
                            }, 1200);
                        }
                        else
                        {
    ...
    public function output_themes()
    {
        ...
        <div id="wpvivid_backup_themes_progress" class="wpvivid-one-coloum wpvivid-workflow wpvivid-clear-float" style="display: none">
            ...
            <p>
                <span class="dashicons dashicons-backup wpvivid-dashicons-blue"></span>
                <span>
                    <span><?php esc_html_e('Rolling back the theme...', 'wpvivid-backup-pro'); ?></span>
                </span>
            </p>
        </div>
        ...
        <script>
            ...
            jQuery('#wpvivid_themes_list').on("click",'.wpvivid-theme-rollback',function()
            {
                ...
                if(version!=='-')
                {
                    var descript = '<?php esc_html_e('Are you sure to rollback the theme?', 'wpvivid-backup-pro'); ?>';
                    ...
                    try
                    {
                        ...
                        if (jsonarray.result === 'success')
                        {
                            ...
                            setTimeout(function()
                            {
                                ...
                                alert(wpvivid_ajax_object_addon.i18n.rollback_theme_completed_successfully);
                            }, 1200);
                        }
                        else
                        {
    ...
    public function output_core()
    {
        ...
        <div id="wpvivid_backup_core_progress" class="wpvivid-one-coloum wpvivid-workflow wpvivid-clear-float" style="display: none">
            ...
            <p>
                <span class="dashicons dashicons-backup wpvivid-dashicons-blue"></span>
                <span>
                    <span id="wpvivid_rollback_core_progress_text"><?php esc_html_e('Rolling back WordPress core...', 'wpvivid-backup-pro'); ?></span>
                </span>
            </p>
        </div>
        <table class="wp-list-table widefat plugins" style="margin-bottom:0.5rem;">
            ...
            <tr class="active">
                ...
                <td class="column-description desc">
                    <div class="eum-plugins-name-actions"><h4 class="eum-plugins-name" style="margin:0;"><?php esc_html_e('Wordpress Core', 'wpvivid-backup-pro'); ?></h4></div>
                    <div class="active second plugin-version-author-uri">
                        <div><span><?php esc_html_e('Current Version', 'wpvivid-backup-pro'); ?> </span><strong><span style="color: orange;"><?php echo $current_version;?></span></strong> | <span><?php esc_html_e('Latest Version', 'wpvivid-backup-pro'); ?> </span><strong><span style="color: green;"><?php echo $new_version;?></span></strong> </div>
                    </div>
                    <div>
                        <label class="wpvivid-switch" title="Enable/Disable the job">
        ...
        <script>
            ...
            jQuery('#wpvivid_core_backup_list').on("click",'.wpvivid-rollback-core-version',function()
            {
                var Obj=jQuery(this);
                var version=Obj.closest('tr').data('version');
                var descript = '<?php esc_html_e('Are you sure to rollback wordpress core?', 'wpvivid-backup-pro'); ?>';
                var ret = confirm(descript);
                if (ret === true)
                {
                    ...
                    try
                    {
                        ...
                        if (jsonarray.result === 'success')
                        {
                            ...
                            else if(jsonarray.status=='completed')
                            {
                                ...
                                alert(wpvivid_ajax_object_addon.i18n.rollback_completed_successfully);
                                location.reload();
                            }
                        }
                        else {
    ...
    public function output_settings()
    {
        ...
        ?>
        <div>
            <p><?php esc_html_e('Note: Once the retention is set up and reached, the oldest versioning backup will be deleted accordingly through a daily cron.', 'wpvivid-backup-pro'); ?></p>
            <p>
                <input type="text" class="wpvivid-rollback-count-retention" id="wpvivid_max_plugins_count" value="<?php echo $max_plugins_count;?>"> <?php esc_html_e('versioning backups retained for plugins.', 'wpvivid-backup-pro'); ?>
            </p>
            <p>
                <input type="text" class="wpvivid-rollback-count-retention" id="wpvivid_max_themes_count" value="<?php echo $max_themes_count;?>"> <?php esc_html_e('versioning backups retained for themes.', 'wpvivid-backup-pro'); ?>
            </p>
            <p>
                <input type="text" class="wpvivid-rollback-count-retention"  id="wpvivid_max_core_count" value="<?php echo $max_core_count;?>"> <?php esc_html_e('versioning backups retained for Wordpress core.', 'wpvivid-backup-pro'); ?>
            </p>
        </div>
        <div style="margin-bottom: 10px;">
            <p id="wpvivid_manual_backup_remote_selector_part">
                <select id="wpvivid_manual_backup_remote_selector">
                    ...
                    {
                        ?>
                        <option value="-1"><?php esc_html_e('Choose cloud storage', 'wpvivid-backup-pro'); ?></option>
                        <?php
                    }
                    else
                    {
                        ?>
                        <option value="-1" selected="selected" ><?php esc_html_e('Choose cloud storage', 'wpvivid-backup-pro'); ?></option>
                        <?php
                    }
                    ...
                    if(!empty($remoteslist))
                    {
                        foreach ($remoteslist as $key=>$remote_option)
                        {
                            ...
                            {
                                ?>
                                <option value="<?php echo esc_attr($remote_option['id']); ?>" ><?php echo $remote_option['name']; ?></option>
                                <?php
                            }
                ...
                <span><?php printf(esc_html__('Choose cloud storage for versioning backups (files + database). Add cloud storage on %s if you haven\'t.', 'wpvivid-backup-pro'), '<a href="' . esc_url(apply_filters('wpvivid_white_label_page_redirect', 'admin.php?page=wpvivid-remote', 'wpvivid-remote')) . '">' . esc_html__('this page', 'wpvivid-backup-pro') . '</a>'); ?></span>
            </p>
            <p>
                <label>
                    <input type="checkbox" class="wpvivid-rollback-remote" id="wpvivid_rollback_retain_local" <?php echo $rollback_retain_local; ?>> <?php esc_html_e('Keep storing the backups in localhost after uploading to remote storage.', 'wpvivid-backup-pro'); ?>
                </label>
            </p>
            <p>
                <label>
                    <input type="checkbox" id="wpvivid_auto_backup_db_before_update" <?php echo esc_attr($auto_backup_db_before_update) ?> />
                    <span><?php esc_html_e('Back up the database before updates. You can manage the backups in Backup Manager.', 'wpvivid-backup-pro'); ?></span>
                </label>
            </p>
            <p>
                <label>
                    <input type="checkbox" id="wpvivid_auto_enable_new_plugin" <?php echo esc_attr($auto_enable_new_plugin); ?> />
                    <span><?php esc_html_e('Automatically enable \'Auto backup before update\' for all new plugins installed on this site.', 'wpvivid-backup-pro'); ?></span>
                </label>
            </p>
            <div id="wpvivid_auto_backup_db_count_display" style="<?php echo esc_attr($auto_backup_db_setting_display); ?>">
                <p>
                    <label>
                        <input type="text" class="wpvivid-backup-count-retention" placeholder="30" id="wpvivid_rollback_max_backup_count" value="<?php echo esc_attr($rollback_max_backup_count); ?>">
                        <span> <?php esc_html_e('database backups retained in localhost.', 'wpvivid-backup-pro'); ?></span>
                    </label>
                </p>
                <p>
                    <label>
                        <input type="text" class="wpvivid-backup-count-retention" placeholder="30" id="wpvivid_rollback_max_remote_backup_count" value="<?php echo esc_attr($rollback_max_remote_backup_count); ?>">
                        <span> <?php esc_html_e('database backups retained in remote storage.', 'wpvivid-backup-pro'); ?></span>
                    </label>
                </p>
            </div>
            <p>
                <input class="button-primary" id="wpvivid_rollback_file_sync" type="submit" value="<?php esc_attr_e('Sync Versioning Backups', 'wpvivid-backup-pro'); ?>">
                <span><?php esc_html_e('Versioning backups information can be lost after site migration or restoration. Use this function to sync versioning backups when the information is lost.', 'wpvivid-backup-pro'); ?></span>
            </p>
        </div>
        <div style="margin-top:1rem;">
            <input class="button-primary" id="wpvivid_submit_rollback_setting" type="submit" value="<?php esc_attr_e('Save Changes', 'wpvivid-backup-pro'); ?>">
        </div>
        <div style="clear: both;"></div>
        <script>
            ...
            function wpvivid_get_rollback_plugins_continue()
            {
                ...
                wpvivid_post_request_addon(ajax_data, function (data)
                {
                    ...
                    if (jsonarray.result === 'success')
                    {
                        ...
                        {
                            //alert(wpvivid_ajax_object_addon.i18n.rollback_sync_has_completed_successfully);
                            //jQuery('#wpvivid_rollback_file_sync').css({'pointer-events': 'auto', 'opacity': '1'});
    ...
    public function output_version_backup()
    {
        ...
        <div id="wpvivid_rollback_progress" class="wpvivid-one-coloum wpvivid-workflow wpvivid-clear-float" style="display: none">
            ...
            <p>
                <span class="dashicons dashicons-backup wpvivid-dashicons-blue"></span>
                <span>
                    <span id="wpvivid_rollback_progress_text" class="wpvivid-rollback-progress-text"><?php esc_html_e('Rollback ing...', 'wpvivid-backup-pro'); ?></span>
                </span>
            </p>
        </div>
