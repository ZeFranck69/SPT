...
class WPvivid_Debug_Schedule_List extends WP_List_Table
{
    ...
    {
        $columns = array();
        $columns['wpvivid_id'] = __( 'ID', 'wpvivid-backup-pro' );
        $columns['wpvivid_name'] =__( 'Name', 'wpvivid-backup-pro'  );
        $columns['wpvivid_status'] = __( 'Status', 'wpvivid-backup-pro'  );
        $columns['wpvivid_start_at'] = __( 'Start at', 'wpvivid-backup-pro'  );
        $columns['wpvivid_start'] = __( 'Start', 'wpvivid-backup-pro'  );
        $columns['wpvivid_end'] = __( 'End', 'wpvivid-backup-pro'  );
...
class WPvivid_Cron_Checker
{
    ...
    public function add_schedule_tabs($tabs)
    {
        ...
        $tabs['debug']['title']=__('Debug', 'wpvivid-backup-pro');
