...
class WPvivid_New_Backup_Page_addon
{
    ...
    public function __construct()
    {
        ...
        add_filter('wpvivid_exclude_options_from_database_backup', array($this, 'exclude_options_from_database_backup'));
    ...
    public function exclude_options_from_database_backup($options)
    {
        if (!is_array($options))
        {
            $options = array();
        ...
        $exclude_options = array(
            'wpvivid_schedule_setting',
            'wpvivid_compress_setting',
            'wpvivid_local_setting',
            'wpvivid_upload_setting',
            'wpvivid_common_setting',
            'wpvivid_email_setting',
            'wpvivid_saved_api_token',
            'wpvivid_backup_list',
            'wpvivid_new_remote_list',
            'wpvivid_general_schedule_data',
            'wpvivid_manual_backup_history',
            'wpvivid_schedule_addon_setting',
            'wpvivid_enable_incremental_schedules',
            'wpvivid_incremental_schedules',
            'wpvivid_incremental_backup_data',
            'wpvivid_last_msg',
            'wpvivid_full_backup_last_msg',
            'wpvivid_incremental_backup_last_msg',
            'wpvivid_incremental_database_last_msg',
            'wpvivid_email_setting_addon',
            'wpvivid_restore_task',
            'white_label_setting'
        );

        return array_values(array_unique(array_merge($options, $exclude_options)));
    }
        ...
        if ($disk_free_space != false)
        {
            if($check_space >= $disk_free_space)
            {
                $warnings[] = array(
                    'type'       => 'warning',
                    'code'       => 'low_disk_space',
                    'message'    => __( 'Warning: We detected that you have less than 35MB of free disk space. This may cause the backup to fail, please free up or increase disk space.', 'wpvivid-backup-pro' ),
                    'allow_html' => false,
                );
            }
        }
    ...
    public function default_exclude_folders($folders)
    {
        ...
        $exclude_default[19]['path'] = WP_PLUGIN_DIR.'/'.'duplicator-backups';
        $exclude_default[20]['type'] = 'file';
        $exclude_default[20]['path'] = WP_CONTENT_DIR.'/'.'mysql.sql';  //mysql
    ...
    public function get_dashboard_menu($submenus,$parent_slug)
    {
        ...
        if($display)
        {
            ...
            $submenu['page_title'] = apply_filters('wpvivid_white_label_display', __('Manual Backup', 'wpvivid-backup-pro'));
            $submenu['menu_title'] = __('Manual Backup', 'wpvivid-backup-pro');
        ...
        if (isset($toolbar_menus['wpvivid_admin_menu']) && isset($toolbar_menus['wpvivid_admin_menu']['child']))
        {
            if (isset($toolbar_menus['wpvivid_admin_menu']['child']['wpvivid_admin_menu_backup']))
            {
                ...
                if($display)
                {
                    ...
                    $menu['title'] = __('Manual Backup', 'wpvivid-backup-pro');
                                ...
                                <ul class="">
                                    ...
                                    if($unused_image_cleaner_display)
                                    {
                                        ...
                                        <li><span class="dashicons dashicons-code-standards  wpvivid-dashicons-grey"></span>
                                            <a href="https://docs.wpvivid.com/unused-images-cleaner.html"><b><?php esc_html_e('Unused Image Cleaner', 'wpvivid-backup-pro'); ?></b></a>
        ...
        <script>
            ...
            function wpvivid_list_task_data(data)
            {
                ...
                if(data.running_backup_taskid!== '')
                {
                    ...
                    if(typeof data.running_backup_type !== 'undefined')
                    {
                        jQuery('input:radio[option=backup][name=backup_files][value="' + data.running_backup_type + '"]').prop('checked', true);

                        if(data.running_backup_type === 'custom')
                        {
                        ...
                        else if(data.running_backup_type === 'mu')
                        {
    ...
    public function welcome_bar()
    {
        ...
        <div class="wpvivid-welcome-bar wpvivid-clear-float">
            <div class="wpvivid-welcome-bar-left">
                <p><span class="dashicons dashicons-backup wpvivid-dashicons-large wpvivid-dashicons-blue"></span><span class="wpvivid-page-title"><?php esc_html_e('Back Up Manually', 'wpvivid-backup-pro'); ?></span></p>
                <p><span class="about-description"><?php esc_html_e('The page allows you to manually create a backup of the website for restoration or migration.', 'wpvivid-backup-pro'); ?></span></p>
            </div>
                ...
                <div class="wpvivid-status-row wpvivid-margin-bottom-1rem">
                    ...
                    <div class="wpvivid-status-right">
                        <div class="wpvivid-log-block">
                            <div class="wpvivid-log-title"><a><?php esc_html_e('Backup Log', 'wpvivid-backup-pro'); ?></a></div>
            ...
            <div class="wpvivid-backup-success">
                ...
                <div class="wpvivid-success-header">
                    <div class="wpvivid-success-title">
                        🎉 <?php esc_html_e('Congratulations, the backup succeeded!', 'wpvivid-backup-pro'); ?>
                    </div>
                ...
                <div class="wpvivid-success-content" id="wpvivid-success-content" style="display: none;">
                    ...
                    <div class="wpvivid-success-footer">
                        ...
                        <button class="wpvivid-btn-primary wpvivid-local-site-download-all"><?php esc_html_e('Download All Parts', 'wpvivid-backup-pro'); ?></button>
        ...
        <div class="wpvivid-one-coloum" id="wpvivid_remote_backup_success_notice" style="display: none;">
            ...
            <div class="wpvivid-v2-export-container">
                ...
                <div class="wpvivid-v2-export-message">
                    ...
                    <p>
                        <strong>
                            ...
                            <a href="https://docs.wpvivid.com/wpvivid-backup-pro-migrate-site-manually.html" class="wpvivid-v2-export-link"><?php esc_html_e('learn more...', 'wpvivid-backup-pro'); ?></a>
                        </strong>
                    </p>
                    <p>
                        <strong>
                ...
                <div class="wpvivid-v2-export-action">
                    <span class="wpvivid-btn-primary wpvivid-hide-remote-backup-site-notice"><?php esc_html_e('I got it', 'wpvivid-backup-pro'); ?></span>
                </div>
            </div>
        </div>
        <?php
            ...
            <div class="wpvivid-one-coloum wpvivid-workflow wpvivid-clear-float">
                ...
                <div>
                    <p>
                        ...
                        ?>
                        <span><strong><?php esc_html_e('Comment the backup', 'wpvivid-backup-pro'); ?></strong><?php esc_html_e('(optional)', 'wpvivid-backup-pro'); ?>: </span><input type="text" option="backup" name="backup_prefix" id="wpvivid_set_manual_prefix" value="<?php echo esc_attr($prefix); ?>" onkeyup="value=value.replace(/[^a-zA-Z0-9._]/g,'')" onpaste="value=value.replace(/[^\a-\z\A-\Z0-9]/g,'')" placeholder="<?php echo esc_attr($prefix); ?>">
                    </p>
                </div>
                <div style="border-top:1px solid #f1f1f1;padding-top:1em;">
                    <input class="button-primary" style="width: 200px; font-size: 20px; margin-bottom: 10px; pointer-events: auto; opacity: 1;" id="wpvivid_quickbackup_btn" type="submit" value="<?php esc_attr_e('Backup Now', 'wpvivid-backup-pro'); ?>">
                </div>
    ...
    public function backup_to()
    {
        ...
        <div>
            ...
            <div style="padding-left:2em;">
                <label class="">
                    <input type="radio" option="backup" name="backup_to" value="local" <?php echo esc_attr($default_backup_local); ?> /><?php esc_html_e('Backup to localhost', 'wpvivid-backup-pro'); ?>
                </label>
                ...
                if( apply_filters('wpvivid_current_user_can',true,'wpvivid-can-backup-remote'))
                {
                    ?>
                    <label class="">
                        <input type="radio" option="backup" name="backup_to" value="remote" <?php echo esc_attr($default_backup_remote); ?> /><?php esc_html_e('Backup to remote storage', 'wpvivid-backup-pro'); ?>
                    </label>
                    <span style="padding:0 0.2em;"></span>
                    <span id="wpvivid_manual_backup_remote_selector_part" style="<?php echo esc_attr($default_remote_seletor); ?>">
                        <select id="wpvivid_manual_backup_remote_selector">
                            ...
                            if(sizeof($remoteslist['remote_selected']) > 0)
                            {
                                ...
                                {
                                    ?>
                                    <option value="all" selected="selected"><?php esc_html_e('All activated remote storage', 'wpvivid-backup-pro'); ?></option>
                                    <?php
                                }
                                else
                                {
        ...
        <fieldset >
            ...
            if(is_multisite())
            {
                ...
                <label style="padding-right:2em;">
                    ...
                    <span> <?php esc_html_e('For the purpose of moving a subsite to a single install', 'wpvivid-backup-pro'); ?></span>
                </label>
                <?php
            }
            ?>
    ...
    public function pre_new_backup($backup_options)
    {
        ...
        {
            $ret['result']='failed';
            $ret['error']=__('We detected that there is already a running backup task. Please wait until it completes then try again.', 'wpvivid-backup-pro');
            return $ret;
        }
        ...
        if(isset($backup_options['backup_files']) && $backup_options['backup_files'] === 'custom')
        {
            ...
            {
                $ret['result']='failed';
                $ret['error']=__('Upon selecting the \'include additional database\' option, no extra database has been chosen. You must either specify an additional database or uncheck the option.', 'wpvivid-backup-pro');
                return $ret;
            }
        }
    ...
    public function get_backup_options($backup_options)
    {
        ...
        {
            $options['backup_files'] = $backup_options['backup_files'];
        }
    ...
    public function deal_backup_shutdown_error()
    {
        if($this->end_shutdown_function===false)
        {
            ...
            if($status['str']!='completed')
            {
                ...
                {
                    $message=__('Too many resumption attempts.', 'wpvivid-backup-pro');
                ...
                {
                    $message=__('Task timed out.', 'wpvivid-backup-pro');
                                            ...
                                            <div class="wpvivid-status-row wpvivid-margin-bottom-1rem">
                                                <div class="wpvivid-status-left">
                                                    <div class="wpvivid-status-info">
                                                        <span class="wpvivid-status-item">
                                                            <span class="dashicons dashicons-admin-page wpvivid-dashicons-green"></span>
                                                            <span class="label">'.esc_html__('Total Size:', 'wpvivid-backup-pro').'</span>
                                                            <span class="value">'.$info['task_info']['total'].'</span>
                                                        </span>
                                                        <span class="wpvivid-status-item">
                                                            <span class="dashicons dashicons-upload wpvivid-dashicons-blue"></span>
                                                            <span class="label">'.esc_html__('Uploaded:', 'wpvivid-backup-pro').'</span>
                                                            <span class="value">'.$info['task_info']['upload'].'</span>
                                                        </span>
                                                        <span class="wpvivid-status-item">
                                                            <span class="dashicons dashicons-plugins-checked wpvivid-dashicons-green"></span>
                                                            <span class="label">'.esc_html__('Speed:', 'wpvivid-backup-pro').'</span>
                                                            <span class="value">'.$info['task_info']['speed'].'</span>
                                                        </span>
                                                        <span class="wpvivid-status-item">
                                                            <span class="dashicons dashicons-networking wpvivid-dashicons-green"></span>
                                                            <span class="label">'.esc_html__('Network Connection:', 'wpvivid-backup-pro').'</span>
                                                ...
                                                <div class="wpvivid-status-right">
                                                    <div class="wpvivid-log-block">
                                                        <div class="wpvivid-log-title"><a>'.esc_html__('Backup Log', 'wpvivid-backup-pro').'</a></div>
                                                        <div class="wpvivid-log-content">
                                                        '.$log_data_html.'
                                                        </div>
                                                    </div>
    ...
    function wpvivid_update_mainwp_client_report()
    {
        ...
        $backup_time = time();
        do_action("wpvivid_backup", $destination , $message, __('Finished', 'wpvivid-backup-pro'), $backup_report, $backup_time);
    ...
    public function handle_backup_succeed($task_id)
    {
        ...
        WPvivid_Pro_Option::update_last_backup_message($task_msg);
    ...
    public function auto_backup_now()
    {
        ...
        try
        {
            ...
            {
                $ret['result'] = 'failed';
                $ret['error'] = __('Error occurred while parsing the request data. Please try to run backup again.', 'wpvivid-backup-pro');
                echo json_encode($ret);
                die();
            }
            //$task_id = sanitize_key($_POST['task_id']);
    ...
    public function _backup_cancel()
    {
        try
        {
            ...
            if($no_responds)
            {
                ...
                $ret['task_id'] = $task_id;
                $ret['msg'] = __('The backup is not responding for a while, do you want to force cancel it?', 'wpvivid-backup-pro');
            }
            else
            {
                $ret['result'] = 'success';
                ...
                $ret['task_id'] = $task_id;
                $ret['msg'] = __('The backup will be canceled after backing up the current chunk ends.', 'wpvivid-backup-pro');
            }
