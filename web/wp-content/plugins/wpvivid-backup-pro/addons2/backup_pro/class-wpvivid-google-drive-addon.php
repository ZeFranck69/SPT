...
class Wpvivid_Google_drive_addon extends WPvivid_Remote_addon
{
                ...
                try {
                    ...
                    foreach ($remoteslist as $key => $value)
                    {
                        if (isset($value['auth_id']) && isset($_GET['auth_id']) && $value['auth_id'] == sanitize_text_field($_GET['auth_id']))
                        {
                            $this->auth_notice = array(
                                'type'    => 'success',
                                'message' => __('You have authenticated the Google Drive account as your remote storage.','wpvivid-backup-pro')
                            );
                            return;
                        }
                    }
    ...
    public function wpvivid_add_storage_page_google_drive()
    {
        ...
        if($this->add_remote)
        {
            ...
            <div id="storage_account_google_drive" class="storage-account-page">
                <div style="color:#8bc34a; padding: 0 10px 10px 0;">
                    <strong><?php esc_html_e("Authentication is done, please continue to enter the storage information, then click 'Add Now' button to save it.", 'wpvivid-backup-pro'); ?></strong>
                </div>
                <div style="padding: 0 10px 10px 0;">
                    <strong><?php esc_html_e('Enter Your Google Drive Information', 'wpvivid-backup-pro'); ?></strong>
                </div>
                <table class="wp-list-table widefat plugins" style="width:100%;">
                    ...
                    <tr>
                        <td class="plugin-title column-primary">
                            <div class="wpvivid-storage-form">
                                <input type="text" class="regular-text" value="<?php echo esc_attr(apply_filters('wpvivid_white_label_remote_root_path', 'wpvividbackuppro')); ?>" autocomplete="off" option="googledrive" name="root_path" onkeyup="value=value.replace(/[^a-zA-Z0-9\-_]/g,'')" />
                            </div>
                        </td>
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
                                <i><?php echo sprintf(__('Customize a root directory in your Google Drive for holding %s directories.', 'wpvivid-backup-pro'), apply_filters('wpvivid_white_label_display', 'WPvivid backup')); ?></i>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td class="plugin-title column-primary">
                            <div class="wpvivid-storage-form">
                                <input type="text" class="regular-text" autocomplete="off" option="googledrive" name="path" placeholder="Google Drive Folder" value="<?php echo esc_attr($wpvivid_backup_pro->func->swtich_domain_to_folder_name(home_url())); ?>" onkeyup="value=value.replace(/[^a-zA-Z0-9\-_/]/g,'')" />
                            </div>
                        </td>
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
                                <i><?php esc_html_e('Customize the directory where you want to store backups. By default it takes your current website domain or URL.', 'wpvivid-backup-pro'); ?></i>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
                                <i><?php esc_html_e('The size of each upload block. Reduce this value if you experience timeouts during file uploads.', 'wpvivid-backup-pro'); ?></i>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
                                <i><?php esc_html_e('The size of each download block. Reduce this value if you experience timeouts during file downloads.', 'wpvivid-backup-pro'); ?></i>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="plugin-title column-primary">
                            <div class="wpvivid-storage-select">
                                <label>
                                    <input type="checkbox" option="googledrive" name="default" checked /> <?php esc_html_e('Set as the default remote storage.', 'wpvivid-backup-pro'); ?>
                                </label>
                            </div>
                        </td>
                        <td class="column-description desc">
                    ...
                    <tr>
                        <td class="plugin-title column-primary">
                            <div class="wpvivid-storage-form">
                                <input id="wpvivid_google_drive_auth" class="button-primary" type="submit" value="<?php esc_attr_e('Add Now', 'wpvivid-backup-pro'); ?>" />
                            </div>
                        </td>
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
                                <i><?php esc_html_e('Click the button to add the storage.', 'wpvivid-backup-pro'); ?></i>
                            </div>
                        </td>
                    </tr>
                    </tbody>
            ...
            <script>
                ...
                function wpvivid_google_drive_auth()
                {
                    ...
                    if(name == ''){
                        alert(wpvivid_ajax_object_addon.i18n.warning_an_alias_for_remote_storage_is_required);
                    }
                    else if(wpvivid_check_google_drive_storage_alias(name) === false)
                    {
                        alert(wpvivid_ajax_object_addon.i18n.alias_already_exists);
                    }
                    else if(root_path == '')
                    {
                        alert(wpvivid_ajax_object_addon.i18n.the_backup_folder_name_cannot_be_empty);
                    }
                    else if(root_path == '/')
                    {
                        alert(wpvivid_ajax_object_addon.i18n.the_backup_folder_name_cannot_be);
                    }
                    else if(path == '')
                    {
                        alert(wpvivid_ajax_object_addon.i18n.the_backup_folder_name_cannot_be_empty);
                    ...
                    else if(path == '/')
                    {
                        ...
                        alert(wpvivid_ajax_object_addon.i18n.warning_please_enter_an_upload_block_size);
                    }
                    else if(download_chunk_size == ''){
                        alert(wpvivid_ajax_object_addon.i18n.warning_please_enter_a_download_block_size);
                    }
                    else if(use_remote_retention == '1' && backup_retain == ''){
                        alert(wpvivid_ajax_object_addon.i18n.backup_retention_policy_required);
                    }
                ...
                jQuery('input:text[option=googledrive][name=upload_chunk_size]').on("keyup", function(){
                    ...
                    if(!regExp.test(input_value) && input_value !== ''){
                        alert(wpvivid_ajax_object_addon.i18n.only_a_number_from_1_30_is_allowed);
        ...
        else
        {
            ...
            <div id="storage_account_google_drive" class="storage-account-page">
                <div style="padding: 0 10px 10px 0;">
                    <strong><?php esc_html_e('To add Google Drive, please get Google authentication first. Once authenticated, you will be redirected to this page, then you can add storage information and save it', 'wpvivid-backup-pro'); ?></strong>
                </div>
                <table class="wp-list-table widefat plugins" style="width:100%;">
                    <tbody>
                    ...
                    <tr>
                        <td class="plugin-title column-primary">
                            <div class="wpvivid-storage-form">
                                <input onclick="wpvivid_google_drive_auth();" class="button-primary" type="submit" value="<?php esc_attr_e('Authenticate with Google Drive', 'wpvivid-backup-pro'); ?>" />
                            </div>
                        </td>
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
                                <i><?php esc_html_e('Click to get Google authentication.', 'wpvivid-backup-pro'); ?></i>
                            </div>
                        </td>
                    </tr>
                    </tbody>
                    ...
                    <span>
                        ...
                        echo wp_kses(
                            ...
                            /* translators: %s: documentation link. */
                                __(
                                    'Tip: Get a 404 or 403 error after authorization? Please read this %s.',
                                    'wpvivid-backup-pro'
                                ),
                                '<a href="' . esc_url('https://docs.wpvivid.com/http-403-error-authorizing-cloud-storage.html') . '">' . esc_html__('doc', 'wpvivid-backup-pro') . '</a>'
                            ),
                            array(
                                'a' => array(
                                    'href' => array(),
        ...
        <div id="remote_storage_edit_googledrive" >
            ...
            <table class="wp-list-table widefat plugins" style="width:100%;">
                ...
                <tr>
                    <td class="plugin-title column-primary">
                        <div class="wpvivid-storage-form">
                            <input type="text" class="regular-text" value="<?php echo esc_attr(apply_filters('wpvivid_white_label_remote_root_path', 'wpvividbackuppro')); ?>" autocomplete="off" option="edit-googledrive" name="root_path" onkeyup="value=value.replace(/[^a-zA-Z0-9\-_]/g,'')" />
                        </div>
                    </td>
                    <td class="column-description desc">
                        <div class="wpvivid-storage-form-desc">
                    ...
                    <td class="column-description desc">
                        <div class="wpvivid-storage-form-desc">
                            ...
                            <!--<i><span style="padding: 0; margin: 0;">Specify a name for the folder where you want to store backups. Google Drive Folder:</span><span option="googledrive" name="path">
                                ...
                                echo esc_html($root_path.WPVIVID_GOOGLEDRIVE_DEFAULT_FOLDER);
                                ?>
                            </span></i>-->
                        </div>
                    </td>
                ...
                <tr>
                    <td class="plugin-title column-primary">
                        <div class="wpvivid-storage-form">
                            <input onclick="wpvivid_google_drive_update_auth();" class="button-primary" type="submit" value="<?php esc_attr_e('Save Changes', 'wpvivid-backup-pro'); ?>" />
                        </div>
                    </td>
                    <td class="column-description desc">
                        <div class="wpvivid-storage-form-desc">
    ...
    public function _upload($task_id, $file,$client,$service,$folder_id, $callback = '', $retry_times=0)
    {
        ...
        {
            if (method_exists($media, 'resume')) {
                $media->resume($upload_job['job_data'][basename($file)]['resumeUri']);
            }
            WPvivid_Google_Compat_Ex::media_apply_resume_state($media, $upload_job['job_data'][basename($file)]);
            $offset = 0;
            if (method_exists($media, 'getProgress')) {
                $offset = (int)$media->getProgress();
            }
            if ($offset <= 0 && isset($upload_job['job_data'][basename($file)]['progress'])) {
                $offset = (int)$upload_job['job_data'][basename($file)]['progress'];
            }
            $wpvivid_backup_pro->wpvivid_pro_log->WriteLog('Resume uploading '.basename($file).'.','notice');
            $existing = array();
            if (isset($upload_job['job_data'][basename($file)]) && is_array($upload_job['job_data'][basename($file)])) {
                $existing = $upload_job['job_data'][basename($file)];
            }
            $upload_job['job_data'][basename($file)] = array_merge(
                $existing,
                WPvivid_Google_Compat_Ex::media_extract_resume_state($media)
            );

            if (method_exists($media, 'getResumeUri')) {
                $wpvivid_backup_pro->wpvivid_pro_log->WriteLog('resumeUri:'.$media->getResumeUri().'.','notice');
            }
            if (method_exists($media, 'getProgress')) {
                $wpvivid_backup_pro->wpvivid_pro_log->WriteLog('progress:'.$media->getProgress().'.','notice');
            }
            if ($offset > 0) {
                fseek($handle, $offset);
            }
            WPvivid_taskmanager::update_backup_sub_task_progress($task_id,'upload',$this->options['id'],WPVIVID_UPLOAD_UNDO,'Resume uploading '.basename($file).'.',$upload_job['job_data']);
        }
        else
        {
        ...
        try{
            while (!$status && !feof($handle))
            {
                ...
                $curr_progress = 0;
                if (method_exists($media, 'getProgress')) {
                    $curr_progress = (int)$media->getProgress();
                } elseif (isset($upload_job['job_data'][basename($file)]['progress'])) {
                    $curr_progress = (int)$upload_job['job_data'][basename($file)]['progress'];
                }
                $wpvivid_backup_pro->wpvivid_pro_log->WriteLog('progress:'.$curr_progress.'.','notice');
    ...
    public function check_token(&$client, &$service)
    {
        if ($client->isAccessTokenExpired())
        {
            ...
            global $wpvivid_plugin;
            global $wpvivid_backup_pro;
            $wpvivid_backup_pro->wpvivid_pro_log->WriteLog('check_token Refresh the token.','notice');
            $refresh_token = $client->getRefreshToken();

            $wpvivid_backup_pro->wpvivid_pro_log->WriteLog(
                'check_token client refresh token: ' . ($client->getRefreshToken() ? 'exists' : 'empty'),
                'notice'
            );

            $wpvivid_backup_pro->wpvivid_pro_log->WriteLog(
                'check_token options refresh token: ' . (!empty($this->options['token']['refresh_token']) ? 'exists' : 'empty'),
                'notice'
            );

            if (empty($refresh_token) && !empty($this->options['token']['refresh_token'])) {
                if (!empty($this->options['is_encrypt'])) {
            ...
            if (empty($refresh_token)) {
                return array(
                    ...
                    'error'  => 'get refresh token failed'
                );
            }

            $fetch_ret=$client->fetchAccessTokenWithRefreshToken($refresh_token);
            if (is_array($fetch_ret) && isset($fetch_ret['error'])) {
                return array(
                    'result' => WPVIVID_PRO_FAILED,
                    'error'  => 'Google token refresh failed: ' . $fetch_ret['error']
                );
            }
            ...
            if (isset($token['error'])) {
                return array(
                    'result' => WPVIVID_PRO_FAILED,
                    'error'  => 'Google token refresh failed: ' . $token['error']
                );
            }
            ...
            $this->options['token'] = json_decode(json_encode($token), true);
            ...
            $client_ret = $this->get_client();
            if ($client_ret['result'] == WPVIVID_PRO_FAILED) {
                return $client_ret;
            }

            $client = $client_ret['data'];
    ...
    public function get_client()
    {
        ...
        {
            // Refresh the token if possible, else fetch a new one.
            $wpvivid_backup_pro->wpvivid_pro_log->WriteLog('get_client Refresh the token.','notice');
