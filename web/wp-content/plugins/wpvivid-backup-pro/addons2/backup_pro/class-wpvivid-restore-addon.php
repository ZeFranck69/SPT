...
class WPvivid_Incremental_Files_Restore_List_Ex extends WP_List_Table
{
    ...
    {
        $columns = array();
        $columns['wpvivid_create_date'] = __( 'Creation Date', 'wpvivid-backup-pro' );
        $columns['wpvivid_type'] = __( 'Type', 'wpvivid-backup-pro' );
        return $columns;
    }
    ...
    public function display_rows_or_placeholder() {
        if ( $this->has_items() ) {
            ...
            esc_html_e('There is no \'Incremental Backup\' created.', 'wpvivid-backup-pro');
            echo '</td></tr>';
        }
    }
}
...
class WPvivid_Restore_addon
{
    ...
    public function get_dashboard_menu($submenus,$parent_slug)
    {
        ...
        $submenu['page_title'] = apply_filters('wpvivid_white_label_display', __('Test Restoration', 'wpvivid-backup-pro'));
        $submenu['menu_title'] = __('Test Restoration', 'wpvivid-backup-pro');
    ...
    public function init_page()
    {
        ...
        <div class="wrap wpvivid-canvas">
            ...
            <h1><?php printf( esc_html__('%s Plugins - Restoration', 'wpvivid-backup-pro'), esc_html(apply_filters('wpvivid_white_label_display', 'WPvivid')) ); ?></h1>
            <div id="poststuff">
                                ...
                                <div class="wpvivid-clear-float">
                                    ...
                                    <div class="wpvivid-v2-card">
                                        <div class="wpvivid-stepper-header">
                                            <h2><?php esc_html_e('Restoration', 'wpvivid-backup-pro'); ?></h2>
                                        </div>

                                        <div class="wpvivid-v2-stepper">
                                            <div id="wpvivid_restore_step1" class="wpvivid-v2-step active">
                                                <div class="wpvivid-step-circle">1</div>
                                                <span class="wpvivid-step-title"><?php esc_html_e('Prepare', 'wpvivid-backup-pro'); ?></span>
                                            </div>
                                            ...
                                            <div id="wpvivid_restore_step2" class="wpvivid-v2-step">
                                                ...
                                                <span class="wpvivid-step-title"><?php esc_html_e('Restore', 'wpvivid-backup-pro'); ?></span>
                                            </div>
                                            ...
                                            <div id="wpvivid_restore_step3" class="wpvivid-v2-step">
                                                ...
                                                <span class="wpvivid-step-title"><?php esc_html_e('Done', 'wpvivid-backup-pro'); ?></span>
                                            </div>
                                        </div>
                                    </div>
    ...
    public function show_backup_info($backup_id)
    {
        ...
        if(isset($this->backup_data['find_zero_date']) && $this->backup_data['find_zero_date'])
        {
            ...
            if(preg_match('/NO_ZERO_DATE/', $ret_sql_mode['mysql_mode']))
            {
                ...
                <div class="wpvivid-v2-warning-bar">
                    ...
                    <span><strong><?php esc_html_e('Warning', 'wpvivid-backup-pro'); ?>:</strong> <?php esc_html_e('We have detected that the backup contains zero dates \'0000-00-00\', while NO_ZERO_DATE which forbids zero dates is enabled on the current server, which may cause a restore failure. It is recommended to temporarily disable NO_ZERO_DATE on the server.', 'wpvivid-backup-pro'); ?></span>
                </div>
                <?php
            }
        }
        ...
        if(is_multisite())
        {
            if(isset($this->backup_data['is_mu_site']) && !$this->backup_data['is_mu_site'])
            {
                ...
                <div class="wpvivid-v2-warning-bar">
                    <span class="dashicons dashicons-warning"></span>
                    <span><strong><?php esc_html_e('Warning', 'wpvivid-backup-pro'); ?>:</strong> <?php esc_html_e('We\'ve detected that the site in the backup is a single-site WordPress installation, but your current site is a Multisite network. WPvivid currently does not support restoring backups from single-site installations to Multisite networks.', 'wpvivid-backup-pro'); ?></span>
                </div>
                <?php
            }
        }
        ...
        <div class="wpvivid-v2-warning-bar" id="wpvivid_restore_warning_info" style="display: none;">
            <span class="dashicons dashicons-warning"></span>
            <span><strong><?php esc_html_e('Warning', 'wpvivid-backup-pro'); ?>:</strong> <span id="wpvivid_restore_warning_msg"></span></span>
        </div>

        <div class="wpvivid-v2-restore-info">
            <div class="wpvivid-v2-info-left">
                <p><strong><?php esc_html_e('Creation Date', 'wpvivid-backup-pro'); ?>:</strong> <?php echo $this->backup_data['create_time'];?></p>
                <p><strong><?php esc_html_e('Type', 'wpvivid-backup-pro'); ?>:</strong> <?php echo $this->backup_data['type'];?></p>
                <p><strong><?php esc_html_e('Comment', 'wpvivid-backup-pro'); ?>:</strong> <?php echo $this->backup_data['comment'];?></p>
                <p><strong><?php esc_html_e('Backup Size', 'wpvivid-backup-pro'); ?>:</strong> <?php echo size_format($this->backup_data['size'],2);?></p>
                <p><strong><?php esc_html_e('Backup Location', 'wpvivid-backup-pro'); ?>:</strong> <?php echo $this->backup_data['location'];?></p>
                <?php
                if($this->backup_data['need_download'])
                {
                    ?>
                    <button class="wpvivid-v2-btn-blue" id="wpvivid_restore_retrieve_to_local"><?php esc_html_e('Retrieve to Localhost', 'wpvivid-backup-pro'); ?></button>
                    <?php
                }
                ?>
            </div>
            ...
            <div class="wpvivid-v2-info-right">
                <div class="wpvivid-v2-system-title"><?php esc_html_e('System Information', 'wpvivid-backup-pro'); ?></div>
                <div class="wpvivid-v2-system-grid">
                    ...
                    ?>
                    <div>
                        <p><strong><?php esc_html_e('In Backup', 'wpvivid-backup-pro'); ?>:</strong></p>
                        <p><?php esc_html_e('PHP Version', 'wpvivid-backup-pro'); ?>: <?php echo $backup_php_version;?></p>
                        <p><?php esc_html_e('MYSQL Version', 'wpvivid-backup-pro'); ?>: <?php echo $backup_mysql_version;?></p>
                        <p><?php esc_html_e('WordPress Version', 'wpvivid-backup-pro'); ?>: <?php echo $backup_wp_version; ?></p>
                    </div>
                    <div>
                        <p><strong><?php esc_html_e('Restore To', 'wpvivid-backup-pro'); ?>:</strong></p>
                        <p><?php esc_html_e('PHP Version', 'wpvivid-backup-pro'); ?>: <?php echo $php_version;?></p>
                        <p><?php esc_html_e('MYSQL Version', 'wpvivid-backup-pro'); ?>: <?php echo $mysql_version;?></p>
                        <p><?php esc_html_e('WordPress Version', 'wpvivid-backup-pro'); ?>: <?php echo $wp_version;?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        if($this->backup_data['need_download'])
        {
            ...
            <div class="wpvivid-v2-progress-bar-wrap" id="wpvivid_need_download_progress" style="display: none;">
                <div class="wpvivid-v2-progress-header">
                    ...
                    <span><?php esc_html_e('Retrieving backups from cloud', 'wpvivid-backup-pro'); ?></span>
                    <span class="dashicons dashicons-dismiss wpvivid-v2-close" id="wpvivid_restore_cancel_download"></span>
                </div>
                <span><span class="wpvivid-backup-percent-progress">0%</span> <?php esc_html_e('Completed', 'wpvivid-backup-pro'); ?></span><br>
                <div class="wpvivid-v2-progress-track">
                    <div class="wpvivid-v2-progress-fill" style="width:0%;"></div>
                </div>
                <p id="wpvivid_download_progress_text"><strong><?php esc_html_e('Retrieving', 'wpvivid-backup-pro'); ?>:</strong> xxxxxxxxxxxxxxxxx_part03.zip</p>
            </div>
            ...
            <script>
                ...
                function wpvivid_get_restore_download_progress()
                {
                    if(wpvivid_restore_download_cancel)
                    {
                        ...
                        alert(wpvivid_ajax_object_addon.i18n.download_canceled);
                        return;
                    }
    ...
    public function show_backup_detail()
    {
        ...
        <div class="wpvivid-v2-section">
            <div class="wpvivid-v2-section-header">
                <strong><?php esc_html_e('Advanced Settings', 'wpvivid-backup-pro'); ?></strong>
            ...
            <div class="wpvivid-v2-settings-list" id="wpvivid_restore_setting" style="display: none;">
                <div class="wpvivid-v2-item">
                    <label><?php esc_html_e('Database access method', 'wpvivid-backup-pro'); ?>:</label><br>
                    <label><input type="radio" option="restore_detail_options" name="db_connect_method" value="wpdb" <?php echo esc_attr($db_method_wpdb); ?>> <?php esc_html_e('WPDB', 'wpvivid-backup-pro'); ?></label>
                    <label><input type="radio" option="restore_detail_options" name="db_connect_method" value="pdo" <?php echo esc_attr($db_method_pdo); ?>> <?php esc_html_e('PDO', 'wpvivid-backup-pro'); ?></label>
                </div>

                <div class="wpvivid-v2-item">
                    <label><?php esc_html_e('Choose a server resource consumption mode', 'wpvivid-backup-pro'); ?>:</label><br>
                    <label><input type="radio" option="restore_detail_options" name="restore_level" value="low"> <?php esc_html_e('Low', 'wpvivid-backup-pro'); ?></label>
                    <label><input type="radio" option="restore_detail_options" name="restore_level" value="mid" checked> <?php esc_html_e('Mid', 'wpvivid-backup-pro'); ?></label>
                    <label><input type="radio" option="restore_detail_options" name="restore_level" value="high"> <?php esc_html_e('High', 'wpvivid-backup-pro'); ?></label>
                    <label><input type="radio" option="restore_detail_options" name="restore_level" value="custom"> <?php esc_html_e('Custom', 'wpvivid-backup-pro'); ?></label>
                </div>

                <div class="wpvivid-v2-item wpvivid-custom-restore-setting" style="display: none;">
                    <label><input type="text" option="restore_custom_detail_options" name="restore_max_execution_time" placeholder="1000" value="<?php echo $restore_max_execution_time?>"> <?php esc_html_e('seconds, maximum PHP script execution time for restore.', 'wpvivid-backup-pro'); ?></label>
                </div>

                <div class="wpvivid-v2-item wpvivid-custom-restore-setting" style="display: none;">
                    <label><input type="text" option="restore_custom_detail_options" name="restore_memory_limit" placeholder="256" value="<?php echo $restore_memory_limit?>"> <?php esc_html_e('MB, maximum PHP memory for restore.', 'wpvivid-backup-pro'); ?></label>
                </div>

                <div class="wpvivid-v2-item wpvivid-custom-restore-setting" style="display: none;">
                    <label><input type="text" option="restore_custom_detail_options" name="max_allowed_packet" placeholder="32" value="32"> <?php esc_html_e('MB, maximum size of data transmitted per request.', 'wpvivid-backup-pro'); ?></label>
                </div>

                <div class="wpvivid-v2-item wpvivid-custom-restore-setting" style="display: none;">
                    <label><input type="text" option="restore_custom_detail_options" name="sql_file_buffer_pre_request" placeholder="5" value="5"> <?php esc_html_e('MB, maximum SQL size imported per request.', 'wpvivid-backup-pro'); ?></label>
                </div>

                <div class="wpvivid-v2-item wpvivid-custom-restore-setting" style="display: none;">
                    <label><input type="text" option="restore_custom_detail_options" name="replace_rows_pre_request" placeholder="10000" value="10000"> <?php esc_html_e('rows, maximum rows processed per request.', 'wpvivid-backup-pro'); ?></label>
                </div>

                <div class="wpvivid-v2-item wpvivid-custom-restore-setting" style="display: none;">
                    <label><input type="checkbox" option="restore_custom_detail_options" name="use_index"> <?php esc_html_e('Extract files by index.', 'wpvivid-backup-pro'); ?></label>
                </div>

                <div class="wpvivid-v2-item wpvivid-custom-restore-setting" style="display: none;">
                    <label><input type="text" option="restore_custom_detail_options" name="unzip_files_pre_request" placeholder="1000" value="1000" readonly> <?php esc_html_e('files are unzipped every PHP request.', 'wpvivid-backup-pro'); ?></label>
                </div>

                <div class="wpvivid-v2-item">
                    <label><input type="checkbox" option="restore_detail_options" name="restore_htaccess"> <?php esc_html_e('Restore the .htaccess file in the backup.', 'wpvivid-backup-pro'); ?></label><br>
                    <label><input type="checkbox" option="restore_detail_options" name="restore_reset"> <?php esc_html_e('Clean up old files before restoring.', 'wpvivid-backup-pro'); ?></label><br>
                    <label><input type="checkbox" option="restore_detail_options" name="restore_db_reset"> <?php esc_html_e('Empty the database before restoring.', 'wpvivid-backup-pro'); ?></label><br>
                    <label><input type="checkbox" option="restore_detail_options" name="replace_table_character_set"> <?php esc_html_e('Auto replace not exist character set.', 'wpvivid-backup-pro'); ?></label><br>
                </div>

                <div>
                    <?php
                    $password = WPvivid_Pro_Option::get_encrypt_db_password('');
                    ?>
                    <input type="text" option="restore_detail_options" name="restore_db_password" value="<?php echo esc_attr($password); ?>"> <?php esc_html_e('Enter your password to decrypt the database backup. Ignore it if you didn\'t enable encryption for this backup.', 'wpvivid-backup-pro'); ?>
                </div>
            </div>
        </div>
        ...
        <div class="wpvivid-v2-restore-actions">
            ...
            ?>
            <input class="button-primary" id="wpvivid_restore_next_step_2" type="submit" value="<?php esc_attr_e('Next Step', 'wpvivid-backup-pro'); ?>" style="<?php echo esc_attr($next_step_btn_style); ?>">
        </div>
        <script>
    ...
    public function output_restore_info()
    {
            ...
            <div class="wpvivid-v2-db-section">
                ...
                <div class="wpvivid-v2-db-body">
                    ...
                    if(isset( $this->backup_data['restore_info']['additional_databases']))
                    {
                        ...
                        <div class="wpvivid-v2-db-item">
                            <div class="wpvivid-v2-db-line">
                                <label><input type="checkbox" option="restore_options" name="additional_databases" checked> <?php esc_html_e('Additional Database', 'wpvivid-backup-pro'); ?></label>
                                <span class="wpvivid-v2-db-size">
                                    <?php
                        ...
                        <div class="wpvivid-additional-database-detail">
                            <div style="padding-left:4em;">
                                <div style="border-bottom:1px solid #eee;border-top:1px solid #eee;">
                                    <p>
                                        <span><?php esc_html_e('Host:', 'wpvivid-backup-pro'); ?> </span><span><input type="text" option="additional_databases" name="host" style="width: 120px;"></span>
                                        <span><?php esc_html_e('User Name:', 'wpvivid-backup-pro'); ?> </span><span><input type="text" option="additional_databases" name="user" style="width: 120px;"></span>
                                        <span><?php esc_html_e('Password:', 'wpvivid-backup-pro'); ?> </span><span><input type="password" option="additional_databases" name="pw" style="width: 120px;"></span>
                                        <span><?php esc_html_e('Database:', 'wpvivid-backup-pro'); ?> </span><span><input type="text" option="additional_databases" name="db" style="width: 120px;"></span>
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        ?>
        <div class="wpvivid-v2-restore-actions">
            <input class="button-primary" id="wpvivid_restore_prev_step_1" type="submit" value="<?php esc_attr_e('Previous Step', 'wpvivid-backup-pro'); ?>">
            <input class="button-primary" id="wpvivid_restore_now" type="submit" value="<?php esc_attr_e('Restore Now', 'wpvivid-backup-pro'); ?>">
        </div>
        ...
        if(isset($this->backup_data['location']) && $this->backup_data['location'] === 'Cloud Storage')
        {
            ...
            <div>
                <label>
                    <input type="checkbox" option="restore_option_delete_local" name="delete_local"> <?php esc_html_e('Delete the local copy of the remote backup immediately after the restoration is successful.', 'wpvivid-backup-pro'); ?>
                </label>
            </div>
            <?php
        }
            ...
            foreach ($page_list as $backup_version)
            {
                ...
                <div class="wpvivid-v2-incremental-row">
                    <div class="wpvivid-v2-incremental-left">
                        <input type="radio" option="restore_options" name="restore_version" value="<?php echo esc_attr($backup_version['version']); ?>" <?php echo esc_attr($check_status); ?>>
    ...
    public function output_restore_incremental_info()
    {
        ...
        <script>
            jQuery('#wpvivid_restore_version_select').click(function()
            {
                ...
                if(restore_version=='')
                {
                    alert(wpvivid_ajax_object_addon.i18n.please_choose_a_restore_point);
                }
                else
                {
    ...
    public function restore_step3()
    {
        ...
        <div class="wpvivid-v2-congra-container" id="wpvivid_restore_page_3" style="display: none">
            ...
            <div class="wpvivid-v2-congra-card wpvivid-v2-congra-success" id="wpvivid_restore_success">
                <h1 class="wpvivid-v2-congra-title">🎉 <?php esc_html_e('Congratulations!', 'wpvivid-backup-pro'); ?></h1>
        ...
        <div class="wpvivid-one-coloum" id="wpvivid_restore_page_3" style="display: none">
            <div id="wpvivid_restore_success">
                <div style="font-size:4em; font-weight:900; color:#8bc34a; text-align:center;padding-top:1.5em;">
                    <span><?php esc_html_e('Congratulations!', 'wpvivid-backup-pro'); ?></span>
                </div>
    ...
    public function view_log_ex()
    {
        ...
        try
        {
            if (isset($_POST['log']) && !empty($_POST['log']) && is_string($_POST['log']))
            {
                ...
                {
                    $json['result'] = 'failed';
                    $json['error'] = __('Log does not exist. It might have been deleted or lost during a website migration.', 'wpvivid-backup-pro');
                ...
                if (!$file) {
                    $json['result'] = 'failed';
                    $json['error'] = __('Unable to open the log file.', 'wpvivid-backup-pro');
                    echo json_encode($json);
                    die();
                }
                ...
                $json['result'] = 'failed';
                $json['error'] = __('Reading the log failed. Please try again.', 'wpvivid-backup-pro');
                echo json_encode($json);
            }
        }
        catch (Exception $error)
    ...
    public function do_restore()
    {
        ...
        catch (Exception $error)
        {
            ...
            do_action('wpvivid_restore_analyze_error', $error->getMessage());
    ...
    public function finish_restore()
    {
        ...
        echo '<p>' . esc_html__('The restoration has been successfully completed.', 'wpvivid-backup-pro') . '</p>';
        ...
        echo '<p><a class="wpvivid-v2-congra-btn" href="' . esc_url($siteurl) . '" target="_blank">' . esc_html__('Visit Site', 'wpvivid-backup-pro') . '</a><span> </span></p>';
    ...
    public function restore_failed()
    {
        ...
        $is_unknown_collation_error = false;
        if (isset($restore_task['restore_error_info'])
            && isset($restore_task['restore_error_info']['type'])
            && $restore_task['restore_error_info']['type'] === 'unknown_collation')
        {
            $is_unknown_collation_error = true;
        }

        if (!$is_unknown_collation_error)
        {
        ...
        if($restore_task['status']=='error')
        {
            ...
            else if($is_unknown_collation_error)
            {
                echo '<p>Please initial another restore, and enable the \'Auto replace not exist character set\' option in the restore settings, then start restore. <a href="https://docs.wpvivid.com/restore-failed.html">More details</a></p>';
            }
            else
            {
    ...
    public function check_restore_db()
    {
        ...
        foreach ($restore_task['sub_tasks'] as $sub_task)
        {
            if($sub_task['type']=='databases')
            {
                ...
                $current_local_setting = get_option('wpvivid_local_setting', array());
                $current_common_setting = get_option('wpvivid_common_setting', array());
                $current_setting = WPvivid_Setting::export_setting_to_json();

                if (!isset($current_setting['data']['wpvivid_local_setting']) || !is_array($current_setting['data']['wpvivid_local_setting']))
                {
                    $current_setting['data']['wpvivid_local_setting'] = array();
                }

                if (isset($current_local_setting['path']) && $current_local_setting['path'] !== '')
                {
                    $current_setting['data']['wpvivid_local_setting']['path'] = $current_local_setting['path'];
                }

                if (isset($current_local_setting['outside_path']) && $current_local_setting['outside_path'] !== '')
                {
                    $current_setting['data']['wpvivid_local_setting']['outside_path'] = $current_local_setting['outside_path'];
                }

                if (!isset($current_setting['data']['wpvivid_common_setting']) || !is_array($current_setting['data']['wpvivid_common_setting']))
                {
                    $current_setting['data']['wpvivid_common_setting'] = array();
                }

                $preserve_common_keys = array(
                    'local_backup_folder',
                    'log_save_location',
                    'log_save_location_outside',
                );

                foreach ($preserve_common_keys as $key)
                {
                    if (array_key_exists($key, $current_common_setting))
                    {
                        $current_setting['data']['wpvivid_common_setting'][$key] = $current_common_setting[$key];
                    }
                }

                $preserved_mainwp_options = array(
                    'mainwp_child_pubkey'   => get_option('mainwp_child_pubkey', null),
                    'mainwp_child_uniqueId' => get_option('mainwp_child_uniqueId', null),
                );
                ...
                if($ret['result'] === 'success')
                {
                    if($preserved_mainwp_options['mainwp_child_pubkey'] !== null)
                    {
                        update_option('mainwp_child_pubkey', $preserved_mainwp_options['mainwp_child_pubkey']);
                        $this->log->WriteLog('Restored option: mainwp_child_pubkey', 'notice');
                    }

                    if($preserved_mainwp_options['mainwp_child_uniqueId'] !== null)
                    {
                        update_option('mainwp_child_uniqueId', $preserved_mainwp_options['mainwp_child_uniqueId']);
                        $this->log->WriteLog('Restored option: mainwp_child_uniqueId', 'notice');
                    }
                }
