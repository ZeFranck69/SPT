...
class WPvivid_pCloud_addon extends WPvivid_Remote_addon
{
                ...
                try
                {
                    ...
                    foreach ($remoteslist as $key => $value)
                    {
                        if (isset($value['auth_id']) && isset($_GET['auth_id']) && $value['auth_id'] == $_GET['auth_id']) {
                            $this->auth_notice = array(
                                'type'    => 'success',
                                'message' => __('You have authenticated the pCloud account as your remote storage.','wpvivid-backup-pro')
                            );
                            return;
                        }
                    }
    ...
    public function wpvivid_add_storage_page_pcloud()
    {
        ...
        if($this->add_remote)
        {
            ...
            <div id="storage_account_pcloud" class="storage-account-page">
                ...
                <div style="padding: 0 10px 10px 0;">
                    <strong><?php esc_html_e('Enter Your pCloud Information', 'wpvivid-backup-pro'); ?></strong>
                </div>
                <table class="wp-list-table widefat plugins" style="width:100%;">
                    ...
                    <tr>
                        <td class="plugin-title column-primary">
                            <div class="wpvivid-storage-form">
                                <input type="text" class="regular-text" value="<?php echo esc_attr(apply_filters('wpvivid_white_label_remote_root_path', 'wpvividbackuppro')); ?>" autocomplete="off" option="pcloud" name="root_path" onkeyup="value=value.replace(/[^a-zA-Z0-9\-_]/g,'')" />
                            </div>
                        </td>
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
                                <i><?php echo sprintf(__('Customize a root directory in your pCloud for holding %s directories.', 'wpvivid-backup-pro'), apply_filters('wpvivid_white_label_display', 'WPvivid backup')); ?></i>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td class="plugin-title column-primary">
                            <div class="wpvivid-storage-form">
                                <input type="text" class="regular-text" autocomplete="off" option="pcloud" name="path" placeholder="pCloud Folder" value="<?php echo esc_attr($wpvivid_backup_pro->func->swtich_domain_to_folder_name(home_url())); ?>" onkeyup="value=value.replace(/[^a-zA-Z0-9\-_/]/g,'')" />
                            </div>
                        </td>
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
                    ...
                    <tr>
                        <td class="plugin-title column-primary">
                            <div class="wpvivid-storage-select">
                                <label>
                                    <input type="checkbox" option="pcloud" name="default" checked /> <?php esc_html_e('Set as the default remote storage.', 'wpvivid-backup-pro'); ?>
                                </label>
                            </div>
                        </td>
                        <td class="column-description desc">
                    ...
                    <tr>
                        <td class="plugin-title column-primary">
                            <div class="wpvivid-storage-form">
                                <input id="wpvivid_pcloud_auth" class="button-primary" type="submit" value="<?php esc_attr_e('Add Now', 'wpvivid-backup-pro'); ?>">
                            </div>
                        </td>
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
        ...
        else
        {
            ...
            <div id="storage_account_pcloud" class="storage-account-page">
                <div style="padding: 0 10px 10px 0;">
                    <strong><?php esc_html_e('To add pCloud, please get pCloud authentication first. Once authenticated, you will be redirected to this page, then you can add storage information and save it', 'wpvivid-backup-pro'); ?></strong>
                </div>
                <table class="wp-list-table widefat plugins" style="width:100%;">
                    <tbody>
                    <tr>
                        <td class="plugin-title column-primary">
                            <div class="wpvivid-storage-form">
                                <select option="pcloud" name="area" style="margin-bottom:5px;">
                                    <option value="area_us"><?php esc_html_e('United States', 'wpvivid-backup-pro'); ?></option>
                                    <option value="area_eu"><?php esc_html_e('European Union', 'wpvivid-backup-pro'); ?></option>
                                </select>
                            </div>
                        </td>
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
                                <i><?php esc_html_e('Choose your pCloud account\'s region', 'wpvivid-backup-pro'); ?></i>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td class="plugin-title column-primary">
                            <div class="wpvivid-storage-form">
                                <input onclick="wpvivid_pcloud_auth();" class="button-primary" type="submit" value="<?php esc_attr_e('Authenticate with pCloud', 'wpvivid-backup-pro'); ?>">
                            </div>
                        </td>
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
                                <i><?php esc_html_e('Click to get pCloud authentication.', 'wpvivid-backup-pro'); ?></i>
                            </div>
                        </td>
                    </tr>
                    </tbody>
        ...
        <div id="remote_storage_edit_pCloud">
            ...
            <table class="wp-list-table widefat plugins" style="width:100%;">
                ...
                <tr>
                    <td class="plugin-title column-primary">
                        <div class="wpvivid-storage-form">
                            <input type="text" class="regular-text" value="<?php echo esc_attr(apply_filters('wpvivid_white_label_remote_root_path', 'wpvividbackuppro')); ?>" autocomplete="off" option="edit-pCloud" name="root_path" onkeyup="value=value.replace(/[^a-zA-Z0-9\-_]/g,'')" />
                        </div>
                    </td>
                    <td class="column-description desc">
                        <div class="wpvivid-storage-form-desc">
                ...
                <tr>
                    <td class="plugin-title column-primary">
                        <div class="wpvivid-storage-form">
                            <input onclick="wpvivid_pcloud_drive_update_auth();" class="button-primary" type="submit" value="<?php esc_attr_e('Save Changes', 'wpvivid-backup-pro'); ?>">
                        </div>
                    </td>
                    <td class="column-description desc">
                        <div class="wpvivid-storage-form-desc">
