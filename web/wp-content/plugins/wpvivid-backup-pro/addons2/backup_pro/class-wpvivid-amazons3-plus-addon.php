...
class WPvivid_AMAZONS3Class_addon extends WPvivid_Remote_addon
{
    ...
    public function wpvivid_add_storage_page_amazons3()
    {
        ...
        <div id="storage_account_amazons3"  class="storage-account-page">
            <div style="padding: 0 10px 10px 0;">
                <strong><?php esc_html_e('Enter Your Amazon S3 Account', 'wpvivid-backup-pro'); ?></strong>
            </div>
            <table class="wp-list-table widefat plugins" style="width:100%;">
                ...
                <form>
                    ...
                    <tr>
                        ...
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
                                <i><?php esc_html_e('Enter your Amazon S3 access key.', 'wpvivid-backup-pro'); ?></i><a href="https://wpvivid.com/get-amazon-access-secret-key.html" target="_blank"> <?php esc_html_e('How to get an AmazonS3 access key.', 'wpvivid-backup-pro'); ?></a>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
                                <i><?php esc_html_e('Enter your Amazon S3 secret key.', 'wpvivid-backup-pro'); ?></i><a href="https://wpvivid.com/get-amazon-access-secret-key.html" target="_blank"> <?php esc_html_e('How to get an AmazonS3 secret key.', 'wpvivid-backup-pro'); ?></a>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
                                <i><span><?php echo sprintf(__('Enter an existing Bucket in which you want to create a parent folder for holding %s folders.', 'wpvivid-backup-pro'), apply_filters('wpvivid_white_label_display', 'WPvivid backup')); ?></span></i>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td class="plugin-title column-primary">
                            <div class="wpvivid-storage-form">
                                <input type="text" class="regular-text" autocomplete="off" option="amazons3" name="root_path" value="<?php echo esc_attr(apply_filters('wpvivid_white_label_remote_root_path', 'wpvividbackuppro')); ?>" />
                            </div>
                        </td>
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
                                <i><span><?php echo sprintf(__('Customize a parent folder in the Bucket for holding %s folders.', 'wpvivid-backup-pro'), apply_filters('wpvivid_white_label_display', 'WPvivid backup')); ?></span></i>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td class="plugin-title column-primary">
                            <div class="wpvivid-storage-form">
                                <input type="text" class="regular-text" autocomplete="off" option="amazons3" name="path" placeholder="Custom Path" value="<?php echo esc_attr($wpvivid_backup_pro->func->swtich_domain_to_folder_name(home_url())); ?>" />
                            </div>
                        </td>
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
                                <i><span><?php echo sprintf(__('Customize the name of folder under the parent folder where you want to store %s backups.', 'wpvivid-backup-pro'), apply_filters('wpvivid_white_label_display', WPVIVID_PRO_PLUGIN_SLUG)); ?></span></i>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
                                <i><?php esc_html_e('The block size of uploads and downloads. Reduce it if you encounter a timeout when transferring files.', 'wpvivid-backup-pro'); ?></i>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td class="plugin-title column-primary">
                            <div class="wpvivid-storage-select">
                                <label>
                                    <input type="checkbox" option="amazons3" name="default" checked /> <?php esc_html_e('Set as the default remote storage.', 'wpvivid-backup-pro'); ?>
                                </label>
                            </div>
                        </td>
                        <td class="column-description desc">
                    ...
                    <tr>
                        <td class="plugin-title column-primary">
                            <div class="wpvivid-storage-select">
                                <label>
                                    <input type="checkbox" option="amazons3" name="classMode" checked /><?php esc_html_e('Storage class: Standard (infrequent access).', 'wpvivid-backup-pro'); ?>
                                </label>
                            </div>
                        </td>
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
                                <i><?php esc_html_e('Check the option to use Amazon S3 Standard-Infrequent Access (S3 Standard-IA) storage class for data transfer.', 'wpvivid-backup-pro'); ?></i>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td class="plugin-title column-primary">
                            <div class="wpvivid-storage-select">
                                <label>
                                    <input type="checkbox" option="amazons3" name="sse" checked /><?php esc_html_e('Server-side encryption.', 'wpvivid-backup-pro'); ?>
                                </label>
                            </div>
                        </td>
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
                                <i><?php esc_html_e('Check the option to use Amazon S3 server-side encryption to protect data.', 'wpvivid-backup-pro'); ?></i>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td class="plugin-title column-primary">
                            <div class="wpvivid-storage-select">
                                <label>
                                    <input type="checkbox" option="amazons3" name="uncheckdelete" /><?php esc_html_e('Do not check DeleteObject.', 'wpvivid-backup-pro'); ?>
                                </label>
                            </div>
                        </td>
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
                                <div style="float: left; padding-right: 5px;">
                                    <i><?php esc_html_e('Tick this option so WPvivid won\'t check s3:DeleteObject permission of the user in the authentication.', 'wpvivid-backup-pro'); ?></i>
                                </div>
                                <span class="dashicons dashicons-editor-help wpvivid-dashicons-editor-help wpvivid-tooltip">
                                    <div class="wpvivid-bottom">
                                        <p><?php esc_html_e('s3:DeleteObject is a permission for deleting objects from Amazon S3. Without it, you are not able to delete backups on S3 from WPvivid.', 'wpvivid-backup-pro'); ?></p>
                ...
                <tr>
                    <td class="plugin-title column-primary">
                        <div class="wpvivid-storage-form">
                            <input class="button-primary" option="add-remote" type="submit" value="<?php esc_attr_e('Test and Add', 'wpvivid-backup-pro'); ?>" />
                        </div>
                    </td>
                    <td class="column-description desc">
                        <div class="wpvivid-storage-form-desc">
                            <i><?php esc_html_e('Click the button to connect to Amazon S3 storage and add it to the storage list below.', 'wpvivid-backup-pro'); ?></i>
                        </div>
                    </td>
                </tr>
                </tbody>
            ...
            <table class="wp-list-table widefat plugins" style="width:100%;">
                ...
                <form>
                    ...
                    <tr>
                        <td class="plugin-title column-primary">
                            <div class="wpvivid-storage-form">
                                <input type="text" class="regular-text" autocomplete="off" option="edit-amazons3" name="root_path" value="<?php echo esc_attr(apply_filters('wpvivid_white_label_remote_root_path', 'wpvividbackuppro')); ?>" />
                            </div>
                        </td>
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
                    ...
                    <tr>
                        <td class="plugin-title column-primary">
                            <div class="wpvivid-storage-select">
                                <label>
                                    <input type="checkbox" option="edit-amazons3" name="classMode" /><?php esc_html_e('Storage class: Standard (infrequent access).', 'wpvivid-backup-pro'); ?>
                                </label>
                            </div>
                        </td>
                        <td class="column-description desc">
                    ...
                    <tr>
                        <td class="plugin-title column-primary">
                            <div class="wpvivid-storage-select">
                                <label>
                                    <input type="checkbox" option="edit-amazons3" name="sse" /><?php esc_html_e('Server-side encryption.', 'wpvivid-backup-pro'); ?>
                                </label>
                            </div>
                        </td>
                        <td class="column-description desc">
                ...
                <tr>
                    <td class="plugin-title column-primary">
                        <div class="wpvivid-storage-form">
                            <input class="button-primary" option="edit-remote" type="submit" value="<?php esc_attr_e('Save Changes', 'wpvivid-backup-pro'); ?>" />
                        </div>
                    </td>
                    <td class="column-description desc">
                        <div class="wpvivid-storage-form-desc">
    ...
    public function test_connect()
    {
        ...
        try
        {
            ...
            {
                return array('result'=>WPVIVID_PRO_FAILED,'error'=>__('We successfully accessed the bucket, but create test file failed.','wpvivid-backup-pro'));
            }
            ...
            if(isset($this->options['uncheckdelete']) && $this->options['uncheckdelete']){
                ...
                {
                    return array('result'=>WPVIVID_PRO_FAILED,'error'=>__('We successfully accessed the bucket, and create test file succeed, but delete test file failed.','wpvivid-backup-pro'));
                }
            }
        }catch(Exception $e){
    ...
    public function sanitize_options($skip_name='')
    {
        ...
        {
            $ret['error']=__('Warning: Please enter an upload block size.', 'wpvivid-backup-pro');
            return $ret;
        }

        if(empty($this->options['chunk_size']))
        {
            $ret['error']=__('Warning: Please enter an upload block size.', 'wpvivid-backup-pro');
            return $ret;
        }
        ...
        {
            $ret['error']=__('Warning: The access key for Amazon S3 is required.','wpvivid-backup-pro');
            return $ret;
        }
        ...
        {
            $ret['error']=__('Warning: The storage secret key is required.','wpvivid-backup-pro');
            return $ret;
        }
        ...
        {
            $ret['error']=__('Warning: A Bucket name is required.','wpvivid-backup-pro');
            return $ret;
        }
        ...
        if(!isset($this->options['root_path']))
        {
            $ret['error']=__('Warning: A root path is required.','wpvivid-backup-pro');
            return $ret;
        }
        ...
        {
            $ret['error']=__('Warning: A directory name is required.','wpvivid-backup-pro');
            return $ret;
        }
