...
class WPvivid_Backup_Download_Addon
{
    ...
    public function incremental_backup_scan()
    {
        ...
        $backup_start_time = WPvivid_Time::parse_local_datetime_to_timestamp($start_date.' '.$start_time, 'Y-m-d H:i');
        $backup_end_time   = WPvivid_Time::parse_local_datetime_to_timestamp($end_date.' '.$end_time, 'Y-m-d H:i');
            ...
            foreach ($backup['backup']['files'] as $file)
            {
                ...
                if(preg_match('/[0-9]{4}-[0-9]{2}-[0-9]{2}-[0-9]{2}-[0-9]{2}/',$file['file_name'],$matches))
                {
                    ...
                    if(sizeof($time_array)>4)
                        ...
                        $time=$backup['date'];
                    $backup_time = WPvivid_Time::parse_local_datetime_to_timestamp($time, 'Y-m-d H:i');
                }
        ...
        <div id="wpvivid_download_page">
            <div id="wpvivid_download_progress" class="wpvivid-one-coloum wpvivid-workflow wpvivid-clear-float" style="margin-bottom:1em;display: none">
                <div>
                    ...
                    <p></p>
                    <div>
                        <input id="wpvivid_cancel_download" class="button-primary" type="submit" value="<?php esc_attr_e('Cancel', 'wpvivid-backup-pro'); ?>">
                    </div>
                </div>
            </div>
            <div id="wpvivid_old_remote_backup" class="wpvivid-one-coloum wpvivid-workflow wpvivid-clear-float" style="margin-bottom: 10px;display: none">
                ...
                <span><?php esc_html_e('We detected this backup was from an old version,currently only supports full downloads or file downloads individually.', 'wpvivid-backup-pro'); ?></span>
            </div>
            <div id="wpvivid_incremental_backup_box" class="wpvivid-one-coloum wpvivid-workflow wpvivid-clear-float" style="display: none;box-shadow:0 1px 1px rgba(0,0,0,.04);border:1px solid #c3c4c7">
                ...
                <div style="float:left;">
                    ...
                    <span>
                        <code><?php esc_html_e('Incremental Backup Cycle', 'wpvivid-backup-pro'); ?></code> <?php esc_html_e('started on', 'wpvivid-backup-pro'); ?> <span id="wpvivid_incremental_backup_started_time"></span>
                    </span>
                    </h2>
                    <p>
                    <span>
                        ...
                        <span><?php esc_html_e('Full Backup', 'wpvivid-backup-pro'); ?></span>
                        <span style="padding:0 1rem;"></span>
                        <span>
                        <input id="wpvivid_incremental_backup_check" type="checkbox" checked/>
                    </span>
                        <span><?php esc_html_e('All of Incremental Backups', 'wpvivid-backup-pro'); ?></span>
                        <span>
                        <input type="submit" id="wpvivid_incremental_backup_download" class="button action" value="<?php esc_attr_e('Download', 'wpvivid-backup-pro'); ?>"/>
                    </span>
                    </p>
                </div>
            ...
            <div id="wpvivid_incremental_backup_tablenav_top" class="tablenav top" style="display: none">
                <div class="alignleft actions bulkactions">
                    <p>
                        <span><?php esc_html_e('Display the', 'wpvivid-backup-pro'); ?> <code><strong><?php esc_html_e('incremental backups', 'wpvivid-backup-pro'); ?></strong></code> <?php esc_html_e('created from:', 'wpvivid-backup-pro'); ?></span>
                        <span>
                        ...
                        <span>
                        <input type="submit" id="wpvivid_incremental_backup_scan" class="button action" value="<?php esc_attr_e('Apply', 'wpvivid-backup-pro'); ?>">
                    </span>
                    </p>
                </div>
            </div>
            <div id="wpvivid_download_tablenav_top" style="margin-bottom:0.5rem;">
                ...
                <select id="wpvivid_select_bulk_download">
                    <option value="download"><?php esc_html_e('Download All', 'wpvivid-backup-pro'); ?></option>
                </select>
                <input type="submit" class="button action wpvivid-select-bulk wpvivid_bulk_download" value="<?php esc_attr_e('Apply', 'wpvivid-backup-pro'); ?>">
            </div>
