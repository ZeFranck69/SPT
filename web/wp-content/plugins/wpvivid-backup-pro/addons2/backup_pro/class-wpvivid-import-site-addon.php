...
class WPvivid_Import_Backup_List extends WP_List_Table
{
    ...
    {
        $columns = array();
        $columns['wpvivid_backup'] = __( 'Backup', 'wpvivid-backup-pro' );
        return $columns;
    }
...
class WPvivid_Import_Site_Page_addon
{
    ...
    public function get_dashboard_menu($submenus,$parent_slug)
    {
        ...
        if($display)
        {
            ...
            $submenu['page_title'] = apply_filters('wpvivid_white_label_display', __('Import Site', 'wpvivid-backup-pro'));
            $submenu['menu_title'] = __('Import Site', 'wpvivid-backup-pro');
    ...
    public function get_toolbar_menus($toolbar_menus)
    {
        ...
        if($display)
        {
            ...
            $menu['title'] = __('Import Site', 'wpvivid-backup-pro');
    ...
    public function reload_remote_backup()
    {
        ...
        try{
            if(!isset($_POST['remote_id']) || empty($_POST['remote_id']))
            {
                echo wp_json_encode(array(
                    'result' => 'failed',
                    'error'  => __('Failed to post remote storage id. Please try again.', 'wpvivid-backup-pro')
                ));
                die();
            }
            ...
            if(!isset($_POST['folder']) || empty($_POST['folder']))
            {
                echo wp_json_encode(array(
                    'result' => 'failed',
                    'error'  => __('Failed to post remote storage folder. Please try again.', 'wpvivid-backup-pro')
                ));
                die();
            }
            ...
            $remote_folder = sanitize_text_field($_POST['folder']);

            if(!isset($remoteslist[$remote_id]))
            {
                echo wp_json_encode(array(
                    'result' => 'failed',
                    'error'  => __('The selected remote storage no longer exists. Please refresh the page and try again.', 'wpvivid-backup-pro')
                ));
                die();
            }
                            ...
                            <div class="wpvivid-backup">
                                <div class="wpvivid-welcome-bar wpvivid-clear-float">
                                    <div class="wpvivid-welcome-bar-left">
                                        <p><span class="dashicons dashicons-migrate wpvivid-dashicons-large wpvivid-dashicons-blue"></span><span class="wpvivid-page-title"><?php esc_html_e('Import Site', 'wpvivid-backup-pro'); ?></span></p>
                                        <span class="about-description"><?php esc_html_e('Import a site from localhost(web server), remote storage or source site (auto-migration).', 'wpvivid-backup-pro'); ?></span>
                                    </div>
                                ...
                                <div class="wpvivid-canvas wpvivid-clear-float">
                                    ...
                                    $tabs['import_from_upload']['title']=__('Import from Localhost(Web Server)', 'wpvivid-backup-pro');
                                    ...
                                    $args['is_parent_tab']=0;
                                    $tabs['import_from_remote']['title']=__('Import from Remote Storage', 'wpvivid-backup-pro');
                                    ...
                                    $args['div_style']='padding-top:0;';
                                    $args['is_parent_tab']=0;
                                    $tabs['import_from_migration']['title']=__('Import from Auto-Migration', 'wpvivid-backup-pro');
                                    ...
                                    $args['div_style']='padding-top:0;';
                                    $args['is_parent_tab']=0;
                                    $tabs['general_key']['title']=__('Generate A Key', 'wpvivid-backup-pro');
    ...
    public function output_import_from_upload()
    {
        ...
        <div class="wpvivid-one-coloum wpvivid-workflow wpvivid-clear-float" style="margin-bottom: 10px;">
            ...
            <span><?php esc_html_e('The files you want to upload need to be a backup created by WPvivid backup plugin. Make sure you will upload every part of a backup to the directory if the backup is split into many parts', 'wpvivid-backup-pro'); ?></span>
        </div>
    ...
    public function output_import_from_remote()
    {
            ...
            <div class="wpvivid-v2-remote-box">
                ...
                <div class="wpvivid-v2-remote-header">
                    <h2>
                        ...
                        <?php esc_html_e('Import from Remote Storage', 'wpvivid-backup-pro'); ?>
                    </h2>
                    <p>
                        <?php esc_html_e('Display the exported backups on', 'wpvivid-backup-pro'); ?>
                        <select id="wpvivid_select_import_remote_storage">
                            ...
                            foreach ($remoteslist as $key=>$value)
                            {
                                ...
                                ?>
                                <option value="<?php echo esc_attr($key); ?>" <?php selected($key, $select_remote_id); ?>>
                ...
                <div class="wpvivid-v2-remote-footer">
                    <p>
                        ...
                        <?php esc_html_e('You can clean the backups on', 'wpvivid-backup-pro'); ?> <a href="<?php echo 'admin.php?page='.strtolower(sprintf('%s-backup-and-restore', apply_filters('wpvivid_white_label_slug', 'wpvivid')));?>"><?php esc_html_e('Backup Manager Page', 'wpvivid-backup-pro'); ?></a>, <?php esc_html_e('learn more...', 'wpvivid-backup-pro'); ?>
                    </p>
                </div>
                ...
                function wpvivid_load_remote_backup_list()
                {
                    ...
                    wpvivid_post_request_addon(ajax_data, function (data)
                    {
                        ...
                        try
                        {
                            ...
                            {
                                alert(jsonarray.error || wpvivid_ajax_object_addon.i18n.unknown_error);
                            }
                        }
                        catch (err)
                        {
                            alert((err && err.message) ? err.message : wpvivid_ajax_object_addon.i18n.unknown_error);
                        }
        ...
        else
        {
            ...
            <div class="wpvivid-v2-alert">
                ...
                <a href="<?php echo 'admin.php?page='.strtolower(sprintf('%s-remote', apply_filters('wpvivid_white_label_slug', 'wpvivid')));?>"><?php esc_html_e('Cloud Storage', 'wpvivid-backup-pro'); ?></a> <?php esc_html_e('page.', 'wpvivid-backup-pro'); ?>
            </div>
            <?php
        }
    }
    ...
    public function output_import_from_migration()
    {
        ...
        if(empty($migrationlist))
        {
            ...
            <div class="wpvivid-v2-alert">
                <span class="dashicons dashicons-info-outline"></span>
                <?php esc_html_e('There is no available Auto-migration backup here.', 'wpvivid-backup-pro'); ?>
            </div>
            <?php
        }
        else
        {
            ...
            <div class="wpvivid-v2-remote-box">
                ...
                <div class="wpvivid-v2-remote-header">
                    <h2>
                        <span class="dashicons dashicons-cloud"></span>
                        <?php esc_html_e('Import From Auto-Migration', 'wpvivid-backup-pro'); ?>
                    </h2>
                    <p>
                        <span><?php esc_html_e('Click here to reload the latest received backup', 'wpvivid-backup-pro'); ?> </span>
    ...
    public function output_general_key()
    {
        ...
        <div class="wpvivid-v2-key-box">
            ...
            <div class="wpvivid-v2-key-header">
                ...
                <h2><?php esc_html_e('Generate a Key for Site Connection', 'wpvivid-backup-pro'); ?></h2>
            </div>

            <p class="wpvivid-v2-key-desc">
                <?php esc_html_e('To allow another site to send a backup to this site, please generate a key below.', 'wpvivid-backup-pro'); ?>
                <?php esc_html_e('Once the key is generated, this site will be ready to receive a backup.', 'wpvivid-backup-pro'); ?>
                <?php esc_html_e('Then, copy and paste the key into the sending site and save it.', 'wpvivid-backup-pro'); ?>
            </p>

            <div class="wpvivid-v2-key-expire">
                <label><?php esc_html_e('The key will expire in', 'wpvivid-backup-pro'); ?></label>
                <select id="wpvivid_generate_url_expires">
                    <option value="2 hour"><?php esc_html_e('2 hours', 'wpvivid-backup-pro'); ?></option>
                    <option selected value="8 hour"><?php esc_html_e('8 hours', 'wpvivid-backup-pro'); ?></option>
                    <option value="24 hour"><?php esc_html_e('24 hours', 'wpvivid-backup-pro'); ?></option>
                </select>
            ...
            <div class="wpvivid-v2-key-footer">
                <button class="wpvivid-v2-btn-primary" id="wpvivid_generate_url" onclick="wpvivid_click_generate_url();">
                    <?php esc_html_e('Generate', 'wpvivid-backup-pro'); ?>
                </button>
            </div>
        </div>
        <script>
            ...
            function wpvivid_click_generate_url()
            {
                ...
                wpvivid_post_request_addon(ajax_data, function (data)
                {
                    try
                    {
                        ...
                        {
                            alert(wpvivid_ajax_object_addon.i18n.failed_to_generating_key);
                        }
                    }
                    catch (err)
                    {
