...
class WPvivid_WebDav_addon extends WPvivid_Remote_addon
{
    ...
    public function add_storage_page_webdav()
    {
        ...
        <div id="storage_account_webdav"  class="storage-account-page">
            <div style="padding: 0 10px 10px 0;">
                <strong><?php esc_html_e('Enter Your WebDav Account', 'wpvivid-backup-pro'); ?></strong>
            </div>
            <table class="wp-list-table widefat plugins" style="width:100%;">
                ...
                <form>
                    ...
                    <tr>
                        ...
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
                                <i><?php esc_html_e('Enter the storage hostname.', 'wpvivid-backup-pro'); ?></i>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
                                <i><?php esc_html_e('Enter the storage port.', 'wpvivid-backup-pro'); ?></i>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
                                <i><?php esc_html_e('Enter the username.', 'wpvivid-backup-pro'); ?></i>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
                                <i><?php esc_html_e('Enter the password.', 'wpvivid-backup-pro'); ?></i>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td class="plugin-title column-primary">
                            <div class="wpvivid-storage-form">
                                <input type="text" class="regular-text" autocomplete="off" option="webdav" name="root_path" value="<?php echo esc_attr(apply_filters('wpvivid_white_label_remote_root_path', 'wpvividbackuppro')); ?>" />
                            </div>
                        </td>
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
                                <i><span><?php echo sprintf(__('Customize a root directory in the storage for holding WPvivid backup directories.', 'wpvivid-backup-pro'), apply_filters('wpvivid_white_label_display', 'WPvivid backup')); ?></span></i>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td class="plugin-title column-primary">
                            <div class="wpvivid-storage-form">
                                <input type="text" class="regular-text" autocomplete="off" option="webdav" name="path" placeholder="Custom Path" value="<?php echo esc_attr($wpvivid_backup_pro->func->swtich_domain_to_folder_name(home_url())); ?>" />
                            </div>
                        </td>
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
                    ...
                    <tr>
                        <td class="plugin-title column-primary">
                            <div class="wpvivid-storage-select">
                                <label>
                                    <input type="checkbox" option="webdav" name="ssl" /><?php esc_html_e('WebDAV (HTTPS)', 'wpvivid-backup-pro'); ?>
                                </label>
                            </div>
                        </td>
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
                                <i><?php esc_html_e('Check the option to connect the storage server over HTTPS. Make sure HTTPS is enabled on the storage server.', 'wpvivid-backup-pro'); ?></i>
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="plugin-title column-primary">
                            <div class="wpvivid-storage-select">
                                <label>
                                    <input type="checkbox" option="webdav" name="default" checked /> <?php esc_html_e('Set as the default remote storage.', 'wpvivid-backup-pro'); ?>
                                </label>
                            </div>
                        </td>
                        <td class="column-description desc">
                ...
                <tr>
                    ...
                    <td class="column-description desc">
                        <div class="wpvivid-storage-form-desc">
                            <i><?php esc_html_e('Click the button to connect to WebDav storage and add it to the storage list below.', 'wpvivid-backup-pro'); ?></i>
                        </div>
                    </td>
                </tr>
                </tbody>
            ...
            <table class="wp-list-table widefat plugins" style="width:100%;">
                ...
                <form>
                    ...
                    <tr>
                        <td class="plugin-title column-primary">
                            <div class="wpvivid-storage-form">
                                <input type="text" class="regular-text" autocomplete="off" option="edit-webdav" name="root_path" value="<?php echo esc_attr(apply_filters('wpvivid_white_label_remote_root_path', 'wpvividbackuppro')); ?>" />
                            </div>
                        </td>
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
                    ...
                    <tr>
                        <td class="plugin-title column-primary">
                            <div class="wpvivid-storage-form">
                                <input type="text" class="regular-text" autocomplete="off" option="edit-webdav" name="path" placeholder="Custom Path" value="<?php echo esc_attr($wpvivid_backup_pro->func->swtich_domain_to_folder_name(home_url())); ?>" />
                            </div>
                        </td>
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
                    ...
                    <tr>
                        <td class="plugin-title column-primary">
                            <div class="wpvivid-storage-select">
                                <label>
                                    <input type="checkbox" option="edit-webdav" name="ssl" /><?php esc_html_e('WebDAV (HTTPS)', 'wpvivid-backup-pro'); ?>
                                </label>
                            </div>
                        </td>
                        <td class="column-description desc">
                    ...
                    <tr>
                        <td class="plugin-title column-primary">
                            <div class="wpvivid-storage-select">
                                <label>
                                    <input type="checkbox" option="edit-webdav" name="default" checked /> <?php esc_html_e('Set as the default remote storage.', 'wpvivid-backup-pro'); ?>
                                </label>
                            </div>
                        </td>
                        <td class="column-description desc">
    ...
    public function test_upload_method($url)
    {
        ...
        $ret['error']=__('This WebDAV service does not support resumable uploads, and is not currently supported by WPvivid.','wpvivid-backup-pro');
        return $ret;
    }
    ...
    public function test_connect()
    {
        try
        {
            ...
            {
                $ret['result']='failed';
                $ret['error']=__('Failed to create a test file. Please make sure the storage credentials you enter are correct and the folder has sufficient permissions.','wpvivid-backup-pro');
                $ret['test']=$url;
                return $ret;
            }
    ...
    public function sanitize_options($skip_name='')
    {
        ...
        {
            $ret['error']=__('Warning: The hostname for WebDav is required.','wpvivid-backup-pro');
            return $ret;
        }
        ...
        {
            $ret['error']=__('Warning: The username for WebDav is required.','wpvivid-backup-pro');
            return $ret;
        }

        if(!isset($this->options['password']))
        {
            $ret['error']=__('Warning: The password is required.','wpvivid-backup-pro');
            return $ret;
        }
...
XML;
    ...
    public function remote_mkdir($url)
    {
        ...
        if($response!==false)
        {
            ...
            {
                $ret['result']='failed';
                $ret['error']=__('Creating a backup folder failed, error code: ','wpvivid-backup-pro').$http_code;
                return $ret;
            }
        }
        else
