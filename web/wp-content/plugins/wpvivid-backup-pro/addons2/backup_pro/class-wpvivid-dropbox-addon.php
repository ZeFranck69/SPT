...
class WPvivid_Dropbox_addon extends WPvivid_Remote_addon
{
                ...
                try {
                    ...
                    foreach ($remoteslist as $key => $value)
                    {
                        if (isset($value['auth_id']) && isset($_GET['auth_id']) && $value['auth_id'] == $_GET['auth_id'])
                        {
                            $this->auth_notice = array(
                                'type'    => 'success',
                                'message' => __('You have authenticated the Dropbox account as your remote storage.','wpvivid-backup-pro')
                            );
                            return;
                        }
                    }
    ...
    public function wpvivid_add_storage_page_dropbox(){
        ...
        if($this->add_remote)
        {
            ...
            <div id="storage_account_dropbox" class="storage-account-page">
                ...
                <div style="padding: 0 10px 10px 0;">
                    <strong><?php esc_html_e('Enter Your Dropbox Information', 'wpvivid-backup-pro'); ?></strong>
                </div>
                <table class="wp-list-table widefat plugins" style="width:100%;">
                    ...
                    <tr>
                        <td class="plugin-title column-primary">
                            <div class="wpvivid-storage-form">
                                <input type="text" class="regular-text" autocomplete="off" value="<?php echo sprintf(__('apps/%s backup restore', 'wpvivid-backup-pro'), apply_filters('wpvivid_white_label_display', 'Wpvivid')); ?>" readonly="readonly" />
                            </div>
                        </td>
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
                                <i><?php echo sprintf(__('A root directory in your Dropbox for holding all %s directories.', 'wpvivid-backup-pro'), apply_filters('wpvivid_white_label_display', 'WPvivid backup')); ?></i>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td class="plugin-title column-primary">
                            <div class="wpvivid-storage-form">
                                <input type="text" class="regular-text" autocomplete="off" option="dropbox" name="path" placeholder="Dropbox Folder" value="<?php echo esc_attr($wpvivid_backup_pro->func->swtich_domain_to_folder_name(home_url())); ?>" onkeyup="value=value.replace(/[^a-zA-Z0-9\-_/]/g,'')" />
                            </div>
                        </td>
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
                    ...
                    <tr>
                        <td class="plugin-title column-primary">
                            <div class="wpvivid-storage-select">
                                <label>
                                    <input type="checkbox" option="dropbox" name="default" checked /> <?php esc_html_e('Set as the default remote storage.', 'wpvivid-backup-pro'); ?>
                                </label>
                            </div>
                        </td>
                        <td class="column-description desc">
                    ...
                    <tr>
                        <td class="plugin-title column-primary">
                            <div class="wpvivid-storage-form">
                                <input id="wpvivid_dropbox_auth" class="button-primary" type="submit" value="<?php esc_attr_e('Add Now', 'wpvivid-backup-pro'); ?>">
                            </div>
                        </td>
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
        ...
        else
        {
            ...
            <div id="storage_account_dropbox" class="storage-account-page">
                <div style="padding: 0 10px 10px 0;">
                    <strong><?php esc_html_e('To add Dropbox, please get Dropbox authentication first. Once authenticated, you will be redirected to this page, then you can add storage information and save it', 'wpvivid-backup-pro'); ?></strong>
                </div>
                <table class="wp-list-table widefat plugins" style="width:100%;">
                    <tbody>
                    <tr>
                        <td class="plugin-title column-primary">
                            <div class="wpvivid-storage-form">
                                <input onclick="wpvivid_dropbox_auth();" class="button-primary" type="submit" value="<?php esc_attr_e('Authenticate with Dropbox', 'wpvivid-backup-pro'); ?>">
                            </div>
                        </td>
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
                                <i><?php esc_html_e('Click to get Dropbox authentication.', 'wpvivid-backup-pro'); ?></i>
                            </div>
                        </td>
                    </tr>
                    </tbody>
        ...
        <div id="remote_storage_edit_dropbox">
            ...
            <table class="wp-list-table widefat plugins" style="width:100%;">
                    ...
                    <td class="column-description desc">
                        <div class="wpvivid-storage-form-desc">
                            ...
                            <!--<i><span>Specify a name for the folder where you want to store backups. Dropbox Folder Path:</span><span option="dropbox" name="path">
                                ...
                                echo esc_html($root_path.WPVIVID_DROPBOX_DEFAULT_FOLDER);
                                ?>
                            </span></i>-->
                        </div>
                    </td>
                ...
                <tr>
                    <td class="plugin-title column-primary">
                        <div class="wpvivid-storage-form">
                            <input onclick="wpvivid_dropbox_update_auth();" class="button-primary" type="submit" value="<?php esc_attr_e('Save Changes', 'wpvivid-backup-pro'); ?>">
                        </div>
                    </td>
                    <td class="column-description desc">
                        <div class="wpvivid-storage-form-desc">
