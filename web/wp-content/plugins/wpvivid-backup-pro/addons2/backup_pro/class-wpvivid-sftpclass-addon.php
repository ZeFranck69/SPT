...
class WPvivid_SFTPClass_addon extends WPvivid_Remote_addon
{
    ...
    public function wpvivid_add_storage_page_sftp()
    {
        ...
        <div id="storage_account_sftp" class="storage-account-page">
            <div style="padding: 0 10px 10px 0;">
                <strong><?php esc_html_e('Enter Your SFTP Account', 'wpvivid-backup-pro'); ?></strong>
            </div>
            <table class="wp-list-table widefat plugins" style="width:100%;">
                ...
                <form>
                    ...
                    <tr>
                        ...
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
                                <i><?php esc_html_e('Enter the user name.', 'wpvivid-backup-pro'); ?></i>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
                                <i><?php esc_html_e('Enter the user password.', 'wpvivid-backup-pro'); ?></i>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
                                <i><?php esc_html_e('Enter the server port.', 'wpvivid-backup-pro'); ?></i>
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="plugin-title column-primary">
                            <div class="wpvivid-storage-form">
                                <input type="text" class="regular-text" autocomplete="off" option="sftp" name="root_path" value="<?php echo esc_attr(apply_filters('wpvivid_white_label_remote_root_path', 'wpvividbackuppro')); ?>" />
                            </div>
                        </td>
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
                    ...
                    <tr>
                        <td class="plugin-title column-primary">
                            <div class="wpvivid-storage-form">
                                <input type="text" class="regular-text" autocomplete="off" option="sftp" name="custom_path" placeholder="Custom Path(e.g. myfolder)" value="<?php echo esc_attr($wpvivid_backup_pro->func->swtich_domain_to_folder_name(home_url())); ?>" />
                            </div>
                        </td>
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
                    ...
                    <tr>
                        <td class="plugin-title column-primary">
                            <div class="wpvivid-storage-select">
                                <label>
                                    <input type="checkbox" option="sftp" name="default" checked /> <?php esc_html_e('Set as the default remote storage.', 'wpvivid-backup-pro'); ?>
                                </label>
                            </div>
                        </td>
                        <td class="column-description desc">
                ...
                <tr>
                    ...
                    <td class="column-description desc">
                        <div class="wpvivid-storage-form-desc">
                            <i><?php esc_html_e('Click the button to connect to SFTP server and add it to the storage list below.', 'wpvivid-backup-pro'); ?></i>
                        </div>
                    </td>
                </tr>
                </tbody>
            ...
            <table class="wp-list-table widefat plugins" style="width:100%;">
                ...
                <form>
                    ...
                    <tr>
                        <td class="plugin-title column-primary">
                            <div class="wpvivid-storage-form">
                                <input type="text" class="regular-text" autocomplete="off" option="edit-sftp" name="root_path" value="<?php echo esc_attr(apply_filters('wpvivid_white_label_remote_root_path', 'wpvividbackuppro')); ?>" />
                            </div>
                        </td>
                        <td class="column-description desc">
                            <div class="wpvivid-storage-form-desc">
        ...
        if($ret['result']=='success')
        {
            ...
            if ($str['result'] == WPVIVID_PRO_SUCCESS)
            {
                ...
                if ($str['result'] == WPVIVID_PRO_SUCCESS)
                {
                    ...
                    return array('result' => WPVIVID_PRO_FAILED, 'error' => __('Failed to create a test file. Please try again later.','wpvivid-backup-pro'));
                } else {
                    return $str;
                }
            }
    ...
    public function sanitize_options($skip_name = '')
    {
        ...
        if (!isset($this->options['host'])) {
            $ret['error'] = __('Warning: The IP Address is required.','wpvivid-backup-pro');
            return $ret;
        }
        ...
        if (!isset($this->options['username'])) {
            $ret['error'] = __('Warning: The username is required.','wpvivid-backup-pro');
            return $ret;
        }
        ...
        if (!isset($this->options['port'])) {
            $ret['error'] = __('Warning: The port number is required.','wpvivid-backup-pro');
            return $ret;
        }
    ...
    function do_connect($host, $username, $password, $port)
    {
        ...
        if (!$ret) {
            return array('result' => WPVIVID_PRO_FAILED, 'error' => __('The connection failed because of incorrect credentials or server connection timeout. Please try again.','wpvivid-backup-pro'));
        }
