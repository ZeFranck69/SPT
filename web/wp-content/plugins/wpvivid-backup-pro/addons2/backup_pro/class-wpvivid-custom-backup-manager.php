...
class WPvivid_Custom_Backup_Manager
{
    ...
    public static function wpvivid_get_new_backup_history($default = array())
    {
        return WPvivid_Pro_Option::get_manual_backup_history();
    }

    public static function wpvivid_set_new_backup_history($backup_history)
    {
        if (isset($backup_history['custom_dirs']['additional_database_list']))
        {
            unset($backup_history['custom_dirs']['additional_database_list']);
        }
        return WPvivid_Pro_Option::update_manual_backup_history($backup_history);
    }
    ...
    public function output_custom_backup_db_table()
    {
        ...
        if (!empty($custom_backup_history['additional_database_option']) && is_array($custom_backup_history['additional_database_option']))
        {
            $additional_database_option = $custom_backup_history['additional_database_option'];

            if (!empty($additional_database_option['db_host']))
            {
                $additional_db_host = $additional_database_option['db_host'];
            }

            if (!empty($additional_database_option['db_user']))
            {
                $additional_db_user = $additional_database_option['db_user'];
            }
        }
        ...
        <div style="">
            ...
            <span><strong><?php esc_html_e('Databases', 'wpvivid-backup-pro'); ?></strong></span>
            <span style="<?php echo esc_attr($database_style); ?>"> (</span><span class="wpvivid-database-size wpvivid-size" style="<?php echo esc_attr($database_style); ?>"><?php echo esc_html($database_size); ?></span><span style="<?php echo esc_attr($database_style); ?>">) </span>
            <span class="wpvivid-recalc-database-backup-size" style="padding:0.5em;">
                <span class="wpvivid-grey" style="padding:0.2em 0.6em;cursor:pointer; border-radius:3px;"><?php esc_html_e('calc', 'wpvivid-backup-pro'); ?></span>
            </span>
        </div>

        <!-- Database Tables -->
        <div style="padding-left:2em;">
            <p><span><input type="checkbox" class="wpvivid-custom-database-check" <?php echo esc_attr($database_check); ?>><span class="wpvivid-handle-base-database-detail" style="cursor:pointer;"><strong><?php esc_html_e('Database', 'wpvivid-backup-pro'); ?></strong></span></span>
        ...
        <div class="wpvivid-custom-database-info wpvivid-base-database-detail" style="display: none;">
            ...
            <div style="float: left;"><?php esc_html_e('Archieving database tables', 'wpvivid-backup-pro'); ?></div>
        ...
        <div style="padding-left:2em;">
            <p>
                <span><input type="checkbox" class="wpvivid-custom-additional-database-check" <?php echo esc_attr($additional_database_check); ?>><span class="wpvivid-handle-additional-database-detail" style="cursor:pointer;"><strong><span style="color:green;"><i><?php esc_html_e('(optional)', 'wpvivid-backup-pro'); ?></i></span><?php esc_html_e('Include Additional Databases', 'wpvivid-backup-pro'); ?></strong></span></span>
            ...
            <div style="padding-left:2em;padding-right:1em;">
                <div style="padding: 0px 1em 1em; border: 1px solid rgb(204, 204, 204);">
                    <div style="border-bottom:1px solid #ccc;">
                        <p>
                            <span><?php esc_html_e('Host:', 'wpvivid-backup-pro'); ?> </span><span><input type="text" class="wpvivid-additional-database-host" style="width: 120px;" value="<?php echo esc_attr($additional_db_host); ?>"></span>
                            <span><?php esc_html_e('User Name:', 'wpvivid-backup-pro'); ?> </span><span><input type="text" class="wpvivid-additional-database-user" style="width: 120px;" value="<?php echo esc_attr($additional_db_user); ?>"></span>
                            <span><?php esc_html_e('Password:', 'wpvivid-backup-pro'); ?> </span><span><input type="password" class="wpvivid-additional-database-pass" style="width: 120px;"></span>
                            <span><input type="submit" value="<?php esc_attr_e('Connect', 'wpvivid-backup-pro'); ?>" class="button button-primary wpvivid-connect-additional-database" ></span>
                        </p>
                    </div>
                    <div style="width:50%;float:left;box-sizing:border-box;padding-right:0.5em;">
                        <div>
                            <p><span class="dashicons dashicons-excerpt-view wpvivid-dashicons-blue"></span>
                                <span><strong><?php esc_html_e('Databases', 'wpvivid-backup-pro'); ?></strong></span>
                                <span>( <?php esc_html_e('click', 'wpvivid-backup-pro'); ?> "<span class="dashicons dashicons-plus-alt wpvivid-icon-16px"></span>" <?php esc_html_e('icon to add the database to backup list', 'wpvivid-backup-pro'); ?> )</span>
                            </p>
                        </div>
                    ...
                    <div style="width:50%; float:left;box-sizing:border-box;padding-left:0.5em;">
                        <div>
                            <p>
                                ...
                                <span><strong><?php esc_html_e('Databases will be backed up', 'wpvivid-backup-pro'); ?></strong></span>
                                <span>( <?php esc_html_e('click', 'wpvivid-backup-pro'); ?> <span class="dashicons dashicons-trash wpvivid-icon-16px"></span> <?php esc_html_e('icon to exclude the database', 'wpvivid-backup-pro'); ?> )</span>
                            </p>
                        </div>
    ...
    public function output_custom_backup_file_table()
    {
        ...
        <div style="margin-top:1em;">
            ...
            <span><strong><?php esc_html_e('Files & Folders', 'wpvivid-backup-pro'); ?> </strong></span>
            <span style="<?php echo esc_attr($file_style); ?>"> (</span><span class="wpvivid-total-content-size wpvivid-size wpvivid-file-size" style="<?php echo esc_attr($file_style); ?>"><?php echo esc_html($file_size); ?></span><span style="<?php echo esc_attr($file_style); ?>">)</span>
        ...
        <div style="padding-left:2em;">
            <p><span><input type="checkbox" class="wpvivid-custom-core-check" <?php echo esc_attr($core_check); ?>><span><strong><?php esc_html_e('Wordpress Core', 'wpvivid-backup-pro'); ?></strong><span style="<?php echo esc_attr($core_style); ?>"> (</span><span class="wpvivid-core-size wpvivid-size wpvivid-file-size" style="<?php echo esc_attr($core_style); ?>"><?php echo esc_html($core_size); ?></span><span style="<?php echo esc_attr($core_style); ?>">)</span></span></span></p>
            <p><span><input type="checkbox" class="wpvivid-custom-content-check" <?php echo esc_attr($content_check); ?>><span><strong><?php esc_html_e('wp-content', 'wpvivid-backup-pro'); ?></strong><span style="<?php echo esc_attr($content_style); ?>"> (</span><span class="wpvivid-content-size wpvivid-size wpvivid-file-size" style="<?php echo esc_attr($content_style); ?>"><?php echo esc_html($content_size); ?></span><span style="<?php echo esc_attr($content_style); ?>">)</span></span></span></p>
            <p><span><input type="checkbox" class="wpvivid-custom-themes-check" <?php echo esc_attr($themes_check); ?>><span><strong><?php esc_html_e('themes', 'wpvivid-backup-pro'); ?></strong><span style="<?php echo esc_attr($themes_style); ?>"> (</span><span class="wpvivid-themes-size wpvivid-size wpvivid-file-size" style="<?php echo esc_attr($themes_style); ?>"><?php echo esc_html($themes_size); ?></span><span style="<?php echo esc_attr($themes_style); ?>">)</span></span></span></p>
            <p><span><input type="checkbox" class="wpvivid-custom-plugins-check" <?php echo esc_attr($plugins_check); ?>><span><strong><?php esc_html_e('plugins', 'wpvivid-backup-pro'); ?></strong><span style="<?php echo esc_attr($plugins_style); ?>"> (</span><span class="wpvivid-plugins-size wpvivid-size wpvivid-file-size" style="<?php echo esc_attr($plugins_style); ?>"><?php echo esc_html($plugins_size); ?></span><span style="<?php echo esc_attr($plugins_style); ?>">)</span></span></span></p>
            <p><span><input type="checkbox" class="wpvivid-custom-uploads-check" <?php echo esc_attr($uploads_check); ?>><span><strong><?php esc_html_e('uploads', 'wpvivid-backup-pro'); ?></strong><span style="<?php echo esc_attr($uploads_style); ?>"> (</span><span class="wpvivid-uploads-size wpvivid-size wpvivid-file-size" style="<?php echo esc_attr($uploads_style); ?>"><?php echo esc_html($uploads_size); ?></span><span style="<?php echo esc_attr($uploads_style); ?>">)</span></span></span></p>
            <p><span><input type="checkbox" class="wpvivid-custom-mu-plugin-check" <?php echo esc_attr($mu_plugins_check); ?>><span><strong><?php esc_html_e('mu-plugins', 'wpvivid-backup-pro'); ?></strong><span style="<?php echo esc_attr($mu_plugins_style); ?>"> (</span><span class="wpvivid-mu-plugins-size wpvivid-size wpvivid-file-size" style="<?php echo esc_attr($mu_plugins_style); ?>"><?php echo esc_html($mu_plugins_size); ?></span><span style="<?php echo esc_attr($mu_plugins_style); ?>">)</span></span></span></p>
            <p>
                <input type="checkbox" class="wpvivid-custom-additional-folder-check" <?php echo esc_attr($additional_folder_check); ?>>
                <span class="wpvivid-handle-additional-folder-detail" style="cursor:pointer;"><strong><span style="color:green;"><?php esc_html_e('(optional)', 'wpvivid-backup-pro'); ?></span><?php esc_html_e('Include Non-WordPress Files/Folders', 'wpvivid-backup-pro'); ?></strong></span>
                    ...
                    <div>
                        <div style="width:30%;float:left;box-sizing:border-box;padding-right:0.5em;">
                            <div>
                                <p>
                                    <span class="dashicons dashicons-portfolio wpvivid-dashicons-orange"></span>
                                    <span><strong><?php esc_html_e('Folders', 'wpvivid-backup-pro'); ?></strong></span>
                                    <span class="wpvivid-rectangle wpvivid-grey-light wpvivid-hover-blue wpvivid-refresh-include-tree"><?php esc_html_e('Refresh', 'wpvivid-backup-pro'); ?><span>
                                </p>
                            </div>

                            <div style="height:250px;">
                                <div class="wpvivid-custom-additional-folder-tree-info" style="margin-top:10px;height:250px;border:1px solid #ccc;padding:0.2em 0.5em;overflow:auto;"><?php esc_html_e('Tree Viewer', 'wpvivid-backup-pro'); ?></div>
                            </div>
                            <div style="clear:both;"></div>

                            <div style="padding:1.5em 0 0 0;"><input class="button-primary wpvivid-include-additional-folder-btn" type="submit" value="<?php esc_attr_e('Include Files/Folders', 'wpvivid-backup-pro'); ?>"></div>
                        </div>
                        <div style="width:70%; float:left;box-sizing:border-box;padding-left:0.5em;">
                            <div>
                                <p>
                                    <span class="dashicons dashicons-portfolio wpvivid-dashicons-orange"></span>
                                    <span><strong><?php esc_html_e('Non-WordPress Files/Folders Will Be Backed Up', 'wpvivid-backup-pro'); ?></strong></span>
                                </p>
                            </div>
                            ...
                            <div style="padding:1em 0 0 0;"><span class="wpvivid-rectangle wpvivid-grey-light wpvivid-hover-blue wpvivid-clear-custom-include-list" style="float:right;"><?php esc_html_e('Empty Included Files/Folders', 'wpvivid-backup-pro'); ?></span></div>
                        </div>
                        <div style="clear:both;"></div>
                    </div>
                    <div style="clear:both;"></div>
                    <div style="padding:1em 0 0 0;">
                        <span><?php esc_html_e('CTRL + Left Click to select multiple files or folders.', 'wpvivid-backup-pro'); ?></span>
                    </div>
                </div>
            </div>
        </div>
    ...
    public function output_custom_backup_table()
    {
        ...
        <div>
            <div>
                ...
                <span><strong><?php esc_html_e('Custom content', 'wpvivid-backup-pro'); ?></strong></span>
                <span>(</span><span class="wpvivid-total-content-size wpvivid-size"><?php esc_html_e('calculating', 'wpvivid-backup-pro'); ?></span><span>)</span>
                <span class="wpvivid-recalc-backup-size" style="padding:0.5em;">
                    <span class="wpvivid-grey" style="padding:0.2em 0.6em;cursor:pointer; border-radius:3px;"><?php esc_html_e('re-calc', 'wpvivid-backup-pro'); ?></span>
                </span>
            </div>
            ...
            <div style="padding-left:2em;">
                <p>
                    <span>
                        <input type="checkbox" class="wpvivid-custom-database-check" <?php echo esc_attr($database_check); ?>>
                        <span>
                            <strong class="wpvivid-handle-base-database-detail" style="cursor:pointer;"><?php esc_html_e('Database', 'wpvivid-backup-pro'); ?></strong>
                            <span> (</span><span class="wpvivid-database-size wpvivid-size"><?php esc_html_e('calculating', 'wpvivid-backup-pro'); ?></span><span>)</span>
                        </span>
                    </span>
                    <?php
                    if($this->is_mu_single !== '1')
            ...
            <div style="padding-left:2em;">
                <p>
                    <span>
                        <input class="wpvivid-custom-core-check" type="checkbox" <?php echo esc_attr($core_check); ?>>
                        <span>
                            <strong><?php esc_html_e('Wordpress Core', 'wpvivid-backup-pro'); ?></strong>
                            <span> (</span><span class="wpvivid-core-size wpvivid-size"><?php esc_html_e('calculating', 'wpvivid-backup-pro'); ?></span><span>)</span>
                        </span>
                    </span>
                </p>
                <p>
                    <span>
                        <input class="wpvivid-custom-content-check" type="checkbox" <?php echo esc_attr($content_check); ?>>
                        <span>
                            <strong><?php esc_html_e('wp-content', 'wpvivid-backup-pro'); ?></strong>
                            <span> (</span><span class="wpvivid-content-size wpvivid-size"><?php esc_html_e('calculating', 'wpvivid-backup-pro'); ?></span><span>)</span>
                        </span>
                    </span>
                </p>
                <p>
                    <span>
                        <input class="wpvivid-custom-themes-check" type="checkbox" <?php echo esc_attr($themes_check); ?>>
                        <span>
                            <strong><?php esc_html_e('themes', 'wpvivid-backup-pro'); ?></strong>
                            <span> (</span><span class="wpvivid-themes-size wpvivid-size"><?php esc_html_e('calculating', 'wpvivid-backup-pro'); ?></span><span>)</span>
                        </span>
                    </span>
                </p>
                <p>
                    <span>
                        <input class="wpvivid-custom-plugins-check" type="checkbox" <?php echo esc_attr($plugins_check); ?>>
                        <span>
                            <strong><?php esc_html_e('plugins', 'wpvivid-backup-pro'); ?></strong>
                            <span> (</span><span class="wpvivid-plugins-size wpvivid-size"><?php esc_html_e('calculating', 'wpvivid-backup-pro'); ?></span><span>)</span>
                        </span>
                    </span>
                </p>
                <p>
                    <span>
                        <input class="wpvivid-custom-uploads-check" type="checkbox" <?php echo esc_attr($uploads_check); ?>>
                        <span>
                            <strong><?php esc_html_e('uploads', 'wpvivid-backup-pro'); ?></strong>
                            <span> (</span><span class="wpvivid-uploads-size wpvivid-size"><?php esc_html_e('calculating', 'wpvivid-backup-pro'); ?></span><span>)</span>
                        </span>
                    </span>
                </p>
            </div>
            ...
            <div style="padding-left:2em;">
                <p>
                    <label style="cursor:pointer;" title="Click to expand">
                        <span><strong><?php esc_html_e('Advanced Options', 'wpvivid-backup-pro'); ?></strong></span>
            ...
            <div style="padding-left:2em;">
                <p>
                    <input class="wpvivid-custom-additional-folder-check" type="checkbox" <?php echo esc_attr($additional_folder_check); ?>>
                    <span class="wpvivid-handle-additional-folder-detail" style="cursor:pointer;"><strong><?php esc_html_e('Include Non-WordPress Files/Folders', 'wpvivid-backup-pro'); ?></strong></span>
            ...
            if($this->is_mu_single !== '1')
            {
                ...
                <div style="padding-left:2em;">
                    <p>
                        <input class="wpvivid-custom-additional-database-check" type="checkbox" <?php echo esc_attr($additional_database_check); ?>>
                        <span class="wpvivid-handle-additional-database-detail" style="cursor:pointer;"><strong><?php esc_html_e('Include Additional Databases', 'wpvivid-backup-pro'); ?></strong></span>
    ...
    public function output_advanced_option_table()
    {
        ...
        <div>
            <p>
                ...
                <span class="wpvivid-handle-advanced-option-detail" style="cursor:pointer;"><strong><?php esc_html_e('Advanced Settings', 'wpvivid-backup-pro'); ?></strong></span>
        ...
        <div class="wpvivid-advanced-option-detail" style="padding-left:2em; display: none;">
            <p>
                <span class="wpvivid-handle-tree-detail" style="cursor:pointer;"><strong><?php esc_html_e('Exclude Files/Folders Inside /wp-content/ Folder', 'wpvivid-backup-pro'); ?></strong></span>
                    ...
                    <div style="width:30%;float:left;box-sizing:border-box;padding-right:0.5em;">
                        <div>
                            <p>
                                <span class="dashicons dashicons-portfolio wpvivid-dashicons-orange"></span>
                                <span><strong><?php esc_html_e('Folders', 'wpvivid-backup-pro'); ?></strong></span>
                                <span class="wpvivid-rectangle wpvivid-grey-light wpvivid-hover-blue wpvivid-refresh-exclude-tree"><?php esc_html_e('Refresh', 'wpvivid-backup-pro'); ?><span>
                            </p>
                        </div>

                        <div style="height:250px;">
                            <div class="wpvivid-custom-exclude-tree-info" style="margin-top:10px;height:250px;border:1px solid #ccc;padding:0.2em 0.5em;overflow:auto;"><?php esc_html_e('Tree Viewer', 'wpvivid-backup-pro'); ?></div>
                        </div>
                        <div style="clear:both;"></div>

                        <div style="padding:1.5em 0 0 0;"><input class="button-primary wpvivid-custom-tree-exclude-btn" type="submit" value="<?php esc_attr_e('Exclude Files/Folders/File Types', 'wpvivid-backup-pro'); ?>"></div>
                    </div>
                    <div style="width:70%; float:left;box-sizing:border-box;padding-left:0.5em;">
                        <div>
                            <p>
                                <span class="dashicons dashicons-portfolio wpvivid-dashicons-orange"></span>
                                <span><strong><?php esc_html_e('Excluded Files/Folders', 'wpvivid-backup-pro'); ?></strong></span>
                            </p>
                        </div>
                        ...
                        <div style="padding:1em 0 0 0;">
                            <span class="wpvivid-rectangle wpvivid-grey-light wpvivid-hover-blue wpvivid-reset-custom-exclude-list" style="float:right;margin-right:10px;"><?php esc_html_e('Reset Excluded Files/Folders', 'wpvivid-backup-pro'); ?></span>
                            <span class="wpvivid-rectangle wpvivid-grey-light wpvivid-hover-blue wpvivid-clear-custom-exclude-list" style="float:right;"><?php esc_html_e('Empty Excluded Files/Folders', 'wpvivid-backup-pro'); ?></span>
                        </div>
                    </div>
                    <div style="clear:both;"></div>
                </div>
            ...
            <div>
                <p>
                    <span class="wpvivid-handle-exclude-file-type-detail" style="cursor:pointer;"><strong><?php esc_html_e('Exclude File Types', 'wpvivid-backup-pro'); ?></strong></span>
            ...
            <div class="wpvivid-exclude-file-type-detail" style="display: none;">
                <input class="wpvivid-custom-exclude-extension" style="width:100%; padding: 0.5em;border:1px solid #ccc;" value="<?php echo esc_attr($exclude_file_type); ?>" placeholder="<?php esc_attr_e('Exclude file types, separate by comma - for example: gif, jpg, webp, pdf', 'wpvivid-backup-pro'); ?>" />
            </div>
        </div>
        <?php
    }
    ...
    public function load_js()
    {
        ...
        <script>
                            ...
                            "data": function (node_id, callback) {
                                ...
                                jQuery.ajax({
                                    ...
                                    error: function (XMLHttpRequest, textStatus, errorThrown) {
                                        alert(wpvivid_ajax_object_addon.i18n.error);
                                    },
                                    timeout: 30000
                                });
                            },
            ...
            function wpvivid_filter_database_list(table_type, text, parent_id)
            {
                var option;
                var list_class;
                ...
                {
                    option = 'base_db';
                    list_class = 'wpvivid-database-base-list';
                }
                else if(table_type === 'other_table')
                {
                    option = 'other_db';
                    list_class = 'wpvivid-database-other-list';
                }
                else if(table_type === 'diff_prefix_table')
                {
                    option = 'diff_prefix_db';
                    list_class = 'wpvivid-database-diff-prefix-list';
                }
                else
                {
                    return;
                ...
                jQuery('#' + parent_id)
                    .find('.' + list_class + ' input:checkbox[option=' + option + ']')
                    .each(function()
                    {
                        var table_name = String(jQuery(this).val()).toLowerCase();
                        var row = jQuery(this).closest('div.wpvivid-text-line');

                        if(text === '' || table_name.indexOf(text) !== -1)
                        {
                            row.show();
                        }
                        else
            ...
            jQuery('#<?php echo $this->parent_id; ?>').on('click', '.wpvivid-select-base-table-button', function(){
                ...
                wpvivid_filter_database_list('base_table', text, '<?php echo $this->parent_id; ?>');
            });
            ...
            jQuery('#<?php echo $this->parent_id; ?>').on('click', '.wpvivid-select-other-table-button', function(){
                ...
                wpvivid_filter_database_list('other_table', text, '<?php echo $this->parent_id; ?>');
            });
            ...
            jQuery('#<?php echo $this->parent_id; ?>').on('click', '.wpvivid-select-diff-prefix-table-button', function(){
                ...
                wpvivid_filter_database_list('diff_prefix_table', text, '<?php echo $this->parent_id; ?>');
            });
                    ...
                    if(db_host !== ''){
                        ...
                        wpvivid_post_request_addon(ajax_data, function (data) {
                            ...
                            if (jsonarray !== null) {
                                ...
                                jQuery('#<?php echo $this->parent_id; ?>').find('.wpvivid-connect-additional-database').css({'pointer-events': 'auto', 'opacity': '1'});
                                alert(wpvivid_ajax_object_addon.i18n.login_failed_check_credentials);
                            }
                        }, function (XMLHttpRequest, textStatus, errorThrown) {
                            jQuery('#<?php echo $this->parent_id; ?>').find('.wpvivid-connect-additional-database').css({'pointer-events': 'auto', 'opacity': '1'});
                        ...
                        alert(wpvivid_ajax_object_addon.i18n.host_is_required);
                    }
                }
                else{
                    alert(wpvivid_ajax_object_addon.i18n.user_name_is_required);
                }
            });
            ...
            jQuery('#<?php echo $this->parent_id; ?>').on('click', '.wpvivid-add-additional-db', function(){
                ...
                if(db_user !== ''){
                    if(db_host !== ''){
                        ...
                        jQuery('#<?php echo $this->parent_id; ?>').find('.wpvivid-additional-database-list > div').each(function()
                        {
                            if (jQuery(this).attr('database-name') === db_name)
                            {
                                duplicated = true;
                                return false;
                            }
                        ...
                        var item = jQuery('<div>', {'class': 'wpvivid-text-line'});
                        item.attr('database-name', db_name);
                        item.attr('database-host', db_host);
                        item.attr('database-user', db_user);
                        item.attr('database-pass', db_pass);

                        var remove_icon = jQuery('<span>', {
                            'class':
                            'dashicons dashicons-trash ' +
                            'wpvivid-icon-16px ' +
                            'wpvivid-additional-database-remove'
                        });
                        remove_icon.attr('database-name', db_name);

                        var database_icon = jQuery('<span>', {
                            'class':
                        ...
                        var database_text = jQuery('<span>', {
                            'class': 'wpvivid-text-line',
                            text: db_name + '@' + db_host
                        });

                        database_text.attr(
                            'option',
                            'additional_db_custom'
                        );

                        database_text.attr('name', db_name);

                        item.append(remove_icon);
                        item.append(database_icon);
                        item.append(database_text);
                        jQuery('#<?php echo $this->parent_id; ?>').find('.wpvivid-additional-database-list').append(item);
                    }
                    else{
                        alert(wpvivid_ajax_object_addon.i18n.host_is_required);
                    }
            ...
            jQuery('#<?php echo $this->parent_id; ?>').on('click', '.wpvivid-additional-database-remove', function(){
                jQuery(this).closest('.wpvivid-additional-database-list > div').remove();
            });
            ...
            jQuery('#<?php echo $this->advanced_id; ?>').on('click', '.wpvivid-reset-custom-exclude-list', function(){
                var exclude_list = <?php echo wp_json_encode($this->custom_interface->wpvivid_get_default_exclude_list_html()); ?>;
                jQuery('#<?php echo $this->advanced_id; ?>').find('.wpvivid-custom-exclude-list').html(exclude_list);
            });
