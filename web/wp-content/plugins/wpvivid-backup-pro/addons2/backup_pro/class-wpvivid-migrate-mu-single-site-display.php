...
class WPvivid_MU_Single_Site_Custom_List extends WP_List_Table
{
    ...
    public function display_rows()
    {
        ...
        <div style="margin-top:1em;">
            ...
            <span class="wpvivid-handle-file-detail" style="cursor:pointer;"><strong><?php esc_html_e('Files & Folders', 'wpvivid-backup-pro'); ?></strong></span>
        ...
        <div class="wpvivid-file-detail" style="padding-left:2em; display: none;">
            ...
            <p><span><input class="wpvivid-custom-themes-check" type="checkbox" <?php echo esc_attr($themes_check); ?>><span><strong>Themes<span> (</span><span class="wpvivid-themes-size">calculating</span><span>)</span>: </strong>includes all folders of themes.</span></p>
            <p><span><input class="wpvivid-custom-plugins-check" type="checkbox" <?php echo esc_attr($plugins_check); ?>><span><strong>Plugins<span> (</span><span class="wpvivid-plugins-size">calculating</span><span>)</span>: </strong>includes all folders of plugins.</span></p>
            <p><span><input class="wpvivid-custom-content-check" type="checkbox" <?php echo esc_attr($content_check); ?>><span><strong>Wp-content<span> (</span><span class="wpvivid-content-size">calculating</span><span>)</span>: </strong>everything in <code>wp-content</code> <strong>except for</strong> <code>themes</code>, <code>plugins</code> and <code>uploads</code> folders.</span></span></p>
            ...
            <p>
                <span><input class="wpvivid-custom-additional-folder-check" type="checkbox" <?php echo esc_attr($additional_folder_check); ?>><span><strong>Non-WordPress Files/Folders<span> (</span><span class="wpvivid-additional-folder-size">calculating</span><span>)</span>: </strong>all folders/files in root directory of your website except for Wordpress core folders/files.</span></span>
        ...
        <div style="box-sizing:border-box; margin-top:1em;">
            <!--  exclude tree begin  -->
            <div style="margin-top:1em;">
                <span><input type="checkbox" class="wpvivid-custom-exclude-part" <?php echo esc_attr($exclude_part_check); ?>></span>
                <span class="dashicons dashicons-portfolio wpvivid-dashicons-grey"></span>
                <span class="wpvivid-handle-tree-detail" style="cursor:pointer;"><strong><?php esc_html_e('Exclude Files/Folders', 'wpvivid-backup-pro'); ?> </strong></span>
            ...
            <div class="wpvivid-tree-detail" style="display: none;">
                ...
                <div style="width:30%;float:left;box-sizing:border-box;padding-right:0.5em;padding-left:2em;">
                    ...
                    <div style="clear:both;"></div>
                    <div style="padding:1.5em 0 0 0;"><input class="button-primary wpvivid-custom-tree-exclude-btn" type="submit" value="<?php esc_attr_e('Exclude Files/Folders', 'wpvivid-backup-pro'); ?>"></div>
                </div>
                <div style="width:70%; float:left;box-sizing:border-box;padding-left:0.5em;">
                    <div>
                        <p>
                            <span class="dashicons dashicons-portfolio wpvivid-dashicons-orange"></span>
                            <span><strong><?php esc_html_e('Excluded Files/Folders/File Types', 'wpvivid-backup-pro'); ?></strong></span>
                        </p>
                    </div>
                    ...
                    <div class="wpvivid-custom-exclude-module wpvivid-custom-exclude-content-module" style="padding:1em 0 0 0;display: none;"><span class="wpvivid-rectangle wpvivid-grey-light wpvivid-hover-blue wpvivid-clear-custom-exclude-list" style="float:right;"><?php esc_html_e('Empty Excluded Files/Folders', 'wpvivid-backup-pro'); ?></span></div>
                    ...
                    <div class="wpvivid-custom-exclude-module wpvivid-custom-exclude-themes-module" style="padding:1em 0 0 0;"><span class="wpvivid-rectangle wpvivid-grey-light wpvivid-hover-blue wpvivid-clear-custom-exclude-list" style="float:right;"><?php esc_html_e('Empty Excluded Files/Folders', 'wpvivid-backup-pro'); ?></span></div>
                    ...
                    <div class="wpvivid-custom-exclude-module wpvivid-custom-exclude-plugins-module" style="padding:1em 0 0 0;display: none;"><span class="wpvivid-rectangle wpvivid-grey-light wpvivid-hover-blue wpvivid-clear-custom-exclude-list" style="float:right;"><?php esc_html_e('Empty Excluded Files/Folders', 'wpvivid-backup-pro'); ?></span></div>
                    ...
                    <div class="wpvivid-custom-exclude-module wpvivid-custom-exclude-uploads-module" style="padding:1em 0 0 0;display: none;"><span class="wpvivid-rectangle wpvivid-grey-light wpvivid-hover-blue wpvivid-clear-custom-exclude-list" style="float:right;"><?php esc_html_e('Empty Excluded Files/Folders', 'wpvivid-backup-pro'); ?></span></div>
                </div>
...
class WPvivid_Migrate_MU_Single_Site_Display
{
    ...
    public function wpvivid_backuppage_add_backup_type($html, $type_name)
    {
        ...
        <label style="padding-right:2em;">
            <input type="radio" option="backup" name="<?php echo esc_attr($type_name); ?>" value="custom" checked="checked">
            <span>Custom content</span>
        </label>
        <label>
            <input type="radio" option="backup" name="<?php echo esc_attr($type_name); ?>" value="mu">
