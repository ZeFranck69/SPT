...
class WPvivid_Installation
{
    ...
    public function get_dashboard_menu($submenus,$parent_slug)
    {
        ...
        if($display)
        {
            ...
            $submenu['menu_title'] = __('Installer', 'wpvivid-backup-pro');
    ...
    public function init_page()
    {
        ...
        <div class="wrap wpvivid-canvas">
            ...
            <h1><?php printf( esc_html__('%s Plugins - Installer', 'wpvivid-backup-pro'), esc_html(apply_filters('wpvivid_white_label_display', 'WPvivid')) ); ?></h1>
